...
Partial Class php_training_in_chandigarh
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtMobile.Text <> "" Then
                    ...
                    varclass.SendLeadsForIELTS(txtMobile.Text, txtName.Text, txtEmailId.Text, "IELTS (Chandigarh)", "Arrange a Call Back", "https://thinknexttraining.com/ielts-coaching-institute-mohali.aspx/")
                    lblmsg.Visible = True
                    lblmsg.ForeColor = Drawing.Color.Red
                    ' lblmsg.Text = "Thanks for your Enquiry at ThinkNEXT Technologies Pvt. Ltd."
                    txtName.Text = ""
    ...
    Sub AddStudentScholarshipDetail()
        ...
        varclass.SendLeadsForIELTS(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "IELTS Demo Class (Chandigarh)", txtdemoMsg.Text, "https://thinknexttraining.com/ielts-coaching-institute-mohali.aspx")
        Response.Redirect("thanks.html")

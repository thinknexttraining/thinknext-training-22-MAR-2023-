...
Partial Class thinknext_job_fair
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs) Handles btnsubmit.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            'SMS2nd = "Dear " & txtNameR.Text & ", Thanks for your registration for Free Industrial Training under ESDM Govt. Scheme. Venue: ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon. To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
            ...
            varclass.SendLeads(txtContectR.Text, txtNameR.Text, txtEmailR.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/free-industrial-training-esdm-govt-scheme.aspx")
            txtNameR.Text = ""
            txtContectR.Text = ""
            txtEmailR.Text = ""
            txtjob.Text = ""
    ...
    Sub AddStudentScholarshipDetail()
        ...
        cmd.Parameters.AddWithValue("@ModeOfEnquiry", "ESDM Govt. Scheme")
        ...
        cmd.Parameters.AddWithValue("@Comment", "ESDM Govt. Scheme")

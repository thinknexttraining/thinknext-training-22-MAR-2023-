<%@ Page Title="Advanced Diploma Course in Web Design, Development & Internet Marketing in Chandigarh" Language="VB"  MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="diploma-course-Web-Design-Development-Internet-marketing-chandigarh-mohali.aspx.vb" Inherits="diploma_course_Web_Design_Development_Internet_marketing_chandigarh_mohali" %>
...
<meta name="description" content="Advanced Diploma Course in Web Design, Development & Internet Marketing in Chandigar Mohali, Job oriented diploma courses in Web Designing and Digital Marketing in Chandigarh Mohali includes Design Using software’s like Adobe Photoshop, Illustrator and Corel Draw, HTML5, CSS3." />
    ...
    <link rel="image_src" href="http://www.thinknexttraining.com/images/advance-diploma-course-min.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/images/advance-diploma-course-min.jpg"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <img class="d-md-none"  src="images/advance-diploma-course-min.jpg" alt="Advanced Diploma Course in Web Design, Development & Internet Marketing" />
       <img src="images/advance-diploma-course-min.jpg" alt="Advanced Diploma Course in Web Design, Development & Internet Marketing"  />
            ...
            <div class="row m-0">
                <div class="col-md-8">
                    <div class="p-2 border text-justify position-sticky top-0">
                      ...
                      <h1>Advanced Diploma Course in Web Design, Development & Internet Marketing</h1>
                    </div>
                     <p>Diploma course in Web Design, Development & Internet Marketing can make students future secure. Professional institute like ThinkNEXT , an ISO 9001:2015 certified offers numerous short term and long term job oriented courses. Each program has different eligibility criteria depending upon various factors like academic qualifications and a little bit creative with the logical bend of mind. These programs will help aspirants with not only in enhancing their skills but also unleashing their creative thoughts and ideas.</p>
                     <p>It is the necessity and need of an hour to obtain advanced-level training in latest web technologies so that one can have a successful career in the field of website design and development & Digital Marketing. After completion of advanced diploma course in Web Design, Development & Internet marketing from one of the best diploma course institute in Chandigarh Mohali , the probability is high that prominent employers will be hiring you.</p>
            ...
            <div class="row m-0 p-2">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-sticky top-0">
                        ...
                        <h3 class="text-danger"><strong>Best advanced diploma course in Web Design, Development & Internet marketing in Chandigarh Mohali</strong></h3>
                        ...
                        <p>Although there are no definite pre-requisites required joining any of ThinkNEXT diploma course and job oriented Web Design and Development, Internet Marketing Courses . Industry best programming languages and software packages like Adobe Photoshop, Illustrator, HTML5, CSS3, Bootstrap, jQuery, JavaScript, WordPress, Drupal, AngularJS, Digital Marketing, etc. will be taught by our industry experienced experts with their proficiency in the field of web design and development & Internet Marketing .</p>
                        <p>ThinkNEXT is one of the best Web Design, Development & Internet marketing institute doesn’t only helps the students to master in web design and web development & Internet Marketing but also provides them with free counseling before they get registered for any specific course. It will give them a broader look and help them to understand whether they are in the right direction towards their future career path.</p>
    ...
    <section class="py-4">
        <div class="container">
            <div class="text-center bg-0f54bb py-2">
                <h3 class="text-white mb-0 content"><strong>Advanced Diploma Course in Web Design - Course Syllabus</strong> </h3>
            </div>
            <br>
            <div class="row">
                <div class="col-lg-6 col-md-6 mt-3 text-justify">

                    <strong class="textred"> Graphics & Web Imaging- 3 Months</strong>

                    <ul class="welcomeLinks">
                        <li> Planning a website using a structured document</li>
                        <li> Vector Illustration</li>
                        <li> Graphics design and visual communication</li>
                        <li> Typography and color sense for web design</li>
                        <li> Designing your character in line drawing</li>
                        <li> Working with print media</li>
                        <li> Making Animated Web ads, E-cards, Presentations</li>
                        <li> Intros, Web Headers</li>
                        <li> DTP Courses & Graphics Concepts</li>
                        <li> Flat Design User Interface for Web application</li>
                        <li> Advanced Responsive UI by creating web assets</li>
                        <li> Creating Web templates</li>
                        <li> Slicing the templates</li>
                        <li> Recognizing Good Design vs. Bad Design</li>                       
                    </ul>

                </div>

                <div class="col-lg-6 col-md-6 mt-3 text-justify">
                    <strong class="textred"> HTML5, CCSS3, JQuery& JAVA Script- 1 Month</strong>

                    <ul class="welcomeLinks">
                        <li> HTML5/CSS3 with Dreamweaver CC</li>
                        <li> Browser Support & Features Detection</li>
                        <li> HTML5 for Multimedia, Graphics</li>
                        <li> Working with CSS& CSS3 Rules</li>
                        <li> PSD to HTML5</li>
                        <li> Creating and Testing Responsive design</li>
                        <li> Web 3.0 standards, CSS3 for Stunning Aesthetics</li>
                        <li> jQuery UI Widget, jQuery UI</li>
                        <li> Java script</li>
                        <li> Testing and Maintaining a Website</li>
                        <li> JQuery as an alternative for Flash</li>
                        <li> Adding Flash, video, and Audio to Your Web Pages</li>                       
                    </ul>

                </div>

                <div class="col-lg-6 col-md-6 mt-3 text-justify">
                    <strong class="textred"> Core & Advanced PHP- 3 Months</strong>
                    
                    <ul class="welcomeLinks">
                        <li> Fundamentals of PHP ( PHP/MySql/Apache)</li>
                        <li>  Server Side and user side validations</li>
                        <li>  HTML & CSS, PHP String operation</li>
                        <li>  PHP Pagination, File Handling</li>
                        <li>  Sessions and Cookies</li>
                        <li>  User Permissions and Roles</li>
                        <li>  Import Export of DB and Join queries</li>
                        <li>  Introduction to PHP Frameworks</li>
                        <li>  Integration of Social Media with PHP</li>
                        <li>  Integration of Payment Gateway with PHP</li>
                        <li>  Error Handling and Debugging</li>
                        <li>  Stripe API</li>
                        <li>  PDO Queries & Results</li>
                        <li>  PHP Config, PHP Security</li>
                        <li>  Ecommerce</li>
                        <li>  CMS- Joomla WordPress & Magento</li>
                ...
                <div class="col-lg-6 col-md-6 mt-3 text-justify">
                     <strong class=" col-12 textred"> Master in Digital Marketing- 2 Months</strong>
                  
                    <ul class="welcomeLinks">
                        <li>Digital Marketing Overview</li>
                        <li> Website Planning & Creation</li>
                        <li> Search Engine Optimization</li>
                        <li> Email Marketing</li>
                        <li> Google Adwords & Google Analytics</li>
                        <li> Facebook Marketing & LinkedIn Marketing</li>
                        <li> Twitter Marketing & Video Marketing</li>
                        <li> Instagram marketing & Pinterest Marketing</li>
                        <li> Online display advertising</li>
                        <li> Ecommerce Marketing</li>
                        <li> Mobile Web Marketing</li>
                        <li> Content Marketing</li>
                        <li> Online Reputation Management</li>
                        <li> Affiliate Marketing Basics</li>
                        <li> Adsence & Blogging</li>
                        <li> How to grab freelancing Projects?</li>
                    </ul>
                    ...
                    <div class="col-lg-6 col-md-6 mt-3 text-justify">
                        ...
                        <strong class="textred"> Responsive Web Designing & Bootstrap- 1 Month</strong>
                    
                    <ul class="welcomeLinks">
                        <li> Media Attribute and Media Type Concepts</li>
                        <li> Web Pages with a mobile or smart device</li>
                        <li> Understanding CSS Box Model & CSS Resets</li>
                        <li> Flexible content, images background and fonts</li>
                        <li> Displaying & hiding content, Simplifying navigation</li>
                        <li> Validation and Markup</li>
                        <li> Browser Testing & Mobile Testing</li>
                    </ul>
                </div>
                
                 <div class="col-lg-6 col-md-6 mt-3 text-justify">
                     <strong class=" col-12 textred"> Flash & Web Multimedia- 1 Month</strong>
                                     
                    <ul class="welcomeLinks">
                        <li>Creating animated contents</li>
                        <li> Animated web banners and advertisement</li>
                        <li> Audio & Video using in Flash</li>
                        <li> E-Presentation for Web</li>
                        <li> E-learning- Content development</li>
                        <li> Building a website in Flash</li>
                        <li> Action Script Programming Basics</li>
                    </ul>
                </div>

<%@ Page Title="Free Job-Oriented Courses in Chandigarh with Government Certification" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ESDM.aspx.cs" Inherits="ESDM" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <title>Free Job-Oriented Courses in Chandigarh with Government Certification</title>
<meta name="description" content="100% Free Skill/Industrial Training Programme With Placement Assistance Under Skill Development in ESDM (Electronics Sector Development & 

Manufacturing) for Digital India under NIELIT, DeitY, Govt. of India. Special Batches For Students/housewives/working professionals." />
...
<link rel="canonical" href="http://www.thinknexttraining.com/ESDM.aspx" />
<link rel="publisher" href="https://plus.google.com/+ThinknexttrainingIndia/about"/>
     ...
     .popupsmsemail1
{
   ...
   box-shadow: 7px 7px 5px #d7d0d0;
    ...
    <div class="head1">
    <h3 style="color:#000;" >ESDM &nbsp;&nbsp;</h3>
       <div class="ryt">

You are here &nbsp; Home / ESDM 
...
<div style="height:700px">
    ...
    <br />
    <img src="images/digital-India.png" style="width: 246px; height: 105px; float:right; margin-top: 0px; margin-right: 50px;  "/>
    <img src="images/dit.jpg" style="width: 209px; height: 148px; float:left; margin-top:0px; "/>

   
    <%--<table>
    <tr>
    <td align="center"> <h5><b><asp:Label id="Test" runat="server" Text="Lets make every indian skilled and independent"></asp:Label></b></h5></td>
    </tr>
    <tr><td align="center"><h5><b><asp:Label id="Label2" runat="server" Text="Lets make India the Skill Capital of the world."></asp:Label></b></h5></td></tr>
    </table>--%>
   
    <div><table style="background-color:#F9F7CA;border:1px solid black;">
    <tr><td style="font-size:19px"><font font style="font-weight:bold;">Free Job-Oriented Courses With Government Certification</font></td></tr>
    </table></div>
     <br />
    <div>
...
<table width="100%" style="background-color:#F9F7CA;border:1px solid black;border-radius: 15px 50px 30px 5px">
  <tr>
    <td > <li style="margin-left:100px; font-size:16px; font-weight:600; "> <stronge> Free Spoken English PD classes </stronge> </li>
        <li style="margin-left:100px; font-size:16px; font-weight:600; "> Part time / Full time job offer for each student during taining </li>
        <li style="margin-left:100px; font-size:16px; font-weight:600;  " >Study Material </li> 
...
<td style=" border:1px solid black;"><b><%--<asp:LinkButton ID="lbap" runat="server" 
   ...
   <td style=" border:1px solid black; font-size:20px; " class="style2"><font style="font-weight:bold;">3.</font></td>
       <td style=" border:1px solid black;  font-size:20px; " class="auto-style1"><b><span>Embedded System Design using 8-bit Microcontroller<br />
           </span></b></td>
...
<input  style="height: 27px; width: 109px;" name="reset" onclick="togglesing();" type="button"  value="Apply" /> <br /> 
   ...
   <td style=" border:1px solid black; font-size:20px; " class="style2"><font style="font-weight:bold;">4.</font></td>
       <td style=" border:1px solid black;  font-size:20px; " class="auto-style1"><b><span>Automation Technology – Basic Level<br />
           </span></b></td>
...
<input  style="height: 27px; width: 111px;" name="reset" onclick="google();" type="button"  value="Apply" /> <br />
   ...
   <td style=" border:1px solid black; font-size:20px;" class="style2"><font style="font-weight:bold;">5.</font></td>
       <td style=" border:1px solid black;  font-size:20px; " class="auto-style1"><b><span>Automation Technology – Advance Level<br />
           </span></b></td>
...
<table class="tab1" align="center" border="1" id="TableR" style="width:100%;">
  <tbody><tr>
    <td width="25PX" align="left"><font style="font-weight:bold;color:White;">Name</font></td>
  ...
  <tr>
    <td><font style="font-weight:bold;color:White;">Mobile No</font></td>
    <td colspan="2">
        <asp:TextBox ID="txtContectR" runat="server" Height="14px" Width="150px" style="margin-top:26px" MaxLength="10"></asp:TextBox>
        <asp:Label ID="lbla" runat="server" Text="Assembly & Maintenance of PCs" Visible="false"></asp:Label>
&nbsp;</td>
  
  </tr>
  <tr>
    <td> <font style="font-weight:bold;color:White;">E-mail ID</font></td>
    <td colspan="2">
        <asp:TextBox ID="txtEmailR" runat="server" Height="14px" Width="150px" style="margin-top:26px"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">
        <asp:Button ID="btnSave" runat="server" EnableTheming="False" Text="Submit" style="margin-top:26px" OnClick="btnSave_click"/>
        &nbsp;</td>
  </tr>
  <tr>
...
<div id="popup1" runat="server" style="z-index:999; display:none; " class="popupsmsemail1">
...
<table class="tab1" align="center" border="1" id="Table1" style="width:100%;">
  <tbody><tr>
    <td width="25PX" align="left"><font style="font-weight:bold;color:White;">Name</font></td>
    <td colspan="2" width="62%" align="left">
        <asp:TextBox ID="txtName" runat="server" Height="14px" Width="150px"></asp:TextBox>
        &nbsp;</td>
  ...
  <tr>
    ...
    <asp:Label ID="b" runat="server" Text="BSNL Certified Telecom Technician-PC Hardware and Networking" Visible="false"></asp:Label>
        <asp:TextBox ID="txtContect" runat="server" Height="14px" Width="150px" style="margin-top:26px" MaxLength="10"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td> <font style="font-weight:bold;color:White;">E-mail ID</font></td>
    <td colspan="2">
        <asp:TextBox ID="txtEmail" runat="server" Height="14px" Width="150px" style="margin-top:26px"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">
        <asp:Button ID="btnSave1" runat="server" EnableTheming="False" Text="Submit" style="margin-top:26px" OnClick="btnSave1_click"/>
        &nbsp;</td>
  </tr>
  <tr>
...
<table class="tab1" align="center" border="1" id="Table2" style="width:100%;">
  <tbody><tr>
    <td width="25PX" align="left"><font style="font-weight:bold;color:White;">Name</font></td>
    <td colspan="2" width="62%" align="left">
        <asp:TextBox ID="txtName2" runat="server" Height="14px" Width="150px"></asp:TextBox>
        &nbsp;</td>
  ...
  <tr>
    ...
    <asp:Label ID="C" runat="server" Text="Embedded System Design using 8-bit Microcontroller" Visible="false"></asp:Label>
        <asp:TextBox ID="txtContect2" runat="server" Height="14px" Width="150px" style="margin-top:26px" MaxLength="10"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td> <font style="font-weight:bold;color:White;">E-mail ID</font></td>
    <td colspan="2">
        <asp:TextBox ID="txtEmail2" runat="server" Height="14px" Width="150px" style="margin-top:26px"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">
        <asp:Button ID="btnSave2" runat="server" EnableTheming="False" Text="Submit" style="margin-top:26px" OnClick="btnSave2_click"/>
        &nbsp;</td>
  </tr>
  <tr>
...
<table class="tab1" align="center" border="1" id="Table3" style="width:100%;">
  <tbody><tr>
    <td width="25PX" align="left"><font style="font-weight:bold;color:White;">Name</font></td>
    <td colspan="2" width="62%" align="left">
        <asp:TextBox ID="txtName3" runat="server" Height="14px" Width="150px"></asp:TextBox>
        &nbsp;</td>
  ...
  <tr>
    ...
    <asp:Label ID="D" runat="server" Text="Automation Technology – Basic Level" Visible="false"></asp:Label>
        <asp:TextBox ID="txtContect3" runat="server" Height="14px" Width="150px" style="margin-top:26px" MaxLength="10"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td> <font style="font-weight:bold;color:White;">E-mail ID</font></td>
    <td colspan="2">
        <asp:TextBox ID="txtEmail3" runat="server" Height="14px" Width="150px" style="margin-top:26px"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">
        <asp:Button ID="btnSave3" runat="server" EnableTheming="False" Text="Submit" style="margin-top:26px" OnClick="btnSave3_click"/>
        &nbsp;</td>
  </tr>
  <tr>
...
<table class="tab1" align="center" border="1" id="Table4" style="width:100%;">
  <tbody><tr>
    <td width="25PX" align="left"><font style="font-weight:bold;color:White;">Name</font></td>
    <td colspan="2" width="62%" align="left">
        <asp:TextBox ID="txtName4" runat="server" Height="14px" Width="150px"></asp:TextBox>
        &nbsp;</td>
  ...
  <tr>
    ...
    <asp:Label ID="E" runat="server" text="Automation Technology – Advance Level" Visible="false"></asp:Label>
        <asp:TextBox ID="txtContect4" runat="server" Height="14px" Width="150px" style="margin-top:26px" MaxLength="10"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td> <font style="font-weight:bold;color:White;">E-mail ID</font></td>
    <td colspan="2">
        <asp:TextBox ID="txtEmail4" runat="server" Height="14px" Width="150px" style="margin-top:26px"></asp:TextBox>
&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">
        <asp:Button ID="btnSave4" runat="server" EnableTheming="False" Text="Submit" style="margin-top:26px" OnClick="btnSave4_click"/>
        &nbsp;</td>
  </tr>
  <tr>

...
Partial Class thinknext_job_fair
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs) Handles btnsubmit.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            SMS2nd = "Dear " & txtNameR.Text & ", Thanks for your registration for Free Industrial Training under Govt. Scheme. Venue: ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon. To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
    ...
    Sub SendEmailReg()
        ...
        'Dim reader As New StreamReader(Server.MapPath("~/newemail3.html"))
        ...
        msg.Subject = "Registration for Free industrial Training under Govt."
    ...
    Sub AddStudentScholarshipDetail()
        ...
        cmd.Parameters.AddWithValue("@ModeOfEnquiry", "Free industrial Training under Govt.")
        cmd.Parameters.AddWithValue("@EmailID", txtEmailR.Text)
        cmd.Parameters.AddWithValue("@Duration", "6 Months")
        cmd.Parameters.AddWithValue("@Course", txtjob.Text)
        'cmd.Parameters.AddWithValue("@CollegeName", )
        cmd.Parameters.AddWithValue("@Comment", "Free industrial Training under Govt.")
        ...
        cmd.Dispose()
        con.Close()
        varclass.SendLeads(txtContectR.Text, txtNameR.Text, txtEmailR.Text, "None", "Free industrial Training under Govt", "https://www.thinknexttraining.com/free-industrial-training-pmkvy-govt-scheme.aspx")

<%@ Page Title="Best Institute for Web Designing Course in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="web-designing-training-in-chandigarh.aspx.vb" Inherits="web_designing_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<meta name="description" content="Looking for Web Designing Course? ThinkNEXT is the best Web Designing Training Institute in Chandigarh which provides Web Designing Training with 100% job placement." />
<meta name="keywords" content="Web Designing Course in Chandigarh, Web Designing Training in Chandigarh, Web Designing Institutes in Chandigarh" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image position-relative py-4">

        <img class="d-md-none" src="images/Web-Designing-Course-Training-in-Chandigarh-Mohali-min.jpg" alt="Web Designing Training Course in Chandigarh Mohali Panchkula">
        <img class="d-none d-md-block" src="images/Web-Designing-Course-Training-in-Chandigarh-Mohali-2-min.jpg" alt="Web Designing Training Course in Chandigarh Mohali Panchkula">
                ...
                <div class="col-md-8">
                    <div class="p-2 border text-justify position-sticky top-0">
                        <div class="gdl-header-wrapper">
                            <h1>Web Designing Course in Chandigarh</h1>
                        </div>
                        <p>
                        ...
                        <h2 class="h3">Best Institute for Web Designing Course in Chandigarh</h2>
                        ...
                        <p>We offer <strong>100% job-oriented courses after the 12th</strong>. Join a <strong>professional web designing course in Chandigarh</strong> to expose your carrier as a web designer.</p>
    ...
    <div class="container">
        ...
        <div class="row m-0">
                ...
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/11mHiop0y0s" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/11mHiop0y0s/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/11mHiop0y0s" data-bs-target="#VideoModal"></span>
                </div>
            </div>
            
                 <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/uYBt7RL6gyE" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/uYBt7RL6gyE/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/uYBt7RL6gyE" data-bs-target="#VideoModal"></span>
                </div>
            </div>

                  <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/uSZpZMoz01U" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/uSZpZMoz01U/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/uSZpZMoz01U" data-bs-target="#VideoModal"></span>
                </div>
            </div>

                       <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/H1Zt7B4XyOY" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/H1Zt7B4XyOY/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/H1Zt7B4XyOY" data-bs-target="#VideoModal"></span>
                </div>
            </div>

                   <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/jupi1dbDsUg" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/jupi1dbDsUg/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/jupi1dbDsUg" data-bs-target="#VideoModal"></span>
                </div>
            </div>

                   <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/vU3v11yiQCA" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/vU3v11yiQCA/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/vU3v11yiQCA" data-bs-target="#VideoModal"></span>
                </div>
            </div>
              
                  <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/RQvNE3SqZFk" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/RQvNE3SqZFk/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/RQvNE3SqZFk" data-bs-target="#VideoModal"></span>
                </div>
            </div>
                
                   <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/SJUMBAyZHJI" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/SJUMBAyZHJI/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/SJUMBAyZHJI" data-bs-target="#VideoModal"></span>
                </div>
            </div>

                  <div class="col-md-4 my-3">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/qB3rJSOUeLg" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/qB3rJSOUeLg/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/qB3rJSOUeLg" data-bs-target="#VideoModal"></span>
                </div>
            </div>

                 <div class="col-md-4 my-3 d-md-none">
                <div class="video-btn position-relative" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/MQ5WRxJAfsc" data-bs-target="#VideoModal">
                    <img src="https://i.ytimg.com/vi_webp/MQ5WRxJAfsc/maxresdefault.webp" alt="Web Designing Training in Chandigarh">
                    <span class="play-btn" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/MQ5WRxJAfsc" data-bs-target="#VideoModal"></span>
                </div>
            </div>
    ...
    <section class="py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <ul class="welcomeLinks mb-0">
                        <li><a href="web-designing-course-mohali.aspx">Web Designing Course in Mohali</a></li>
                    </ul>
                </div>
            </div>
        </div>

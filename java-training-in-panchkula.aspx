<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/java-training-in-panchkula.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Java Training in Panchkula - ThinkNEXT Technologies </title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Java Training in Panchkula </h3>
    <div class="ryt">

 You Are Here / Java Training in Panchkula
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
                <h1>Java Training in Panchkula &nbsp;</h1>
            </div>
      
             <p>There are a lot of  companies which are <strong>Providing Java Training  in Panchkula.</strong> Java is one of the most demanding programming languages in  Industries or IT companies. ThinkNEXT is the one of the most known company for <strong>Technical Training in Panchkula</strong>. This  company also provides the <strong>Java Training  in Panchkula.</strong>  </p>
            ...
            <h3 style="color: #FF0000; font-weight: bold;">
               <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" /> Java Industrial Training - Course Contents </h3>
        <%--<div class="panel-group col-md-8" id="accordion">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Course Details:</a>
        </h4>
      </div>
      <div id="collapse1" class="panel-collapse collapse in">
        <div class="panel-body">--%>
                <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Introduction<br />
            <i class="fa fa-hand-o-right"></i>&nbsp JDK<br />
            <i class="fa fa-hand-o-right"></i>&nbsp JRE
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp JVM
            <br />          
            <i class="fa fa-hand-o-right"></i>&nbsp Oops Concepts
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Integrated Development Environment
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Data Types
            <br />            
            <i class="fa fa-hand-o-right"></i>&nbsp Arrays
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Operators
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Classes & Objects
            <br />
           
            <i class="fa fa-hand-o-right"></i>&nbsp Packages
            <br />
                  <i class="fa fa-hand-o-right"></i>&nbsp Interfaces
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Multithreading
            <br />
           
            <i class="fa fa-hand-o-right"></i>&nbsp JS
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Applets & AWT
            <br />
                   <i class="fa fa-hand-o-right"></i>&nbsp Basic HTML
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp CSS
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Swings
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Databases
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Handling
            <br />
                  <i class="fa fa-hand-o-right"></i>&nbsp Exception
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp String Handling
            <br />
           
            <i class="fa fa-hand-o-right"></i>&nbsp Collection
            <br />
                  <i class="fa fa-hand-o-right"></i>&nbsp Files I/O
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Serialization
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Networking
            <br />
          
          
            <i class="fa fa-hand-o-right"></i>&nbsp MVC
            <br />
                   <i class="fa fa-hand-o-right"></i>&nbsp Apache Server
           <br />
           
            <i class="fa fa-hand-o-right"></i>&nbsp JSF
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Hibernate
            <br />
                  <i class="fa fa-hand-o-right"></i>&nbsp Servlets
            <br />

                        
            <i class="fa fa-hand-o-right"></i>&nbsp JDBC
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp JSP
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Web Services
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Spring
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Live Project
            <br />
            <i class="fa fa-hand-o-right"></i>&nbsp Interview Preparation 
            <br /> <br />
       </div>
            <div class="col-lg-12">

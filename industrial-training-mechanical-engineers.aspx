<%@ Page Title="Six Months Industrial Training in Mechanical Engineering in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="industrial-training-mechanical-engineers.aspx.vb" Inherits="industrial_training_mechanical_engineering_students" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="Mechanical Engineering Industrial Training in Chandigarh Mohali - ThinkNEXT is best Android Training Company providing Mechanical Engineering Industrial Training in Chandigarh Mohali Panchkula India. ThinkNEXT " />
    <meta name="keywords" content="Mechanical Engineering Industrial Training in Chandigarh Mohali, Mechanical Engineering Industrial Training in Chandigarh, Mechanical Engineering Industrial Training in Chandigarh, Mechanical Engineering Industrial Training in Chandigarh, Mechanical Engineering Industrial Training in Chandigarh, Mechanical Engineering Industrial Training in Chandigarh, Android App Development Training in panchkula INDIA." />
      <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/images/mechanical-engineering.jpg" />
     <meta property="og:image" content="http://www.thinknexttraining.com/images/mechanical-engineering.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image">  
         <img class="d-md-none"  src="images/mechanical-engineering.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
            
     <img class="d-none d-md-block" src="images/mechanical-engineering.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
      ...
      <div class="downloadsyllabus-banner px-2 py-3 rounded">
            <div class="downloadsyllabus w-100 border-0">
                ...
                <section class="bg-ececec py-3 px-2 text-md-center d-none">
                    <div class="container">                    
                    <div class="row m-0">
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                       <div class="gdl-header-wrapper">
                        <h1>Best Six Months/6 Weeks (45 Days/Summer Training) Industrial Training for Mechanical Engineering Students in Chandigarh Mohali Panchkula</h1>
                         <p><strong>Mechanical Engineering (ME)</strong> is that branch of engineering that deals with the planning, construction, and use of machines. Mechanical Engineering applies principles of engineering, physics and material science for the planning, analysis, producing and maintenance of mechanical systems.</p>
                         <p>Earlier it was thought that mechanical engineering is an area where you need to just operate in the mechanical industry however nowadays you should have to require software program abilities in addition to on-site industry knowledge to become industry-ready.</p>
                         <p>So, colleges did mandatory for students to obtain software program as well as on-site mechanical industry training. <strong><a class="text-decoration-none" href="https://www.thinknexttraining.com/">ThinkNEXT</a></strong> is offering Software as well as on-site industrial training to B.E, B.Tech, Polytechnic Diploma, Working Professionals various other job-seekers in the field of Mechanical Engineering under 6 months, 3 months/6 weeks job-oriented industrial training programs.</p>
    ...
    <section>
        <div class="container text-justify">
                         <p><strong>Are you seeking the best six Months (Software + Industry) Industrial training or six Weeks (45 days) summer internship training for Mechanical Students in Chandigarh Mohali?</strong></p>
                         <p><strong>ThinkNEXT Technologies Private Limited</strong> offers the best Six Months or 6 Weeks (45 Days) summer internship Training opportunity for <strong>Mechanical Engineering</strong> Trainees in Chandigarh Mohali region to make students industry-ready.</p>
                         <p>To be ready for industry, mechanical students must know the various software technologies used in the software industry for design, analysis, manufacturing, project planning, cost estimation, maintenance, etc. <strong><a class="text-decoration-none" href="https://www.thinknexttraining.com/">ThinkNEXT</a></strong> offers both industry and training programs for mechanical engineering students. In software training for mechanical students, <strong>ThinkNEXT</strong> offers work-oriented programs/courses as follows:</p>
                       <div class="row">
                           <div class="col-6">
                           <ul class="course-img">
                               <li><a href="Autocad-training-in-chandigarh.aspx">
                                   <img src="images/autocad.png" alt="Autocad" />&ensp; AutoCad </a></li>

                               <li><a href="STAADpro-training-in-chandigarh.aspx">
                                   <img src="images/staad.pro.jpg" alt="Staad.pro" />&ensp; STAADPro</a></li>

                               <li><a href="revit-training-courses-institute-chandigarh-mohali.aspx">
                                   <img src="images/Reviticon.jpg" alt="Revit" />&ensp; Revit</a></li>

                               <li><a href="primavera-training-courses-institute-chandigarh-mohali.aspx">
                                   <img src="images/primavera.jpg" alt="Primavera" />&ensp; Primavera</a> </li>
                           </ul>
                               </div>
                           <div class="col-6">
                             <ul class="course-img">
                               <li> <a href ="Pro-Engineer-Training-in-chandigarh.aspx" >
                                   <img src="images/creo.jpg" alt="Pro Engineering Training in Chandigarh" />&ensp; Creo</a></li>
                               <li><a href ="#">
                                   <img src="images/ANSYS_logo.png"  alt="Ansys Training in Chandigarh" />&ensp; Ansys</a> </li>
                               <li> <a href ="#" >
                                   <img src="images/ungraph.jpg" alt="NX Unigraphics Training in Chandigarh" />&ensp; NX Unigraphics</a></li>
                               <li><a href ="CNC-training-in-chandigarh.aspx" >
                                   <img src="images/CNC-Logo.png" alt="CNC Training in Chandigarh" />&ensp; CNC Programming</a> </li>
                             </ul>
                     </div>
        </div>
    </div>
    ...
    <section class="py-4">
        <div class="container">
            <div class="d-none d-md-block">
                <div>
                    <img src="images/industrial-training-comapny-chandigarh.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div>
                    <img src="images/six-weeks-summer-training-chandigarh.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div>
                    <img src="images/summer-training-in-mohali.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
            </div>
            <div class="d-md-none">
                <div class="text-center">
                    <img src="images/industrial-training-comapny-chandigarh-1.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/industrial-training-comapny-chandigarh-2.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/six-weeks-summer-training-chandigarh-1.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/six-weeks-summer-training-chandigarh-2.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/summer-training-in-mohali-1.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/summer-training-in-mohali-2.jpg" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" />
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                </div>
          ...
          <div class="container">
            <div class="row m-0">
              <div class="col-lg-8 text-justify">                
                    <div class="d-inline-block pt-2 "><br />
                      <h3 class="fw-bold text-danger">Companies/Industries offering Internship for Mechanical Engineering students in Chandigarh Mohali:</h3>
                      <p><strong>ThinkNEXT</strong> has made various tie-ups/collaborations with many companies to make students industry-ready in Chandigarh Mohali such as:</p>
                        <ul class="course-img">
                            <li>
                                <img src="images/l&t.png" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; L&T (Larsen & Toubro)</li>
                            <li>
                                <img src="images/Sonalika_logo.jpg" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; Sonalika Group</li>
                            <li>
                                <img src="images/cheema.png" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; Cheema Boilers</li>
                            <li>
                                <img src="images/allena.jpg" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; Allena Automobiles</li>
                            <li>
                                <img src="images/info-farm.jpg" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; Indo-Farm Tractors.</li>
                            <li>
                                <img src="images/cocacola_logo_PNG7.png" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; Coca-Cola.</li>

                            <li>
                                <img src="images/ess-dee.png" alt="6 Six months Industrial Training for Mechanical Engineering Students" />&ensp; Ess Dee Engineers</li>
                        </ul>
                      <p><strong>ThinkNEXT</strong> also offers Mechanical Engineering students stipend based or Free internship or training in various mechanical companies for 6 months, 3 months or 6 weeks (Summer Training or internship). So various students can earn while they learn in many mechanical companies.</p>
                           ...
                           <div class="right_box margin-top">
                             <div class="without_border dwl1 text-center">
                                 ...
                                 <a href="BroucherDownload.aspx?data=Brochure" onclick="broucherdownload();" target="broucher">
                                     <img src="images/download_brochure.png" alt="Mechanical Engineering Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                                 </a>
                        ...
                        <div class="row m-0">
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-thumb.jpg" alt="Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-award-thumb.jpg" alt="Mechanical Engineering Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/mohali-sithith-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/mohali-sithith-dm-award-thumbn.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                               ...
                               <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                                ...
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-yugmarg.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-yugmarg-thumb.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                                ...
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-honor-thumb.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-honor-thumb.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                               ...
                               <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award-chd.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-chd-thumb.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-mohali.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-mohali-thumb.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh">
                                </a>
                            </div>
                        </div>
    ...
    <section class="py-4 ">
        <div class="container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-justify">
                <ul class="welcomeLinks">
                    <li>Mechanical Engineering Industrial Training from 6 Times National Level Award Winner Company:</li>
                    ...
                    <li>Mechanical Engineering Industrial Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
                    ...
                    <li>Mechanical Engineering Industrial Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
                    ...
                    <li>Mechanical Engineering/Internship from 11+ Years old company</li>
                    ...
                    <li>Numerous Tie-up with IT / Electronics / Mechanical / Mechanical / Electrical / Retail / Textile etc. companies for Placements</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Best Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Mechanical Engineering Industrial Training in Chandigarh Mohali" title="6 Month Mechanical Engineering Industrial Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Mechanical Engineering Industrial Training in Chandigarh" title="Mechanical Engineering Industrial Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

<%@ Page Title="AngularJS Training in Chandigarh Mohali - ThinkNEXT" Language="VB"  MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="AngularJS-training-course-chandigarh-mohali.aspx.vb" Inherits="angularjs_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   

<meta name="description" content="AngularJS Training in Chandigarh Mohali - ThinkNEXT is the Best AngularJS Training Company to provide the basic and advance knowledge about AngularJS Course" />
<meta name="keywords" content="Angular JS Training in Chandigarh Mohali, Angular JS Training in Chandigarh Mohali" />
<meta name="author" content=" Munish Mittal, mittalmunish@thinknext.co.in " />
    
    <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/images/Angularjs-training-chandigarh-mob-min.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/images/Angularjs-training-chandigarh-mob-min.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="main-image position-relative">
          <img class="d-md-none" src="images/Angularjs-training-chandigarh-mob-min.jpg" alt="AngularJS Training Course in Chandigarh Mohali" title="AngularJS Training Course in Chandigarh Mohali" />
           <img  class="d-md-block d-none " src="images/Angularjs-training-chandigarh-min.jpg" alt="AngularJS Training Course in Chandigarh Mohali" />
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                       <div class="gdl-header-wrapper">
                        <h1>AngularJS Training Course in Chandigarh Mohali</h1>
                    </div>
                    <p><strong>ThinkNEXT Technologies Private Limited</strong> is one of the leading organizations which is <strong>providing best AngularJS training course in Chandigarh Mohali</strong>. Trainer of ThinkNEXT believes in to deliver the quality education to the students and clear all the concept of  AngularJS so that you can be a skilled AngularJS developer.<br />
 Our AngularJS training model is completely unique from other institutes. Along with this, we  allow our aspirants to work in live Angular framework applications end to end. ThinkNEXT professionals are having very good experience in JavaScript and angular latest  versions like Angular 4, 5 and 6 and they train you up to the industry Standard.<br />
 Nowadays&nbsp;<strong>AngularJS Training</strong>&nbsp;has become quite a necessity for web designers and developers all over the world. Be a part of this growing trend with the&nbsp;<strong>Best AngularJS Training in Chandigarh Mohali.</strong> One such institution which provides accountable <strong>AngularJS Training Chandigarh Mohali </strong>is <strong>ThinkNEXT Technologies Private Limited.</strong><br />
  <br />
 Candidates completing the <strong>best AngularJS course in Chandigarh Mohali </strong>certification have good career opportunities in the IT Sector. ThinkNEXT has vast experience of providing live project based<strong> AngularJS training in Mohali.</strong></p>
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" />
                </div>
    ...
    <section class="py-4">
        <div class="container">
                ...
                <div>
                    <img src="images/industrial-training-comapny-chandigarh.jpg" alt="Angular JS Training in Chandigarh Mohali Mohali" />
                </div>
                <div>
                    <img src="images/six-weeks-summer-training-chandigarh.jpg" alt="Autocad Internship in Chandigarh Mohali" />
                </div>
                <div>
                    <img src="images/summer-training-in-mohali.jpg" alt="Angular JS Training in Chandigarh Mohali Mohali" />
                </div>
            </div>
             <div class="d-md-none">
                   <div class="text-center">
            <img style="width:89%;" src="images/industrial-training-comapny-chandigarh-1.jpg" alt="Angular JS Training in Chandigarh Mohali Mohali" />
        </div>
             <div class="text-center">
            <img style="width:89%;" src="images/industrial-training-comapny-chandigarh-2.jpg" alt="Angular JS Training in Chandigarh Mohali" />
        </div>
          <div class="text-center">
            <img style="width:89%;" src="images/six-weeks-summer-training-chandigarh-1.jpg" alt="Angular JS Training in Chandigarh Mohali" />
        </div>
              <div class="text-center">
            <img style="width:89%;" src="images/six-weeks-summer-training-chandigarh-2.jpg" alt="Angular JS Training in Chandigarh Mohali" />
        </div>
          <div class="text-center">
            <img style="width:89%;" src="images/summer-training-in-mohali-1.jpg" alt="Angular JS Training in Chandigarh Mohali " />
        </div>
             <div class="text-center">
            <img style="width:89%;" src="images/summer-training-in-mohali-2.jpg" alt="Angular JS Training in Chandigarh Mohali" />
        </div>
                 </div>
        </div>
            ...
            <div class="row m-0 p-2">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="position-sticky top-0">
                        <h2 class="text-danger">AngularJS</h2>
                        
         <p>
            <strong>AngularJS</strong> is a very powerful JavaScript Framework and an open source and free, it is used by thousands of developers around the world. It is used to build powerful,  interactive websites with sleek animations and pleasant user experience. It is maintained by Google and its popularity increasing significantly. It always incorporates the latest development trends in the market.
       </p>
       <p>
           <strong class="textred">AngularJS Features:</strong><br />
 Below are the following features of AngularJS which make it the most powerful frameworks in the market.</p>
<p>
  <i class="fa fa-hand-o-right"></i>&nbsp; <strong>MVC-</strong> AngularJS is built on the famous concept of MVC (Model-View-Controller). MVC design pattern used in all modern day web application and it is based on splitting the data layer, business logic layer, and presentation layer into a different section. Each layer could be managed easily as they split into different sections.<br />
  <i class="fa fa-hand-o-right"></i>&nbsp; <strong>Data Model Binding- </strong>You don't need to write special code  to bind data to the HTML controls. This can be done by Angular by just adding a  few snippets of code.<br />
  <i class="fa fa-hand-o-right"></i>&nbsp; <strong>Writing Less Code-</strong> In angular less amount of code is required to write for DOM manipulation.<br />
  <i class="fa fa-hand-o-right"></i>&nbsp; <strong>Unit Testing Ready-</strong> A testing framework called &lsquo;Karma&rsquo;  also developed by the designer which helps in designing a unit test for AngularJS applications.<br />
</p>
    ...
    <section class="py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>AngularJS  Training-Course Content</strong></h3>
            </div>
            <br>
             ...
             <div class="col-lg-6 col-md-6 text-justify">
                <h4 class="text-danger">1. Introduction to Angular.</h4> 
                 <ul class="welcomeLinks">
                       <li> What is Angular?</li>
  <li> Features of AngularJS  and Angular. </li>
  <li> AngularJS (vs) Angular. </li>
  <li>Steps to Set up for the  local development environment.</li>
  <li> Executing First Angular  program using NodeJS and NPM. </li>
  <li> Executing First Angular  program using Visual Studio.  </li>
  ...
  <div class="col-lg-6 col-md-6 text-justify">
             ...
             <h4 class="text-danger">Module 2. Angular Architecture</h4>
            

                   <ul class="welcomeLinks">
                        <li> Basic Building Blocks of  Angular Applications. </li>
  <li>Angular Modules and  @NgModule decorator.</li>
  <li> Angular Libraries. </li>
  <li>Component, Templates,  and Metadata.</li>
  <li> Services and Dependency  Injection. </li>
            ...
            <div class="col-lg-6 col-md-6 text-justify">
                <h4 class="text-danger">Module 3. Displaying Data using  Templates</h4>
               
                  
                        <ul class="welcomeLinks">
                            <li> About Directives.</li>
                            <li>Components Properties  and Interpolation. </li>
                            <li>Built-In Directive.</li>
                              <li>Creating a class for  data (Model object)</li>
                            <li>Template Expressions. </li>
                            <li>Working with Arrays.</li>
                            <li> External HTML Template  File.</li>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 4. Data Binding</h4>
                        <ul class="welcomeLinks">
                        <li> Binding properties and  Interpolation.</li>
  <li> One-way Binding /  Property Binding. </li>
  <li> Event Binding.</li>
  <li>Two-way Binding. </li>
  <li> Two-way binding with  NgModel. </li>
  <li> Attribute Binding. </li>
  <li>Style and Class Binding. </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 5. Styles Binding</h4>
                        <ul class="welcomeLinks">
                          <li>Style and Class  Bindings.</li>
  <li> Using Component Styles. </li>
  <li>Special selectors.  </li>
  <li>Loading Styles into  Components. </li>
                    ...
                    <div class="col-lg-6 col-md-6 ">
                          <h4 class="text-danger">Module 6. Advanced Component  Features</h4>
                        <ul class="welcomeLinks">
                          <li>Revising what are  Components?</li>
  <li> Components Life-Cycle  Hooks. </li>
  <li>Dynamic components using  NgComponent Outlet. </li>
                     ...
                     <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 7. Template Driven  Forms.</h4>
                        <ul class="welcomeLinks">
                          <li>Create the component  that controls the form.</li>
                          <li>Create a template with  the initial form layout.</li>
                          <li>Bind data properties to  each form input control with the ngModel two-way data binding syntax. </li>
                           <li>Add the name attribute  to each form input control.</li>
                     ...
                     <div class="col-lg-6 col-md-6 text-justify">
                        <ul class="welcomeLinks">
                          ...
                          <li>Show and hide validation  error messages. </li>
                           <li>Handle form submission  with submit.</li>
                          <li>Disable the form submits  button until the form is valid.</li>
                      ...
                      <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 8. Reactive Forms.</h4>
                        <ul class="welcomeLinks">
                          <li>Reactive Forms  Introduction.</li>
                          <li>More Form Controls.</li>
                          <li>Form Control Properties. </li>
                           <li>set Value and patch  Value.</li>
                          <li>Validating Form  Elements. </li>
                          <li>Submitting and Resetting  forms. </li>
                           <li> Observing and Reacting  to Form Changes.</li>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 9. Pipes</h4>
                        <ul class="welcomeLinks">
                          <li> Built-in Pipes.</li>
                          <li>Using parameters and  chaining Pipes.</li>
                          <li>Custom Pipes.  </li>
                           <li>Parameterized Custom  Pipe.</li>
                          <li> Pipes and Change  Detection. </li>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 10.Custom Directives.</h4>
                        <ul class="welcomeLinks">
                          <li>Custom Attribute  Directive.</li>
                          <li>Using HostListener.</li>
                     ...
                     <div class="col-lg-6 col-md-6 text-justify ">
                        ...
                        <ul class="welcomeLinks mt-5">
                          ...
                          <li> Using HostBinding.  </li>
                           <li>Custom Validator  Directive. </li>
                     ...
                     <div class="col-lg-6 col-md-6 ">
                          <h4 class="text-danger">Module 11.Dependency  Injection.</h4>
                        <ul class="welcomeLinks">
                          <li>Understanding Dependency  Injection. </li>
                          <li> Understanding DI in  Angular Framework. </li>
                          <li>Exploring Provider. </li>
                           <li> Types of Tokens.</li>
                          <li>Types of Dependencies.</li>
                          <li>Configuring DI using  Providers</li>
                                <li> Implementing DI in  Angular.</li>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 12: Services in Angular.</h4>
                        <ul class="welcomeLinks">
                          <li> Building and Injecting  Custom Services.</li>
                          <li>Service using another  Service.</li>
                          <li>Built-In $http Service. </li>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 13: Angular Routing</h4>
                        <ul class="welcomeLinks">
                          <li> Configuring and  Navigating. </li>
                          <li> Parameterised routes. </li>
                          <li> Nested (or) Child  Routes.</li>
                          
                        </ul>
                    </div>

                    <div class="col-lg-6 col-md-6 text-justify">
                          <h4 class="text-danger">Module 14: Angular Modules.</h4>
                        <ul class="welcomeLinks">
                          <li>AppModule as Root  Module. </li>
                          <li>Feature modules.</li>
                          <li> Lazy Loading a Module.  </li>
                           <li> Shared Module.  </li>
                    ...
                    <div class="col-lg-6 col-md-6 text-justify">
                         <h4 class="text-danger">Module 15:  Performing CRUD Operations as in Real time  Angular Application.</h4>
                        <ul class="welcomeLinks">
                            <li> Create an ASP.NET MVC  Web API Application.  </li>
  <li> Add Angular Seed,  download files and Configure Project. </li>
  <li> Setup Project for Entity  Framework Code First Model. </li>
  ...
  <li>Add Web API Controller  to perform CRUD Operations using EF.  </li>
  <li>Create Angular Feature  and Routing Modules.</li>
   <li> Configure Angular to use  HTTP and Json Services.</li>
  <li> Program Angular Modules  to performing CRUD Operations. </li>
...
<li>AngularJS Training from 6 Times National Level Award Winner Company:</li>
...
<li>AngularJS Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>AngularJS Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
...
<li>Free online courses for class-room/offline students undergoing AngularJS Training</li>
<li>Get AngularJS Training in 3 modes: (1. Classroom training/Offline training   2. Instructor-led online Live training          3. Self-Paced Online Courses</li>
...
<li>AngularJS Training from 11+ Years old company</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Angular JS Training in Chandigarh Mohali" title=" Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Angular JS Training in Chandigarh Mohali Mohali" title="6 Month Angular JS Training in Chandigarh Mohali Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Angular JS Training in Chandigarh Mohali" title="Angular JS Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

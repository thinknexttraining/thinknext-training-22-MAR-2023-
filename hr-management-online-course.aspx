<%@ Page Title="HR Management Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="hr-management-online-course.aspx.vb" Inherits="HR_training_in_chandigarh_with_management_internship" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">     
    <meta name="description" content="HR Management Online Course - ThinkNEXT is one of the best IT company providing free 6 months and six weeks dot net training in Chandigarh, Mohali. Visit us for .net, PHP, JAVA, Web Designing, iPHONE, Networking and Android." />
    <meta name="keywords" content="HR Management Online Course, HR Course Online, hr certification online, human resources certification online, best online human resources certificate programs, human resources courses online, hr courses near me, human resource management courses distance learning, hr classes online, hr classes online, hr certificate program online, hr certification courses online, human resources classes online, human resources courses distance learning, human resource management online course, human resources certificate online program, human resource management certificate online, study hr online, hr analytics course online, graduate certificate in human resource management online, coursera human resources, coursera hr courses, hr analyst course" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>HR Management Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become HR Expert and Boost your Career. Enroll Now </strong></p>
                <br />
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/hr-management-online-course.aspx"
        });
    </script>
    <script>

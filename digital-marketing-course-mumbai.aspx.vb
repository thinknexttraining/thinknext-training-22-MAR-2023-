...
Partial Class digital_marketing_course_Mumbai
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtMobile.Text <> "" Then
                    ...
                    varclass.SendLeadsDM(txtMobile.Text, txtName.Text, txtEmailId.Text, "Digital Marketing Course", "Arrange a Call Back", "https://www.thinknexttraining.com/digital-marketing-course-mumbai.aspx")
                    txtName.Text = ""
                    txtEmailId.Text = ""
                    txtMobile.Text = ""
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            varclass.SendLeadsDM(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "Digital Marketing Demo", "Demo Class", "https://www.thinknexttraining.com/digital-marketing-course-mumbai.aspx")
            txtdemoName.Text = ""
            txtdemoMblno.Text = ""
            txtdemoEmail.Text = ""
            txtdemoMsg.Text = ""
        ...
        If NameSyl.Text <> "" Then
            If EmailidSyl.Text <> "" Then
                If PhonenoSyl.Text <> "" Then
                    ...
                    cmd.Dispose()
                    con.Close()
                    varclass.SendLeads4(PhonenoSyl.Text, NameSyl.Text, EmailidSyl.Text, "Digital Marketing Course", "Download Syllabus", "https://www.thinknexttraining.com/digital-marketing-course-mumbai.aspx")
                    NameSyl.Text = ""
                    EmailidSyl.Text = ""
                    PhonenoSyl.Text = ""

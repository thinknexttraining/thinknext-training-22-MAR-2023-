    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            If lblweekmonth.Text = "Free 6 Months/6 Weeks" And txtNameR.Text <> "" Then
                SMS2nd = "Dear " & txtNameR.Text & ", Thanks for registration for Free 6 Months/6 Weeks Industrial Training. Exam Date: " & lblnewssss.Text & " Timings: 10:00 AM to 5:00 PM Duration: 20 Minutes Venue: ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon."
            Else
            ...
            varclass.SendLeads(txtContectR.Text, txtNameR.Text, txtEmailR.Text, "None", "Stipend Based Internship", "https://www.thinknexttraining.com/stipend-based-internship-in-chandigarh-mohali.aspx")
            'lblmsg.Visible = True

    <%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="international-certification.aspx.vb" Inherits="summer_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>International Certification - ThinkNEXT</title>
    <meta name="description" content="International Certification - ThinkNEXT" />
   <style>
       .certi-box {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <%--  <img src="images/Larvel.jpg"  alt="Laravel Php Framework Training in Chandigarh Mohali Panchkula" />--%>
     </div>
...
<div class="col-lg-6 col-sm-6">
    <div class="certi-box">
   <a href="cisco-certification.aspx"> <img src="images/cisco-certification.jpg" style="width:100%;"/></a><br />
  <h3><a href="cisco-certification.aspx">CISCO</a></h3>
    <br />
              ...
              <div class="col-lg-6 col-sm-6">
                  <div class="certi-box">
                 <a href="microsoft-certification.aspx">  <img src="images/microsoft-certification.jpg" style="width:100%;"/></a><br />
  <h3><a href="microsoft-certification.aspx">MICROSOFT</a></h3>
                  <br />
              ...
              <div class="col-lg-6 col-sm-6">
                   <div class="certi-box">
 <a href="google-certification.aspx"><img src="images/google-certification.jpg" style="width:100%;"/> </a> <br />
                  <h3><a href="google-certification.aspx">GOOGLE</a></h3>
                  <br />
              ...
              <div class="col-lg-6 col-sm-6">
                  <div class="certi-box">
 <a href="oracle-java-certification.aspx"><img src="images/java-oracle-certification.jpg" style="width:100%;"/> </a><br />
                  <h3><a href="oracle-java-certification.aspx">ORACLE JAVA</a></h3>
                  <br />
              ...
              <div class="col-lg-6 col-sm-6">
                  <div class="certi-box">
 <a href="amazon-certification.aspx"><img src="images/amazone-certification.jpg" style="width:100%;"/> </a><br />
                  <h3><a href="amazon-certification.aspx">AMAZON</a></h3>
                  <br />
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="certi-box">
 <a href="autodesk-certification.aspx"><img src="images/autodesk-certification.jpg" style="width:100%;"/> </a><br />
                  <h3><a href="autodesk-certification.aspx">AUTODESK</a></h3>
                  <br />
               ...
               <div class="col-lg-6 col-sm-6">
                   <div class="certi-box">
<a href="hpe-certification.aspx"> <img src="images/Hpe-certification.jpg" style="width:100%;"/> </a> <br />
                  <h3><a href="hpe-certification.aspx">HPE</a></h3>
                  <br />
                 ...
                 <div class="col-lg-6 col-sm-6">
                     <div class="certi-box">
 <a href="ec-council-certification.aspx"><img src="images/ec-counsil-certification.jpg" style="width:100%;"/> </a><br />
                  <h3><a href="ec-council-certification.aspx">EC-COUNCIL</a></h3>
                  <br />
               ...
               <div class="col-lg-6 col-sm-6">
                   <div class="certi-box">
  <a href="comptia-certification.aspx"><img src="images/comptia-certification.jpg" style="width:100%;"/> </a> <br /> 
                  <h3><a href="comptia-certification.aspx">COMPTIA</a></h3>
                  <br />
...
<div class="rounded_box popular-courses">
 ...
 <asp:Label ID="lblmessgaelogin" runat="server"  >
                            ...
                            <a href="default.aspx">Oracle\SQL Server Course</a><br /> 
...
<br />
				...
				<div class="row" id="profile-grid">
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
				        <div class="panel panel-default">
				          <div class="panel-thumbnail">
				          	<a href="#" title="ThinkNEXT Technologies" class="thumb">
				          		<img  src="awards-img/award-image11.jpg" alt="Best Digital marketing training in chandigarh" class="img-responsive img-rounded" data-toggle="modal" data-target=".modal-profile-lg" />
				          	</a>
				          </div>
				        ...
				        <div class="panel panel-default">
				          <div class="panel-thumbnail">
				          	<a href="#" title="ThinkNEXT Technologies" class="thumb">
				          		<img  src="images/Leadership-Summit-2019-Award.jpg" alt="6 Month industrial training in chandigarh" class="img-responsive img-rounded" data-toggle="modal" data-target=".modal-profile-lg" />
				          	</a>
				          </div>
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
				        <div class="panel panel-default">
				          <div class="panel-thumbnail">
				          	<a href="#" title="ThinkNEXT Technologies" class="thumb">
				          		<img  src="images/awards-1.jpg" alt="Industrial Training Company in chandigarh" class="img-responsive img-rounded" data-toggle="modal" data-target=".modal-profile-lg" />
				          	</a>
				          </div>
     ...
     <div class="col-sm-4 col-md-3 col-xs-12 profile">
				        <div class="panel panel-default">
				          <div class="panel-thumbnail">
				          	<a href="#" title="ThinkNEXT Technologies" class="thumb">
				          		<img  src="images/awards-2.jpg" alt="Php course in chandigarh" class="img-responsive img-rounded" data-toggle="modal" data-target=".modal-profile-lg" />
				          	</a>
				          </div>
				        ...
				        <div class="panel panel-default">
				          <div class="panel-thumbnail">
				          	<a href="#" title="ThinkNEXT Technologies" class="thumb">
				          		<img  src="awards-img/6-weeks-industrial-training-company-chandigarh.jpg" alt="php training in panchkula" class="img-responsive img-rounded" data-toggle="modal" data-target=".modal-profile-lg" />
				          	</a>
				          </div>
...
<script type="text/javascript" src="social-share/jquery.floating-social-share.min.js"></script>
  ...
  $("body").floatingSocialShare({
    ...
    url: "http://www.thinknexttraining.com/international-certification.aspx"
  });
</script>

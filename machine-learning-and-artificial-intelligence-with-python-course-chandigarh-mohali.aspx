<%@ Page Title="Machine Learning and Artificial Intelligence with Python Course in Chandigarh Mohali" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="machine-learning-and-artificial-intelligence-with-python-course-chandigarh-mohali.aspx.vb" Inherits="machine_learning_and_artificial_intelligence_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">

    <meta name="description" content="Machine Learning and Artificial Intelligence with Python Course in Chandigarh Mohali - ThinkNEXT is top Python training company that provides Python training in chandigarh from ThinkNEXT Company expert as trainers and get details on python classes in Chandigarh, " />
    <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/share-images/machine-learning-ai-training-chandigarh.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/share-images/machine-learning-ai-training-chandigarh.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="main-image">   
       <img class="d-md-none" src="images/machine-learning-Ai-course-in-chandigarh-m.jpg" alt="Machine Learning and Artificial Intelligence with Python Course in Chandigarh" title="Machine Learning and Artificial Intelligence with Python Course in Chandigarh">
     <img class="d-none d-md-block" src="images/machine-learning-Ai-course-in-chandigarh.jpg" alt="Machine Learning and Artificial Intelligence with Python Course in Chandigarh" />
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                       <div class="gdl-header-wrapper">
                        <h1>Machine Learning and Artificial Intelligence with Python Course in Chandigarh Mohali</h1>
                    </div>
                  <p>ThinkNEXT Technologies Private Limited is providing the&nbsp;<strong>best Machine Learning &amp; AI with Python training Institute in Chandigarh Mohali.</strong>&nbsp;Well-equipped trainer of<strong>&nbsp;ThinkNEXT</strong>&nbsp;will give you immense knowledge in this field so that you can become an expert in machine learning and have a great career in the future. ThinkNEXT always believe in the Job oriented training program with practical knowledge. ThinkNEXT provides&nbsp;<strong>best Machine learning &amp; AI course in Chandigarh Mohali.</strong></p>
                      <p>We have open discussions and meeting sessions where teams can work in collaboration and interact with each other. We are on a mission to transform the lives of the people by accessing the world&rsquo;s best learning experience. We have courses that are taught by top instructors.&nbsp;<strong>ThinkNEXT</strong>&nbsp;is a platform where anyone, anywhere can learn from the best educational providers. After the completion of the&nbsp;<strong>best Machine learning &amp; AI training course in Chandigarh Mohali</strong>, you will receive a course certificate.</p>
                      <p>Top MNC&rsquo;s JP Morgan, Accenture, Aricent, Fiserv, SAP, Sutherland, Intel, AIG, Bosch, and Qualcomm are hiring Machine Learning experts</p>
                    ...
                    <div class="pad-top-bot0 pd-lft-rght-5prcnt position-sticky top-0">                      
                            ...
                            <div class="without_border dwl1 text-center">
                                ...
                                <a href="BroucherDownload.aspx?data=Brochure" onclick="broucherdownload();" target="broucher">
                                    <img src="images/download_brochure.png" alt="Machine Learning and Artificial Intelligence Course in Chandigarh">
                                </a>
        ...
        <div class="container">
            <div class="row m-0 p-2">
                <div class="col-lg-6">
                    ...
                    <iframe class="thknxtytube" src="https://www.youtube.com/embed/nO2ge74W0Zo?autoplay=1&rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>
                    </div>
                <div class="col-lg-6">
                    <div class="position-sticky top-0 text-white text-justify">

                        <h4 class="text-warning"><strong>Machine Learning & AI</strong></h4>
                        <p>To provide system an ability to automatically learn and improve from experience without being explicitly programmed is known as Machine learning which an application of Artificial Intelligence (AI). The complex task which cannot be described by humans easily and doesn’t know how to accomplish the task then machine learning plays an important role to make a computer learn these complex tasks. </p>
                        <p>Artificial Intelligence is a part of computer sciences that give special importance in the creation of intelligent machines that work and reacts like humans. It has become an important part of the IT Industry.</p>
    ...
    <section class="py-4">
        <div class="container">
            <div class="d-none d-md-block">
                <div>
                    <img src="images/industrial-training-comapny-chandigarh.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div>
                    <img src="images/six-weeks-summer-training-chandigarh.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div>
                    <img src="images/summer-training-in-mohali.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
            </div>
            <div class="d-md-none">
                <div class="text-center">
                    <img src="images/industrial-training-comapny-chandigarh-1.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/industrial-training-comapny-chandigarh-2.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/six-weeks-summer-training-chandigarh-1.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/six-weeks-summer-training-chandigarh-2.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/summer-training-in-mohali-1.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/summer-training-in-mohali-2.jpg" alt="Artificial Intelligence with Python Course in Chandigarh" />
                </div>
            </div>
        </div>
    ...
    <section class="py-5">
          <div class="container">
              <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>Course Syllabus</strong></h3>
            </div>
              <h3 class="text-danger text-md-center mt-4 mt-md-5"><strong>Python</strong></h3>
              <div class="row">
                  <div class="col-lg-4 col-md-4 text-justify">
                      <ul class="welcomeLinks mb-0">
                          <li>Introduction to Python </li>
                          <li>Installing Python and Jupyter on Windows	</li>
                          <li>Python Data Types PART-1 </li>
                          <li>Python Data Types Part2 </li>
                          <li>Python Data Types Part3	</li>
                          <li>Control Flow in Python </li>
                          <li>For Loop in Python </li>
                           <li>While Loop in Python	</li>
                          <li>Methods and Functions in Python	</li>
                  ...
                  <div class="col-lg-4 col-md-4 text-justify">
                      <ul class="welcomeLinks mb-0">
                          ...
                          <li>Arguments and Keyword Arguments in Python	</li>
                          <li>Map Filter and Lambda Expressions in Python	</li>
                          <li>Nested Statements and Their Scope	</li>
                          <li>Introduction to OOP in Python	</li>
                          <li>Object Oriented Programming in Python Part2	</li>
                  ...
                  <div class="col-lg-4 col-md-4 text-justify">
                      <ul class="welcomeLinks mb-0">
                          <li>Dunder methods in Python	</li>
                          <li>Modules and Packages	</li>
                          <li>Writing Modules and Packages	</li>
                          <li>Name and Main	</li>
                          <li>Errors and Exceptions Handling	</li>
                          <li>Testing Tool Pylint in Python	</li>
                          <li>Testing Tool Unittest in Python	</li>
                          <li>Decorators in Python	</li>
                          <li>Generators in Python</li>
                      </ul>
                  </div>
                  <div class="col-12"><h3 class="text-danger text-md-center mt-4 mt-md-5"><strong>Advance Python</strong></h3></div>
                  <div class="col-lg-3 col-md-4 text-justify">                 
                      <ul class="welcomeLinks mb-0">
                          <li>Collections Module in Python Part-1 </li>
                          <li>Collections Module in Python Part-2 </li>
                          <li>Datetime Module in Python </li>
                          <li>Python Debugger and Timit </li>
                       ...
                       <div class="col-lg-4 col-md-4 text-justify">
                            <ul class="welcomeLinks mb-0">
                             <li>IO Module and Advance Numbers in Python </li>
                          <li>GUI in Python </li>
                          <li>Advance Data Types Part-1 </li>
                          <li>Advance Data Types Part-2 </li>
                          <li>Final Capstone Project</li>
                                </ul>
                           </div>
                  
                  <div class="col-lg-4 col-md-4 text-justify">
                       <p class="mt-3"><strong class="textred">Projects</strong></p>
                      <ul class="welcomeLinks">
                          <li>Python Games Projects Flappybird and Pacman	</li>
                      </ul>
                           </div>


                      <div class="col-12"><h3 class="text-danger text-md-center mt-4 mt-md-5"><strong>Machine Learning</strong></h3></div>
                  <div class="col-lg-3 col-md-4 text-justify">
                      <ul class="welcomeLinks mb-0">
                          <li>Introduction to Machine Learning </li>
                          <li>Machine Learning Process </li>
                          <li>Machine Learning Task </li>
                          <li>Fuzzy Logic </li>                       
                  ...
                  <div class="col-lg-4 col-md-4 text-justify">                     
                   ...
                   <div class="col-12"><h3 class="text-danger text-md-center mt-4 mt-md-5"><strong>Artificial Intelligence</strong></h3></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-justify text-white">
                    <h4 class="text-warning"><strong>Benefits of AI and Machine Learning</strong></h4>
                        <p>Artificial Intelligence and Machine Learning may be the next big bet in information security. The logic behind artificial intelligence is still a slightly distorted subject. Some people argue that the algorithms used in antivirus software to recognize potential threats are artificially intelligent. But, it's much more than that! </p>
                        <p>While cognitive advances are clearly uncovered in numerous industries, in the field of information security we still need a lot of help as we have several challenges in the future.</p>
                        <p>The exciting and promising market for Machine Learning security is now. But, Data Scientists are in high demand and difficult to find. Universities fail to meet a growing demand, partly driven by the increasing search for classifying and making sense of information from terabytes of data </p>
                </div>
                 ...
                 <div class="col-md-6">
                     <div class="position-sticky top-0">
                      ...
                      <div class="py-3 px-4 bg-light">
                          <h3 class="text-danger text-center"><strong>Book My Free Demo Class Now!</strong></h3>
                          <div class="mt-3">
...
<li>Machine Learning and Artificial Intelligence Training from 6 Times National Level Award Winner Company:</li>
...
<li>Machine Learning and Artificial Intelligence from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>Machine Learning and Artificial Intelligence Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title=" Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Machine Learning Training in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Machine Learning Training in Chandigarh" title="Machine Learning Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Machine Learning Training in Chandigarh" title="Machine Learning Training in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Machine Learning and Artificial Intelligence Course in Chandigarh Mohali" title="6 Month Machine Learning and Artificial Intelligence Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="Machine Learning and Artificial Intelligence Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="ThinkNEXT Technologies" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="ThinkNEXT Technologies" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="ThinkNEXT Technologies" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="ThinkNEXT Technologies" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="ThinkNEXT Technologies" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Machine Learning and Artificial Intelligence Course in Chandigarh" title="ThinkNEXT Technologies" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

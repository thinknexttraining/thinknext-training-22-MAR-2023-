<%@ Page Title="Create Profile" Language="VB" MasterPageFile="~/Staff/MasterAdmin.master" AutoEventWireup="false" CodeFile="~/Staff/CreateProfile.aspx.vb" Inherits="Admin_CreateProfile"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <td>
   ...
   <h3> 
      <asp:Label ID="lblprofile" runat="server" Text="Update Profile"></asp:Label> </h3>
      ...
      <div id="profile" style="width: 100%; height: 396px">
              ...
              id="tabxxx">
                        ...
                        <tr>
                            ...
                            <td align="left"  style="width: 235px; height: 20px">
                                ...
                                <asp:CalendarExtender ID="txtdob_CalendarExtender" runat="server" 
                                    DaysModeTitleFormat="MM/dd/yyyy" Enabled="True" TargetControlID="txtdob" 
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 132px; height: 19px">
                                <asp:TextBox ID="txtSalaryAtPresent" runat="server" BorderStyle="Solid" Font-Size="Small" 
                                    Height="14px" SkinID="MytextID" 
                                    style="font-size: x-small;  background-color: #FFFFFF;" 
                                    Width="207px" BorderWidth="1px"></asp:TextBox>
                            </td>
        ...
        <p style="height: 35px"> 
            <asp:Button ID="btnAddProfile" runat="server" CssClass="Allbuttons" Text="Add Profile" Width="120px" Visible="false" />
            <asp:Button ID="btnSaveUpdate" runat="server" CssClass="Allbuttons" 
                Text="Update Profile"  Width="120px" Visible="false" Height="22px"/>
          </p>

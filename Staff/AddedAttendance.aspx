<%@ Page Language="C#" MasterPageFile="~/Staff/MasterAdmin.master" AutoEventWireup="true" CodeFile="AddedAttendance.aspx.cs" Inherits="Staff_AddedAttendance" Title="Added Attendance" %>
...
<tr>
<th colspan ="4"><center><h2>Display Added Attendance</h2></center></th>
</tr>
<tr>
<td>
    &nbsp;</td>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Name">
         ...
         <asp:TemplateField HeaderText="Batch">
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Batchgroup ") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>

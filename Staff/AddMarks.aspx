<%@ Page Title="Add Marks" Language="VB" MasterPageFile="~/Staff/MasterAdmin.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddMarks.aspx.vb" Inherits="Admin_AddMarks" %>
       ...
       <table id="tabpageicon" style="width: 92%; height: 45px;">
           <tr>
               ...
               <td style="width: 130px">
                  <asp:Label ID="Label1" runat="server" Text="Add Marks"  
                ...
                <ProgressTemplate>
                    ...
                    <br />
                            ...
                            <asp:Label ID="lblMsg" runat="server" Font-Bold="True" Font-Size="Medium" 
                                ...
                                <asp:Label ID="lblMessages" runat="server" Font-Bold="true" Font-Size="Medium" ForeColor="Red"></asp:Label>
                            &nbsp;<br />
                        </td>
                </tr>
                <tr>
                    <td align="center" style="height: 63px; text-align: left;" 
                        valign="top">
                        <asp:Panel ID="Panel3" runat="server" GroupingText="Set Marks" Height="88px" 
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 135px" valign="middle">
                                        <asp:Label ID="lblsetlecturesAttended" runat="server" SkinID="MytextID" 
                                            style="font-size: small" Text="Set Obtain Marks :" Visible="False"></asp:Label>
                                    </td>
                                    <td align="left" style="width: 119px" valign="middle">
                                        <asp:TextBox ID="textBoxLectAttended" runat="server" Height="14px"   
                                            MaxLength="3" SkinID="MytextID" style="font-size: x-small" Width="100px" Visible="False"></asp:TextBox>
                                    </td>
                                    <td align="left" valign="top" style="width: 92px">
                                         <asp:Button   CssClass="Allbuttons" ID="btnLecturesAttended" runat="server"  
                                            ...
                                            Width="42px" ValidationGroup="LAT" Visible="False" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>

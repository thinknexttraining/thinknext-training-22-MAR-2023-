<%@ Page Title="Google SketchUp Training in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="Google-sketchup-training-in-chandigarh.aspx.vb" Inherits="google_sketchup_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="Google SketchUp Training in Chandigarh - ThinkNEXT is best Google SketchUp Training Company providing Google Sketchup Training in Chandigarh" />
    <meta name="keywords" content="Google SketchUp Training in Chandigarh, Google SketchUp Course in Chandigarh, Google SketchUp Training Institute in Chandigarh" />
      <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/images/google-sketchup-training-in-chandigarh-mob.jpg" />
     <meta property="og:image" content="http://www.thinknexttraining.com/images/google-sketchup-training-in-chandigarh-mob.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image">
         <img class="d-md-none"  src="images/google-sketchup-training-in-chandigarh-mob.jpg" alt="Google SketchUp Training in Chandigarh" />
            
     <img class="d-none d-md-block" src="images/google-sketchup-training-in-chandigarh.jpg" alt="Google SketchUp Training in Chandigarh" />
...
<p> To learn this course you are not required to entail any knowledge of any high level application. We just believe you to have basic computer knowledge and creative mind. </p>  
    ...
    <section class="py-4">
        <div class="container">
            <div class="d-none d-md-block">
                ...
                <div>
                    <img src="images/six-weeks-summer-training-chandigarh.jpg" alt="Google SketchUp Training in Chandigarh" />
                </div>
                <div>
                    <img src="images/summer-training-in-mohali.jpg" alt="Google SketchUp Training in Chandigarh" />
                </div>
            </div>
            <div class="d-md-none">
                <div class="text-center">
                    <img src="images/industrial-training-comapny-chandigarh-1.jpg" alt="Google SketchUp Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/industrial-training-comapny-chandigarh-2.jpg" alt="Google SketchUp Training in Chandigarh" />
                </div>
                <div class="text-center">
                    <img src="images/six-weeks-summer-training-chandigarh-1.jpg" alt="Google SketchUp Training in Chandigarh" />
                </div>
                <div class="text-center">
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="Google SketchUp Training in Chandigarh" title="Google SketchUp Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="Google SketchUp Training in Chandigarh" title="Google SketchUp Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="Google SketchUp Training in Chandigarh" title="Google SketchUp Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="Google SketchUp Training in Chandigarh" title="Google SketchUp Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="Google SketchUp Training in Chandigarh" title="Google SketchUp Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="Google SketchUp Training in Chandigarh" title="Google SketchUp Training in Chandigarh">
                </div>
    ...
    <section class="py-4">
        <div class="container">
                ...
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>Google Sketchup Training – Course Content</strong></h3>
             ...
             <div class="col-sm-6 col-md-6 mt-3 text-justify">
              <h3 class="text-danger">Module 1:Introduction To Sketchup</h3>    
                 <ul class="welcomeLinks">
                   
<li>Designing in SketchUp</li>
<li>Drawing Quickly</li>
<li>Viewing Models in 3 Dimensions</li>
<li>Adding Detail to Your Models</li>
<li>Presenting Your Models</li>
<li>Modeling Terrain and Organic Shapes</li>
<li>Application User Interface</li>
</ul>

                 </div>
                   
                     <div class="col-sm-6 col-md-6  mt-3 text-justify">
                          <h3 class="text-danger">Module 2:Application User Interface</h3>
                         <ul class="welcomeLinks">
...
<li>Status Bar</li>
                      ...
                      <div class="col-sm-6 col-md-6  mt-3 text-justify">
                           <h3 class="text-danger">Module 3: Principal Tools</h3>
  <ul class="welcomeLinks">
<li>Select Tool</li>
...
<li>Paint Bucket Too</li>
                ...
                <div class="col-sm-6 col-md-6  mt-3 text-justify">
  <h3 class="text-danger">Module 4:Drawing Tools</h3>
                  <ul class="welcomeLinks mb-0">
...
<li>Polygon Tool</li>
  ...
  <h3 class="text-danger">Module 5: Construction Tools</h3>
                   <ul class="welcomeLinks mb-0">
                     

<li>Tape Measure Tool</li>
<li>Protractor Tool</li>
<li>Axes Tool</li>
<li>Dimensions Tool</li>
<li>Text Tool</li>
<li>Section Plane Tool</li>
...
<li>Zoom Window Tool</li>
                     ...
                     <div class="col-sm-6 col-md-6  mt-3 text-justify">
  <h3 class="text-danger">Module 6: Walkthrough Tools</h3>
                  <ul class="welcomeLinks mb-0">
                     
<li>Position Camera Tool</li>
<li>Walk Tool</li>
<li>Look Around Tool</li>
<li>Camera Tools</li>
<li>Previous</li>
<li>Standard Views</li>
<li>Orbit Tool</li>
...
<li>Zoom Window Tool</li>
<li>Walkthrough Tools</li>
<li>Position Camera Tool</li>
<li>Walk Tool</li>
<li>Look Around Tool</li>
<li>Rendering Tools</li>
<li>Face Style</li>
<li>Soft Smooth Edge</li>
<li>Section</li>
</ul>
                </div>
                     ...
                     <div class="col-sm-6 col-md-6  mt-3 text-justify">
  <h3 class="text-danger">Module 7: Model Settings And Managers</h3>
                  <ul class="welcomeLinks mb-0">
           
<li>Model Info Dialog Box</li>
<li>Entity Info Dialog Box</li>
<li>Material Browser</li>
<li>Material Editor</li>
<li>Component Browser</li>
<li>Layer Manager</li>
...
<li>Page Manager</li>
<li>Display Settings Dialog Box</li>
<li>Shadow Settings Dialog Box</li>
<li>Soften Edges Dialog Box</li>
<li>Component Outliner</li>
<li>Application Preferences Dialog Box</li>
</ul>
                </div>
...
<li>Google Sketchup Training from 6 Times National Level Award Winner Company:</li>
...
<li>Google Sketchup Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>Google Sketchup Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Best Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Google Sketchup Training in Chandigarch Mohali Mohali" title="6 Month Google Sketchup Training in Chandigarch Mohali Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Google Sketchup Training in Chandigarch Mohali" title="Google Sketchup Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

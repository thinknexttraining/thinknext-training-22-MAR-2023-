<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="it-training-internship-in-chandigarh-mohali.aspx.vb" Inherits="it_training_internship_in_chandigarh_mohali" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <title>Information Technology Training Internship in Chandigarh Mohali</title>
    <meta name="description" content="ThinkNEXT is one of the best IT company providing free 6 months and six weeks dot net training in Chandigarh, Mohali. Visit us for .net, PHP, JAVA, Web Designing, iPHONE, Networking and Android." />
...
z-index: 999;
    ...
    margin-left: auto;
     ...
     <script type="text/javascript">
         ...
         function broucherdownloadwithsyllabus() {
             var states = document.getElementById('brochiframe-withsyllabus').style.display;
             if (states == 'block') {

                 document.getElementById('brochiframe-withsyllabus').style.display = 'none';


             } else {
                 document.getElementById('brochiframe-withsyllabus').style.display = 'block';
             }
         };
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <img src="images/IT-industrial-training-course-in-mohali.jpg" width="100%" alt="IT Training Internship in Chandigarh Mohali Panchkula">
    ...
    <div class="body-container">
        ...
        <div class="panel-group col-md-8" id="accordion">
            ...
            <div class="col-lg-12 text-justify">
                 <br />
                   <h1>Information Technology Training in Chandigarh Mohali Panchkula &nbsp; </h1>
            <br />
                <br />
               <p><strong>Information Technology (IT)</strong> is a result of globalization that makes the workplace proficient hence, upgrade the rate of efficiency. It has open ways to the outside world as communication turned out to be significantly simpler and helpful. Because of this avenues, business opportunities, and jobs are opening up. The issue of keeping records into documents are removed through the assistance of PCs and its applications. It is gift of <strong>IT</strong> that individuals can work from anywhere in the world.
</p>
            <p>    
           

 <i class="fa fa-hand-o-right"></i>&nbsp Information Security Management<br />
  <i class="fa fa-hand-o-right"></i>&nbsp IT Strategy and Management<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Organizational Behavior and Design<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Marketing Management and Planning<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Digital Marketing (SEO, SMO, SEM)<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Digital Economy<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Tally ERP<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Strategic Management<br />
  <i class="fa fa-hand-o-right"></i>&nbsp SWOT Analysis<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Accounting and Financial Management<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Database Management<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Systems Analysis and Design<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Process Analysis and Problem Solving<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Distributed Computing Technologies<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Business Intelligence for the Enterprise<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Advanced Studies in IT<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Cloud Computing and Mobile Applications for the Enterprise<br />
  <i class="fa fa-hand-o-right"></i>&nbsp The Digital Economy<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Project Management<br />
  <i class="fa fa-hand-o-right"></i>&nbsp System Development &amp; Procurement<br />
  <i class="fa fa-hand-o-right"></i>&nbsp IS / IT Strategy<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Business Creativity and Innovation.<br />
  <i class="fa fa-hand-o-right"></i>&nbsp Project Work.<br />
</p>
<div>
  <h2>OUR FEATURES</h2>
  <div></div>
</div>
<p>Our IT Training is focused on increasing the efficiency and professionalism of the IT Team and this is the main goal of our IT Training Program.</p>
<div>
  <h4><strong>IT Training Certification, Placement and other Activities:</strong></h4>
  <div></div>
</div>
                <p>

  <i class="fa fa-hand-o-right"></i>&nbsp Free Spoken English, Personality Development &amp; IELTS Classes on Daily basis (Worth Rs. 15000/-)<br />
  ...
  <i class="fa fa-hand-o-right"></i>&nbsp Part Time / Full Time Job Offer for each student during training (Earn while you learn)<br />
           ...
           <a href="BroucherDownload.aspx?data=Management Internship Brochure" onclick="broucherdownload();"  target="broucher"><img src="images/download_brochure.png" alt="Java Course" border="0" /></a>     
             
 

                 
          <div class="brochiframe" id="brochiframe-withsyllabus">
          
            <iframe name="broucher1" style="height:500px; width :650px;"></iframe>
            <span onclick="clsifrm11()" >
            <img alt="Close" src="images/close.png" style="margin-top:-67%; margin-right:3px; height:35px; width:35px; border-style:none; "  /> </span>
               
          </div>

           <a href="BroucherDownload.aspx?data=Management Internship Brochure With Syllabus" onclick="broucherdownloadwithsyllabus();"  target="broucher1"><img src="images/dwnld-wth-sylbs.jpg" alt="Java Course" border="0" /></a>     
 ...
 <div class="right" style="padding-top:12px;">
    ...
    <img src="images/loader.gif" alt="Java Training" />
</div>
...
<%-- <div class="right_box" style="margin-top:9%; float:right">--%>
                   ...
                   <p style="color:#fff;font-weight:bold;margin:0px !important;     padding: 3px 0px;   text-shadow: 2px 2px 3px #969698; border-top-left-radius: 10px; border-top-right-radius: 10px;background-color: red;text-align: center;width: 100%;font-size:17px;margin:0px;clear:both;">Career Counselling</p>
<div class="rounded_box" style="background-color:white;">
<div style="padding:10px;"> 
 <asp:Label ID="Label2"  style="text-align:center;" runat="server"  Font-Bold="True" Font-Size="9.3">
              <div style="width:100px;float:left;"><img src="images/silhouette.png" alt="Java" style="border-radius:100%;" width="150px" /></div>
...
<iframe  class="thknxtytube" style="width:100%;height:450px;" src="https://www.youtube.com/embed/jDSPWREBU0c?&autoplay=1&loop=1&rel=0&showinfo=0&color=white&iv_load_policy=3" frameborder="0" allowfullscreen></iframe>
    </div>
...
<script type="text/javascript" src="social-share/jquery.floating-social-share.min.js"></script>
  ...
  $("body").floatingSocialShare({
    ...
    url: "http://www.thinknexttraining.com/HR-training-in-chandigarh-with-management-internship.aspx"
  });
</script>

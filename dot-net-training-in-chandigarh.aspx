<%@ Page Title="ASP.NET Training in Chandigarh - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="dot-net-training-in-chandigarh.aspx.vb" Inherits="dot_net_training_in_chandigarh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   
  <meta name="description" content="ThinkNEXT Technologies is best dot net (.net) company in Mohali Chandigarh panchkula INDIA. Best institute for ASP.Net, dot net framework, dot net (.net)training institute/company in Punjab Region." />
   ...
   <!-- Facebook sharing image show  -->
     <link rel="image_src" href="http://www.thinknexttraining.com/images/dot-net-training-in-chandigarh-mob.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/images/dot-net-training-in-chandigarh-mob.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main-image position-relative">
        ...
        <img class="d-md-none" src="images/dot-net-training-in-chandigarh-mob.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" />
        <img class="d-none d-md-block" src="images/dot-net-training-in-chandigarh-min.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" />
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                        <div class="gdl-header-wrapper">
                            <h1>Best Dot NET Training in Chandigarh Mohali Panchkula</h1>
                        </div>
                        <p>100% Job assured career courses in Mohali & Chandigarh, <strong>Brand ThinkNEXT</strong>  provide professional and best Dot Net training in Mohali & Chandigarh with live projects & 100% Job assistance with our course you can start your professionalism as a Dot NET Developer as well as an online .NET Freelancer.</p>
                        <p>.NET is an object-oriented programming (OOP) model introduced to help developers to build web based distributed systems. It provides a platform-independent framework that enables developers to quickly develop, deploy, and manage Web-based applications, smart client applications, and XML Web services applications. The platform-independence feature enables businesses to quickly integrate their systems, information, and devices, thereby helping users collaborate and communicate effectively.</p>
                        <p id="callnow_btn"><a class="button-2 rv-button type1 text-decoration-none" href="tel:7837401000"><span class="fusion-button-text">CALL US NOW AT <strong>78374-01000</strong> FOR PROFESSIONAL .NET TRAINING</span></a></p>
                        <p>.Net can be used to develop <strong>Web Application, Enterprise Application, Desktop Application and Mobile Application</strong></p>
  ...
  <section class="py-4 bg-ececec">
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="ASP.NET Training in Chandigarh" title="ASP.NET Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="ASP.NET Training in Chandigarh" title="ASP.NET Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="ASP.NET Training in Chandigarh" title="ASP.NET Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="ASP.NET Training in Chandigarh" title="ASP.NET Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="ASP.NET Training in Chandigarh" title="ASP.NET Training in Chandigarh">
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="ASP.NET Training in Chandigarh" title="ASP.NET Training in Chandigarh">
                </div>
            ...
            <div class="row m-0 p-2">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="position-sticky top-0">
                        <h2 class="text-danger">Job Opportunities After Completing Dot NET Training in Chandigarh</h2>
                        <div class="text-justify">
                            <p>
                                With an increase in the number of active internet users and the widespread use of smartphones and software applications, the demand for software applications across different platforms, devices, domains and operating systems created and curated for different target audiences has significantly increased for all industries and sectors. The software application development industry has now become one of the most lucrative career fields for the new and aspiring IT and software professionals, especially with the newer and improved tools and frameworks for application development that make the entire process easier and more streamlined with interconnected tools and services at a single point of access and control.
                            </p>

                            <p>
                                The dot net is one such software development framework, developed by the Microsoft foundation, that provides a single platform for the different developer resources like developer tools, programming languages, libraries, IDE (integrated development environment), etc.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>Dot NET Development - Course Contents</strong></h3>
            </div>
            <br>
            
                <div class="row"> 
                     <br />
                  <h4 class="text-danger">INTRO TO WEB TECHNOLOGIES</h4>
             <div class="col-lg-4 col-md-4 text-justify">                
                 <ul class="welcomeLinks mb-0">
                    <li>   HTML </li>
     <li>  Client side scripting langs </li>
      <li>  IIS Architecture </li>
    <li>  ASP.NET INTRODUCTION </li>
     <li>  What is ASP.NET </li>
     <li>  Image Technique and code behind techniques </li>
    <li>  SERVER SIDE CONTROLS </li>
    <li>  Type of server controls </li>
     <li>  Examples on Web server controls </li>
    <li>  Validation Controls </li>
     <li>  ASP.NET Page Execution Architecture </li>
                ...
                <div class="col-lg-4 col-md-4 text-justify">
                 ...
                 <ul class="welcomeLinks mb-0">
                         <li>  Theme and Skin State Management</li>
                 <li>  Console Application Development </li>
    <li>  Windows Application Development </li>
    <li>  Web Application Development (ASP.NET using C#) </li>
    <li>  MVC </li>
    ...
    <li>  Cookies </li>
    <li>  Session State </li>
    <li>  Session Tracking Arch </li>
    <li>  Application object </li>
    <li>  Session and App events </li>
    <li>  Global. AJAX </li>
    <li>  Viewstate </li>
             ...
             <div class="col-lg-4 col-md-4 text-justify">
                 <br />
                  <h4 class="text-danger">ADO.NET</h4>  
                 <ul class="welcomeLinks">
             <li> Intro to ADO.NET Providers </li>
   <li> Data Reader </li>
   <li> Dataset </li>
   <li> Datalist </li>
   <li>  Repeater </li>
  <li>  Datasource Controls </li>
  <li>  Grid view </li>
  <li>  Details view </li>
  <li>   List view </li>
                ...
                <div class="col-lg-4 col-md-4 text-justify">
                 <br />
                  <h4 class="text-danger">LINQ CACHING</h4>
                 <ul class="welcomeLinks">
              <li> Importance of Caching </li>
 <li>  ASP 4.5 Support for Caching </li>
 <li>  Type of Caching in ASP.NET </li>
 <li>   Output Caching </li>
 <li>  Web user control(VS) custom control </li>
  <li> Fragment caching </li>
 <li>   Data caching vs Application object </li>
                    </ul>
                    ...
                    <div class="col-lg-4 col-md-4 text-justify">
                 <br />
                  <h4 class="text-danger">ASP.NET CONFIGURATION</h4>
                        <ul class="welcomeLinks">
                            <li>Machine config vs Web config </li>
                            <li>App Settings </li>
                            <li>Compilation setting </li>
                            <li>Custom error setting </li>
                            <li>Session State Setting </li>
                            <li>Enhancement in ASP.NET </li>
                            <li>Inprocess VS out process  session state </li>
                            <li>State server and SQL Server </li>
                            <li>Cookie less session </li>
               ...
               <div class="row"> 
                   ...
                   <div class="col-lg-4 col-md-4 text-justify">
                       <br />
                       <h4 class="text-danger">E-MAIL SERVER SECURITY IN ASP.NET</h4>
                       <ul class="welcomeLinks">
                           <li>Authentication & Authorization </li>
                           <li>Windows Based Authentication </li>
                           <li>Form Based Authentication </li>
                           <li>Passport Authentication </li>
                           <li>Membership </li>
                       </ul>
                            <br />
                  <h4 class="text-danger">ASP.NET TRACING</h4>
                        <ul class="welcomeLinks">
                            <li>Page Level </li>
                ...
                <div class="col-lg-4 col-md-4 text-justify">
                 <br />
                  <h4 class="text-danger">XML WEB SERVICES</h4>
                    <ul class="welcomeLinks">
                        <li>Intro to Web Services </li>
                        <li>Role of WSDL .NET support for XML Web Service </li>
                        <li>Client Apps for Web Service </li>
                        <li>Caching Web Service </li>
                        <li>SOAP </li>
                        <li>UDDI Registry </li>
                    </ul>
                    ...
                    <div class="col-lg-4 col-md-4 text-justify">
                         ...
                         <br />
                  <h4 class="text-danger">WCF MASTER PAGES SITE NAVIGATION WEB PARTS</h4>
                        <ul class="welcomeLinks">
                            <li>Web part manager </li>
                            <li>Zone Types </li>
                            <li>Live Project </li>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-thumb.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-award-thumb.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/mohali-sithith-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/mohali-sithith-dm-award-thumbn.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-yugmarg.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-yugmarg-thumb.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-honor-thumb.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-honor-thumb.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award-chd.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-chd-thumb.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-mohali.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-mohali-thumb.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" alt="ASP.NET Training in Chandigarh">
                                </a>
                            </div>
                        </div>
...
<li>Dot NET Training from 6 Times National Level Award Winner Company:</li>
...
<li>Dot NET Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>Dot NET Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit &amp; Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Dot NET Training in Chandigarh Mohali" title="Best Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Cyber Security Course in Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Dot NET Training in Chandigarh Mohali" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Dot NET Training in Chandigarh Mohali" title="Dot NET Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg">
                            </a>
                        </div>

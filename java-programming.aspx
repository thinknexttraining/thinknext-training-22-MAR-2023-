<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/java-programming.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Java Programming - ThinkNEXT Technologies</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Java Programming &nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / Java Programming 
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
             ...
             <p><strong>Java</strong> is a <strong>programming language</strong> that was  designed to have the feel and look of C++. But java is very simple as compared  to C++. Java is object-oriented programming model. Java is creating to complete  the various applications. These applications may run on a single system or  various servers or clients that are present in the network.</p>

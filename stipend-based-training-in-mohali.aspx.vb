...
Partial Class stipend_based_industrial_training
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            varclass.SendLeads(txtContectR.Text, txtNameR.Text, txtEmailR.Text, "None", "Register for Stipend Based Industrial Training", "https://www.thinknexttraining.com/stipend-based-training-in-mohali.aspx")

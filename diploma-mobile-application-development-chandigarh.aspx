<%@ Page Title="Computer Institute in Chandigarh - ThinkNEXT" Language="VB"  MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="diploma-mobile-application-development-chandigarh.aspx.vb" Inherits="mobile_apps_development_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   

<meta name="description" content="ThinkNEXT Technologies Pvt. Ltd. providing diploma in Mobile Application development in Chandigarh, Mohali with iPhone, Andriod, iOS Objective-C, Phonegap, Eclipse, jQuery,Json." />
<meta name="keywords" content="diploma in mobile application development, mobile application development" />
...
<link rel="canonical" href="http://www.thinknexttraining.com/diploma-mobile-application-development-chandigarh.aspx" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="main-image">  
             <img class="d-md-none" src="images/mobile-app-devlopment-min.jpg" alt="Develop Mobile Apps in Chandigarh" />
       <img src="images/mobile-app-devlopment-min.jpg" alt="Develop Mobile Apps in Chandigarh"  />
            ...
            <div class="row m-0">
                <div class="col-md-8">
                    <div class="p-2 border text-justify position-sticky top-0">
                      ...
                      <h1>Diploma in Mobile Application in Chandigarh, Mohali</h1>
                        </div>
          
                     <p>In this course students will learn to develop mobile applications across multiple platforms including ios, android and window. After completing this mobile application development course in Chandigarh, you’ll understand how to develop mobile application using as Objective-C (Interface Builder for Apple), Java and Eclipse (for Android) combined with SDK(Software Development Kit) and by using 3rd party libraries such as Phone gap and Jquery libraries .</p>
                        <ul class="welcomeLinks">
                            <li> Core Java, OOPs Concepts</li>
                            <li> Introduction to Android</li>
                            <li> Setting Android Development Environment</li>
                            <li> Creating Application & Activity</li>
                            <li> Creating User Interfaces</li>
                            <li> Intents, Broadcast Receivers,Adapters</li>
                            <li> Menus, Preferences</li>
                            <li> Multimedia</li>
                            <li> 3D Graphics</li>
                            <li> Multi Touch</li>
                            <li> Databases and Content Providers</li>
                            <li> Working in Baackground</li>
                            <li> Advance Android Development</li>
                            <li> Project Work</li>
            ...
            <div class="row m-0 p-2">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="position-sticky top-0">
                        <h2 class="text-danger">Introduction to iPhone and Objective -C:</h2>
                        <ul class="welcomeLinks">
                            <li> XCode</li>
                            <li> XCodeCont.. SQLite, PList</li>
                            <li> XcodeCont.. File Handling</li>
                            <li> XcodeCont.. Core Data and Localization</li>
                        </ul>

                        <h2 class="text-danger">Career after Mobile Application Development:</h2>
                        <ul class="welcomeLinks">
                            <li> Mobile Application Developer</li>
                            <li> Windows Mobile App Developer</li>
                            <li> Software Engineer</li>
                            <li> Java Application Developer</li>
                            <li> Objective C Developer:  C# “C Sharp” Developer</li>
                            <li> Businesses & Hiring Managers</li>
                            <li> Android Application Developer</li>
                            <li> iPhone/iOS Application Developer</li>
                            <li> Blackberry Application Developer</li>
                        </ul>
                    </div>
                </div>

...
public partial class ESDM : System.Web.UI.Page
{
    ...
    //{
    //    //ScriptManager.RegisterStartupScript(GetType(), "Javascript", "javascript:toggle(); ", true);

    //      ScriptManager.RegisterStartupScript(this, this.GetType(), "Anyname",  "toggle();", true);
    //}
    //protected void Coomanevent(object sender, EventArgs e)
    //{
    ...
    //        Session["s"] = "Assembly & Maintenance of PCs";
    //    }
    //    else if (button.CommandName == "B")
    //    {
    //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Anyname", "toggles();", true);
    //        Session["s"] = "BSNL Certified Telecom Technician-PC Hardware and Networking";
    //    }
    //    else if (button.CommandName == "C")
    //    {
    //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Anyname", "toggles();", true);
    //        Session["s"] = "Embedded System Design using 8-bit Microcontroller";
    //    }
    //    else if (button.CommandName == "D")
    //    {
    //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Anyname", "toggles();", true);
    //        Session["s"] = "Automation Technology – Basic Level";
    //    }
    //    else if (button.CommandName == "E")
    //    {
    //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Anyname", "toggles();", true);
    //        Session["s"] = "Automation Technology – Advance Level";
    //    }
    ...
    protected void btnSave_click(object sender, EventArgs e)
    {
        ...
        string sql="";
        sql= "insert into Admissions (EnquiryNo,Sesions,Admissiondate,StudentName,StudentMobileNo,EmailID,Course,Comment,ModeOfEnquiry,StatusCode,brandname,FranchiseCode)values(@EnquiryNo,@Session,@Admissiondate,@StudentName,@StudentMobileNo,@EmailID,@Course,@Comment,@ModeOfEnquiry,@StatusCode,@brandname,@FranchiseCode)";
    ...
    public void SendEmailAgain( string mailID,string name,string course)
    {
        ...
        HTML = HTML + "<p>We are happy to Apply for " + course + " Under Skill development in ESDM</p>";
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        varFileName = "assembly&maintenance.docx";
        string Path = null;
        Path = Server.MapPath("~/syllabus/");
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert('File Dose not Exist')", true);
            return;
        }
    ...
    {
        string varFileName = null;
        varFileName = "Embedded-system.docx";
        string Path = null;
        Path = Server.MapPath("~/syllabus/");
        string varFullPath = null;
        varFullPath = Path + varFileName;
    ...
    {   
        ...
        string varFileName = null;
        varFileName = "automation-basic.docx";
        string Path = null;
        Path = Server.MapPath("~/syllabus/");
        string varFullPath = null;
        varFullPath = Path + varFileName;
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string varFileName = null;
        varFileName = "automation-advance.docx";
        string Path = null;
        Path = Server.MapPath("~/syllabus/");
        string varFullPath = null;
        varFullPath = Path + varFileName;

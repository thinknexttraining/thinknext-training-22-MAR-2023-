...
Partial Class aws_training_in_chandigarh
    ...
    Public Sub insert()
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtEmailId.Text <> "" Then
                    sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,StudentMobileNo,Course,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values('" + enquiryno + "','" + txtName.Text + "','" + txtEmailId.Text + "','" + txtMobile.Text + "','" + "AWS Training" + "','" + "Arrange a Call Back" + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',GetDate())")
                    ...
                    ' SMS2nd = "Dear " & txtName.Text & ", Thanks for your enquiry for Python Training at ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon.  To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
                    ...
                    varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, "AWS Training", "Arrange a Call Back", "https://www.thinknexttraining.com/aws-training-course-chandigarh-mohali.aspx")
    ...
    Public Sub SendEmailbroucher()
        ...
        StrContent = StrContent.Replace("[Course]", "AWS Training")
        ...
        msg.Subject = "AWS Industrial Training"
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            varclass.SendLeads(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "AWS Training", "Demo Class", "https://www.thinknexttraining.com/aws-training-course-chandigarh-mohali.aspx")
    ...
    Sub AddStudentScholarshipDetail()
        ...
        cmd.Parameters.AddWithValue("@Duration", "AWS Demo Class")
        cmd.Parameters.AddWithValue("@Course", "AWS Training")
        'cmd.Parameters.AddWithValue("@CollegeName", )
        cmd.Parameters.AddWithValue("@Comment", "AWS Demo Class")
        ...
        If NameSyl.Text <> "" Then
            If EmailidSyl.Text <> "" Then
                If PhonenoSyl.Text <> "" Then
                    sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,StudentMobileNo,Course,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values('" + enquiryno + "','" + NameSyl.Text + "','" + EmailidSyl.Text + "','" + PhonenoSyl.Text + "','" + "AWS Training" + "','" + "Download Syllabus" + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',@Admissiondate)")
                    Dim cmd As New SqlCommand(sql, con)
                    cmd.Parameters.AddWithValue("@Admissiondate", Format(Now, "MM/dd/yyyy"))
                    cmd.ExecuteNonQuery()
                    cmd.Dispose()
                    con.Close()
                    varclass.SendLeads4(PhonenoSyl.Text, NameSyl.Text, EmailidSyl.Text, "AWS Training", "Download Syllabus", "https://www.thinknexttraining.com/aws-training-course-chandigarh-mohali.aspx")
                    NameSyl.Text = ""
                    EmailidSyl.Text = ""
                    PhonenoSyl.Text = ""

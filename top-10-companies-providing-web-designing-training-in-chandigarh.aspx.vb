...
Partial Class top_10_companies_providing_web_designing_course_in_chandigarh
    ...
    Sub AddStudentDetail()
        ...
        If txtName.Text <> "" Then
            ...
            cmd.Parameters.AddWithValue("@Comment", "www.thinknexttraining.com/top-10-companies-providing-web-designing-training-in-chandigarh.aspx")

<%@ Page Title="PHP Programming Course in Chandigarh Mohali" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="php-programming-course.aspx.vb" Inherits="php_programming_course" %>
...
<meta name="keywords" content="PHP Training - Best Core and Advance PHP Industrial Training institute in Chandigarh Mohali Panchkula India. ThinkNEXT is best php training institute provides 100% job oriented PHP Course" />
 <!-- Facebook sharing image show  -->
     <link rel="image_src" href="https://www.thinknexttraining.com/images/php-programming-course.jpg" />
    <meta property="og:image" content="https://www.thinknexttraining.com/images/php-programming-course.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image position-relative">  
      ...
      <img class="d-md-none" src="images/php-programming-course.jpg"  alt="PHP Programming Course" title="PHP Programming Course" />
      <img class="d-none d-md-block" src="images/php-programming-course.jpg" alt="PHP Programming Course" title="PHP Programming Course" />
...
<div class="downloadsyllabus-banner px-2 py-3 rounded">
            ...
            <div class="row m-0">
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                        ...
                        <h1>PHP Programming Course in Chandigarh Mohali</h1>
                    </div>
                  <p><strong>ThinkNEXT Technologies Private Limited</strong> is a renowned company for <strong>PHP training in Chandigarh Mohali Panchkula</strong>. We have well-equipped trainers who will teach you and guide you as per the current market trends and technology. Generate dynamic web pages with rapidly; innovative using PHP scripting language and you can create powerful web applications. Who wants to become an expert in web development should learn PHP.</p>
                  <p><strong><a class="text-decoration-none" href="https://www.thinknexttraining.com/">ThinkNEXT</a></strong> provides a <strong>PHP Training course in Chandigarh Mohali Panchkula</strong> from fresher level to advanced level with live project training; trainer’s assists students to be work for Real-time industrial projects. Candidates who complete the <strong>PHP course</strong> with <strong>ThinkNEXT</strong> will become a specialist in PHP with more practice & exercise.</p>
                  <p>After successful completion of <strong><a class="text-decoration-none" href="https://www.thinknexttraining.com/php-training-in-chandigarh.aspx">PHP Training courses</a></strong>, we even assist our students to avail the best jobs in the industry on PHP Platform with pay that industry best provide. If you were searching for attaining 100% Web Development skills than you are at right place as who can train you best else than an industry expert!!!</p>
                   </div>
                </div>
                <div class="col-md-5">
    ...
    <section class="py-4 bg-ececec">
        <div class="container">              
                <div class="text-justify">
                    <h2><strong class="textred">PHP Programming Course</strong></h2>
                    <p>PHP abbreviation is Hypertext Preprocessor, which is accessible in the market for more than 11+ years. Rasmus Lerdorf industrialized PHP from C, C++, and PERL. PHP is the common database for web development including difficult functionalities for dynamic applications like e-commerce, web applications and more. This mostly used to make web applications and desktop applications as well. PHP is an open source language; it is more popular than web designing technologies like ASP. There is a high demand for PHP programmers than other languages. MYSQL is an open source it is an additional advantage for users. PHP is a simple programming language, who has basic programming skills to learn easily PHP and web development as well. PHP features highly useful for WordPress, magneto, and more.</p>
                    <p><strong>Basic Requirement to learn PHP language in Chandigarh Mohali</strong></p>
                    <p>To learn PHP it is essential to have the knowledge about JAVA script. The advanced course of PHP in Chandigarh Mohali requires the basic knowledge of PHP, SQL, and HTML. We have experienced trainers who work dedicatedly to enhance your skills in PHP language.</p>
                    <h3 class="fw-bold textred">Benefits of PHP training in Chandigarh Mohali</h3>
                    <ul class="welcomeLinks">
                        ...
                        <li>To the greater extent, PHP supports the different kinds of databases such as MySQL, Oracle, Sybase, SQLite, etc., as well as different kind of servers such as Apache, iPlanet, Netscape, etc.</li>
                        <li>PHP has high capability to create dynamic, responsive and secured web applications such as Facebook, and Twitter because of the most popular and an acceptable programming language.</li>
                        <li>PHP is an open source, so anyone from all across the world can use it free of cost and can also be customized easily.</li>
                        <li>As it’s an open source technology, PHP does not use a lot of systems by which the PHP hosting becomes very easy.</li>
                    </ul>
                    <p><strong>ThinkNEXT is the best PHP training institute in Chandigarh Mohali</strong> which provides the proficient PHP training which is widely-used server-side scripting language to create, build, dynamic, secured and data-driven web pages and web applications. We are one of the best results oriented PHP training & placement institute in Chandigarh Mohali for offering the best PHP classes in Mohali of detailed knowledge in PHP and focuses on nurturing your knowledge and skills sets which will provide you a successful career path in life ahead.</p>
                    <p>Our <strong>PHP course in Chandigarh Mohali</strong> will make you capable to create different E-commerce websites, database designing and optimization, and CMS development. Along with the PHP training and placement in Mohali, whether you are fresher or experienced, you will have a lot of options and excellent future opportunities for the career in the PHP because the demand for <strong>PHP programming language</strong> has increased in the entire world. And once you get practical experienced in PHP language, the scope of growth will become superior.</p>
                    <h3 class="fw-bold textred">Career Opportunities-</h3>
                    <ul class="welcomeLinks">
                        <li>PHP Developer/PHP Web Developer</li>
                        <li>Web Developer/E-commerce Developer</li>
                        <li>Webmaster</li>
                        <li>PHP Analyst</li>
                    ...
                    <p>If you are a Student or working professional and looking forward to building a career in Web Designing and Development, then the learning PHP will be most beneficial for you. PHP is the fastest growing language after completing PHP training; you can get a good job and a high salary with a certificate. To learn more about the PHP course, please contact our professional expert or fill out the inquiry form to get back to you.</p>
                </div>
    ...
    <section class="py-4">
        <div class="container">
                ...
                <div>
                    <img src="images/industrial-training-comapny-chandigarh.jpg" alt="PHP Programming Course" />
                </div>
                <div>
                    <img src="images/six-weeks-summer-training-chandigarh.jpg" alt="PHP Programming Course" />
                </div>
                <div>
                    <img src="images/summer-training-in-mohali.jpg" alt="PHP Programming Course" />
                </div>
            </div>
             <div class="d-md-none">
                   <div class="text-center">
            <img style="width:89%;" src="images/industrial-training-comapny-chandigarh-1.jpg" alt="PHP Programming Course" />
        </div>
             <div class="text-center">
            <img style="width:89%;" src="images/industrial-training-comapny-chandigarh-2.jpg" alt="PHP Programming Course" />
        </div>
          <div class="text-center">
            <img style="width:89%;" src="images/six-weeks-summer-training-chandigarh-1.jpg" alt="PHP Programming Course" />
        </div>
              <div class="text-center">
            <img style="width:89%;" src="images/six-weeks-summer-training-chandigarh-2.jpg" alt="PHP Programming Course" />
        </div>
          <div class="text-center">
            <img style="width:89%;" src="images/summer-training-in-mohali-1.jpg" alt="PHP Programming Course" />
        </div>
             <div class="text-center">
            <img style="width:89%;" src="images/summer-training-in-mohali-2.jpg" alt="PHP Programming Course" />
        </div>
                 </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="PHP Programming Course" title="PHP Programming Course" />
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="PHP Programming Course" title="PHP Programming Course" />
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="PHP Programming Course" title="PHP Programming Course" />
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="PHP Programming Course" title="PHP Programming Course" />
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="PHP Programming Course" title="PHP Programming Course" />
                </div>

                 <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="PHP Programming Course" title="PHP Programming Course" />
                </div>
          ...
          <div class="container">
            <div class="row m-0">
              <div class="col-lg-8 text-justify">                
                  ...
                  <h3><strong class="textred">Benefits of PHP Training Course from ThinkNEXT:</strong></h3>
                  <ul class="welcomeLinks">
                      <li>Free Spoken English, Personality Development and Interview Preparation (HR+Technical) Classes on Daily basis so that students not need to struggle for jobs as a fresher</li>
                      <li>Life-Time Learning and Placement Card</li>
                      <li>6 Months Training + Project Certificate By ThinkNEXT</li>
                      <li>PHP/MySQL Experience Certificate by ThinkNEXT</li>
                      <li>A highly experienced trainer will train you.</li>
                      <li>Flexible timing according to preferences.</li>
                      <li>Get to work on live projects for practical exposure</li>
    ...
    <section class="bg-ececec py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>PHP Programming Course - Contents</strong></h3>
            </div>
            <br>
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 mb-3">
                    <span class="abythknxt-hdng">PHP Programming Course</span>
                        ...
                        <div class="row m-0">
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/Pehredaar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Pehredaar-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" title="PHP Programming Course">
                                </a>
                            </div>
                        </div>
				...
				<div class="row m-0">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                    <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                    <img src="images/asia-quality-entreprenuership-award.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                    <img src="images/award-image11.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                    <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                    <img src="/php-images/php-industrial-training.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                    <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                    <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                    <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">   
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                    <img src="images/awards-1.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                    <img src="images/awards-2.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                    <img src="images/Leadership-Summit-2019-Award.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                    <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                    <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                    <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                    <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/ThinkNEXT-Frontdesk.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                   ...
                   <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/galleryjob-fair7.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                    <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/page-5_img-4-b.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/THINKNEXT-b.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                    ...
                    <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/industial-training-in-chandigarh-group.webp" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                     ...
                     <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                      ...
                      <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="PHP Programming Course" title="PHP Programming Course" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>

...
Partial Class Android_training_in_chandigarh
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtMobile.Text <> "" Then
                    If txtfranchisecode.Text = "TNK101" Then
                        sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,StudentMobileNo,Course,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values('" + enquiryno + "','" + txtName.Text + "','" + txtEmailId.Text + "','" + txtMobile.Text + "','" + "IoT Online Training" + "','" + "IoT Online Training" + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',@Admissiondate)")

                    Else
                        sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,StudentMobileNo,Course,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values('" + enquiryno + "','" + txtName.Text + "','" + txtEmailId.Text + "','" + txtMobile.Text + "','" + "IoT" + "','" + "IoT" + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',@Admissiondate)")
                    End If
                    ...
                    '  SMS2nd = "Dear " & txtName.Text & ", Thanks for your enquiry for IoT Online Training at ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon.  To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
                    ...
                    varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/iot-online-training.aspx")
                    txtName.Text = ""
                    txtEmailId.Text = ""
                    txtMobile.Text = ""
                    lblmsg.Visible = True
                    ...
                    Response.Redirect("https://pages.razorpay.com/thinknextonline")
                End If
            End If
        End If
    End Sub
    ...
    Public Sub SendEmailbroucher()
        ...
        If txtfranchisecode.Text = "TNK101" Then
            ...
            StrContent = StrContent.Replace("[Course]", "IoT Online Training")
        Else
            StrContent = StrContent.Replace("[MyName]", txtName.Text)
            StrContent = StrContent.Replace("[Course]", "IoT online Training")
        End If
        ...
        If txtfranchisecode.Text = "TNK101" Then
            msg.Subject = "IoT Online Training"
        Else
            msg.Subject = "IoT Online Industrial Training"
        End If
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            ' varclass.SendSMS(tx  tdemoMblno.Text, SMS2nd, "Route9")
            varclass.SendLeads(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "None", "Demo Class", "https://www.thinknexttraining.com/iot-online-training.aspx")
            txtdemoName.Text = ""
            txtdemoMblno.Text = ""
            txtdemoEmail.Text = ""
            txtdemoMsg.Text = ""

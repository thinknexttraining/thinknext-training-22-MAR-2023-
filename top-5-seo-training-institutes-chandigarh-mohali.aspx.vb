...
Partial Class top_5_seo_training_institutes_in_chandigarh_mohali
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs) Handles btnsubmit.Click
        ...
        varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, txtCourses.Text, "Arrange a Call Back", "https://www.thinknexttraining.com/top-5-seo-training-institutes-chandigarh-mohali.aspx")
    ...
    Sub AddStudentDetail()
        ...
        If txtName.Text <> "" Then
            ...
            cmd.Parameters.AddWithValue("@Comment", "www.thinknexttraining.com/top-5-interior-designing-institutes-chandigarh.aspx")

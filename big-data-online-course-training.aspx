<%@ Page Title="Big Data Online Course Training - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="big-data-online-course-training.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="Big Data Online Course Training - ThinkNEXT is one of the best Training company providing 6 months and 6 weeks Big Data training Online." />
    <meta name="keywords" content="Big Data online course, big data online training, big data courses for beginners, big data courses for beginners free, learn big data online, big data analytics courses online, " />
    <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/share-images/big-data-hadoop-training-in-chandigarh.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/share-images/big-data-hadoop-training-in-chandigarh.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Big Data Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become Big Data Expert and Boost your Career. Enroll Now </strong></p>
                <br />
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-7">
                ...
                <strong class="textred">Hadoop (Big Data) Ecosystem </strong>
                ...
                <strong class="textred">Building Blocks </strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Hadoop Cluster -Architecutre - Configuration files </strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Hadoop Core Components - HDFS & Map Reduce(YARN) </strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Data Integration using Sqoop, Flume & Talend </strong>
                <ul class="welcomeLinks">
            ...
            <div class="col-lg-5">
                ...
                <strong class="textred">data Analysis using PIG </strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Data Analysis using HIVE </strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Data Analysis using Impala</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">NoSql Data base - HBASE </strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Hadoop - Other Analytics Tools </strong>
                <ul class="welcomeLinks">
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/big-data-online-course-training.aspx"
        });
    </script>
    <script>

<%@ Page Title="Change Password" Language="VB" MasterPageFile="~/Students/MasterPageStudent.master" AutoEventWireup="false" CodeFile="ChangePassword.aspx.vb" Inherits="Students_ChangePassword" %>
   ...
   Please enter correct detail to change password
       ...
       <p class="para" style="margin:0px; height: 33px;">
         <strong> Mobile No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><asp:TextBox 
               ...
               Height="20px" Width="231px" MaxLength="10"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
               ErrorMessage="Enter Mobile No." ControlToValidate="txtmobno"></asp:RequiredFieldValidator></p>
       <p class="para" style="margin:0px; height: 33px;">
           <strong> Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>  
           <asp:TextBox ID="txtpwd" runat="server" 
               Height="20px" Width="231px" TextMode="Password"></asp:TextBox>
           &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
               ErrorMessage="Password Required" ControlToValidate="txtpwd"></asp:RequiredFieldValidator></p>
       <p class="para" style="margin:0px; height: 33px;">
         <strong> Confirm Password&nbsp; </strong>  
           ...
           &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" 
               ...
               ControlToValidate="txtpwd2"></asp:CompareValidator></p>

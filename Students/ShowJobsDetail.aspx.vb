...
Partial Class ShowJobsDetail
    ...
    Sub ShowDefault()
        ...
        Dim Sql As String
        Sql = "Select * from PlacementDetails where FranchiseCode='" + txtfranchiseCode.Text + "' order by JobTitle "
    ...
    Sub DisplayByBoth(ByVal SubCategory As String, ByVal Category As String)
        ...
        Dim ds As New DataSet
        Dim Sql As String
        Sql = "Select * from PlacementDetails Where SubCategory like '%" & SubCategory & "%' and Category Like '%" & Category & "%'  and FranchiseCode='" + txtfranchiseCode.Text + "'"
        Dim cmd As New SqlCommand(Sql, con)
        Dim da As New SqlDataAdapter(cmd)
        da.Fill(ds, "PlacementDetail")
        If ds.Tables("PlacementDetail").Rows.Count > 0 Then
    ...
    Sub DispByCategory(ByVal Category As String)
        ...
        Dim ds As New DataSet
        Dim Sql As String
        Sql = "Select * from PlacementDetails Where FranchiseCode='" + txtfranchiseCode.Text + "' and Category like @Category order by PostedOn desc "
        Dim cmd As New SqlCommand(Sql, con)

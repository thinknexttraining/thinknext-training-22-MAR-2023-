...
Partial Class stipend_based_industrial_training
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs) Handles btnsubmit.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            SMS2nd = "Dear " & txtNameR.Text & ", Thanks for your registration for free placement opportunities. Venue: ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon. To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
    ...
    Sub SendEmailReg()
        ...
        msg.Subject = "Registration for FREE Placement opportunities offered by ThinkNEXT"
    ...
    Sub AddStudentScholarshipDetail()
        ...
        cmd.Parameters.AddWithValue("@ModeOfEnquiry", "Placement Drive")
        cmd.Parameters.AddWithValue("@EmailID", txtEmailR.Text)
        cmd.Parameters.AddWithValue("@Duration", "Placement Drive")
        cmd.Parameters.AddWithValue("@Course", txtjob.Text)
        'cmd.Parameters.AddWithValue("@CollegeName", )
        cmd.Parameters.AddWithValue("@Comment", "Placement Drive")

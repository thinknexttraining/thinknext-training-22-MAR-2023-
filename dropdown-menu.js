...
$(document).ready(function() {
	...
	$("#nav > li").css({"display": "inline", "background-color": "#27ae60", "margin": "0 10px"});
	...
	$("#nav li > ul").css({"background": "white", "border": "#27ae60 solid 2px"});
	$("#nav ul ul").css({"background": "none", "border": "none"});
	$("#nav li > ul").css({"color": "#27ae60", "display": "block", "float": "left", "margin": 0, "padding": "10px", "left": "auto"});

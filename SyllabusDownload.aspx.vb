    ...
    Public Sub insert()
        ...
        If Emailid.Text <> "" Then
            If Phoneno.Text <> "" Then
                sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,ContactNo,FileName,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values ('" + enquiryno + "','" + TextName.Text + "','" + Emailid.Text + "','" + Phoneno.Text + "','" + "ThinkNEXT Syllabus" + "','" + Label1.Text + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',@Admissiondate)")
                ...
                varclass.SendLeads4(Phoneno.Text, TextName.Text, Emailid.Text, "None", Label1.Text + "(Download Syllabus)", "https://www.thinknexttraining.com/")

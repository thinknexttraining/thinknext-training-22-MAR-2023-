<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/java-training-institute-in-chandigarh.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Java Training Institute in Chandigarh</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Java Training Institute in Chandigarh &nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / Java Training Institute
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
                <h1>Java Training Institute in Chandigarh Mohali Panchkula &nbsp;</h1>
            </div>
      
             
            <p>Java is the most  demanding programming language in these days. <strong>Java Training in Chandigarh</strong> is the best choice of students. <strong>ThinkNEXT</strong> is the one of famed <strong>Java Training Institute in Chandigarh.</strong> The whole staff of the company is excellent. They understand the problems of  the students regarding their topics and help them to solve these problems.  </p>

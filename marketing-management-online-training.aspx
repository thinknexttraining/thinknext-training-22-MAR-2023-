<%@ Page Title="Marketing Management Online Training - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="marketing-management-online-training.aspx.vb" Inherits="digital_marketing_course_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    
    <meta name="description" content="Online Training Courses - ThinkNEXT provides the best Online Training Course." />
    <meta name="keywords" content="Online Training Course, Online Courses" />
      <!-- Facebook sharing image show  -->
     <link rel="image_src" href="http://www.thinknexttraining.com/images/manage-marketing-online-training-share.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/images/manage-marketing-online-training-share.jpg" />
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size:cover;">
        ...
        <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-50">              
          <span class="bg-info plr-20 ptb-10">Certified Training</span>
              <h2 class="fa-5x text-white main-head"><strong>Marketing Management</strong></h2>
                         ...
                         <tr>
                           <td>
                               ...
                               <asp:DropDownList ID="DropDownList2" runat="server">
                                   <asp:ListItem>Self-learning</asp:ListItem>
                                   <asp:ListItem>Instructor-led</asp:ListItem>                                   
                               </asp:DropDownList>
                       <tr>
                           <td>
                               <strong>I want to learn Marketing Management to:</strong>
                               <asp:DropDownList ID="DropDownList1" runat="server">
                                   <asp:ListItem>Gain a new skill</asp:ListItem>
                                   <asp:ListItem>Build my own project</asp:ListItem>
                                   <asp:ListItem>Get an internship/job in future</asp:ListItem>
                                   <asp:ListItem>Get a certificate</asp:ListItem>
                                    <asp:ListItem>Fulfil college requirement</asp:ListItem>
                               </asp:DropDownList>
                        ...
                        <tr>                         
                            <td>                             
                                <asp:Button ID="btnsubmit" runat="server" Text="Register Now" CssClass ="buton" OnClick="btnsubmit_Click" OnClientClick="btnsubmit_Click" />                              
                                </td>
                        </tr>
                   </table>              
</div>
          ...
          <div class="container py-5">
            ...
            <div class="row mx-auto">
                    ...
                    <div class="item-container d-flex align-items-center">
                        ...
                        <div class="content-container">
                            <h3 class="title">54 hours video</h3>
...
<script type="text/javascript" src="social-share/jquery.floating-social-share.min.js"></script>
  ...
  $("body").floatingSocialShare({
    ...
    url: "http://www.thinknexttraining.com/marketing-management-online-training.aspx"
  });
</script>

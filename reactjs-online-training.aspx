<%@ Page Title="ReactJS Online Training - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="reactjs-online-training.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="ReactJS Online Training  - ThinkNEXT is one of the best Training company providing 6 months and six weeks ReactJS Training Online" />
    <meta name="keywords" content="ReactJS Online Training, ReactJS Online Course, learn react js online, react js online course, best react js course online " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>ReactJS Online Training</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become ReactJS Expert and Boost your Career. Enroll Now </strong></p>
                <br />
                        ...
                        <table class="table2" id="tb1">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="input" placeholder="reactjs Online Training" ReadOnly="true"></asp:TextBox>
                                <tr>
                                </tr>
                            <tr>
                                <td>
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-6 text-justify">
                <strong class="textred">Basics of JS</strong>
                ...
                <strong class="textred">ReactJS</strong>
                <ul class="welcomeLinks">
                    <li>What is React? </li>
                    <li>Templating using JSX </li>
                </ul>
                <p>Working with React Create Element, Expressions, Using logical operators, Specifying attributes, Specifying children</p>

                <strong class="textred">Components:</strong>
                <ul class="welcomeLinks">
                    <li>Significance of component architecture </li>
                    <li>Types of components </li>
                </ul>
                <p class="plr-30">
                    <i class="fa fa-check"></i>&nbsp Functional
                    <br />
                    <i class="fa fa-check"></i>&nbsp Class based
                    <br />
                    <i class="fa fa-check"></i>&nbsp Pure
                    <br />
                </p>
                <ul class="welcomeLinks">
                    <li>Component Composition </li>
                </ul>
                <strong class="textred">State and props</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Just Redux</strong>
                <ul class="welcomeLinks">
                    <li>What is redux </li>
                    <li>Why redux </li>
            ...
            <div class="col-lg-6 text-justify">
                ...
                <strong class="textred">Routing with react router</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Immutable.js for immutable datastructures</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">React Redux</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Unit Testing in react</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Webpack primer</strong>
                <ul class="welcomeLinks">
                ...
                <strong class="textred">Server-side rendering with React</strong>
                <ul class="welcomeLinks">
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/reactjs-online-training.aspx"
        });
    </script>
    <script>

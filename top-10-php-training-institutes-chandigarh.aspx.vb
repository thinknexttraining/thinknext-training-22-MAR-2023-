...
Partial Class top_10_php_training_institutes_chandigarh
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs) Handles btnsubmit.Click
        ...
        varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, txtCourses.Text, "Arrange a Call Back", "https://www.thinknexttraining.com/top-10-php-training-institutes-chandigarh.aspx")
    ...
    Sub AddStudentDetail()
        ...
        If txtName.Text <> "" Then
            ...
            cmd.Parameters.AddWithValue("@Comment", "www.thinknexttraining.com/top-5-java-training-institutes-chandigarh-mohali.aspx")

<%@ Page Title="Machine Learning Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="machine-learning-online-course.aspx.vb" Inherits="python_training_in_chandigarh_mohali" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="Machine Learning Online Course - ThinkNEXT is top Machine Learning Online Course Training " />
    <meta name="keywords" content="machine learning online course, machine learning online training, best ml courses online, coursera machine learning, online learning machine learning, best machine learning course online, machine learning stanford coursera, machine learning free online course, machine learning course free online, machine learning certificate online " />   
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size:cover;">
        ...
        <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">              
          <span class="bg-info plr-20 ptb-10">Certified Training</span>
              <h2 class="fa-5x text-white main-head text-left"><strong>Machine Learning Online Course</strong></h2>
            <div style="border:3px solid orange;"></div>
            <br />
            <p class="text-white"><strong>Become Machine Learning Expert and Boost your Career. Enroll Now </strong></p>
            <br />
                         ...
                         <tr>
                           <td>
                               <strong>Course type</strong>
                                <asp:TextBox ID="TextBox1"  runat="server" class="input" placeholder="Machine Learning Online Training" ReadOnly="true" ></asp:TextBox>
...
<p>  <i class="fa fa-square"></i> <span><strong> Grooming Sessions: Spoken English, Personality Development </strong> </span> </p>
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <br />
               ...
               <div class="col-lg-7">
         <p><strong>Machine Learning-I</strong></p>
			  <ul class="welcomeLinks">
            <li> Introduction Machine Learning </li> 
            <li> Data PreProcessing </li> 
            <li> Regression and it's Types </li> 
            <li> Classification (Logistic Regression,Etc) </li> 
            <li> Clustering </li> 
   ...
   <br />
              ...
              <div class="col-lg-5">
          <p><strong>Machine Learning-II</strong></p>
			  <ul class="welcomeLinks">
            <li> Deep Learning </li> 
            <li> Artificial Neural Networks </li> 
            <li> Amazon Web Services </li> 
            <li> Google Machine Learning API </li> 
            <li> Prediction based ML Projects </li> 
            <li> Final Project </li> 
			</ul>
...
<script type="text/javascript" src="social-share/jquery.floating-social-share.min.js"></script>
  ...
  $("body").floatingSocialShare({
    ...
    url: "http://www.thinknexttraining.com/machine-learning-online-course.aspx"
  });
</script>
    <script>

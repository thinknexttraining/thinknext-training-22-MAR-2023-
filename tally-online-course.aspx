<%@ Page Title="Tally Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="tally-online-course.aspx.vb" Inherits="HR_training_in_chandigarh_with_management_internship" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">     
    <meta name="description" content="Tally Online Course - ThinkNEXT is one of the best IT company providing free 6 months and six weeks dot net training in Chandigarh, Mohali. Visit us for .net, PHP, JAVA, Web Designing, iPHONE, Networking and Android." />
    <meta name="keywords" content="Tally Online Course, tally online training, learn tally online, tally courses near me, online tally course with gst, online tally course with certificate, tally online classes, tally gst course near me, tally course online free, tally erp 9 online course, learn tally erp 9 online, online tally course with gst free, tally erp 9 courses near me" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Tally Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become Tally Expert and Boost your Career. Enroll Now </strong></p>
                <br />
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/tally-online-course.aspx"
        });
    </script>
    <script>

<%@ Page Title="Finance Management Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="finance-management-online-course.aspx.vb" Inherits="java_training_in_chandigarh" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <meta name="description" content="Finance Management Online Course - ThinkNEXT is one of the best IT company providing Finance Training / Internship in Chandigarh Mohali Panchkula" />
    <meta name="keywords" content="Finance Management Online Course,Finance Management Online Training, Finance Course Online, Finance certification online, coursera Finance courses, Finance analyst course" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Finance Management Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become Finance Expert and Boost your Career. Enroll Now </strong></p>
                <br />
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/finance-management-online-course.aspx"
        });
    </script>
    <script>

<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/learn-java-programing.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Learn Java Programing - ThinkNEXT Technologies</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Learn Java Programming &nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / Learn Java Programming
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
            ...
            <p>By <strong>Learning Java</strong> in these days will help you to make your future in the  field of java. Java is the most demanding language in these days. <strong>ThinkNEXT Technologies Private Limited</strong> Is the one of the famed <strong>company in the  Chandigarh.</strong> The trainers of the <strong>ThinkNEXT  Technologies</strong> are well experienced. They teach the students in the simplest  way so that students can understand the topic easily. They teach the students  with piratical examples. So, by being the part of the ThinkNEXT Technologies,  you can <strong>learn java programming</strong> for  your desired job in java field.</p>

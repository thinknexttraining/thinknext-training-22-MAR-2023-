<%@ Page Title="International Business Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="international-business-online-course.aspx.vb" Inherits="HR_training_in_chandigarh_with_management_internship" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">     
    <meta name="description" content="International Business Online Course - ThinkNEXT is one of the best Online Training Company providing International Business Online Course in INDIA" />
    <meta name="keywords" content="International Business online course, ib online course, ib training online, ib certificate in teaching and learning online, free international business courses online " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>International Business Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become International Business Expert and Boost your Career. Enroll Now </strong></p>
                <br />
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-7">
                ...
                <p> <strong>Session 3: Formatting Numbers</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 4: Managing Worksheets</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 5: Modifying Rows and Columns</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 6: Understanding Formulas</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 7: Changing Views</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 8: AutoFill and Custom Lists</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 9: Conditional Formatting</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 10: Tables</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 11: Data Tools</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 12: Referencing Formulas</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 13: Ranges and Dates</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                    <li>Cell Names </li>
                    <li>Named Ranges </li>
                ...
                <p> <strong>Session 14: Lookups</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                    <li>VLOOKUP </li>
            ...
            <div class="col-lg-5">
                <p> <strong>Session 15: Conditional Logic</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                    <li>IF Statement </li>
                    <li>Nested IF </li>
                ...
                <p> <strong>Session 16: Text Formulas</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                    <li>Case Formulas </li>
                ...
                <p> <strong>Session 18: Formatting Charts</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                    <li>Chart Styles </li>
                    <li>Chart Layouts </li>
                ...
                <p> <strong>Session 19: Adding Graphics to  Spreadsheets</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 20: Outline, Sort, Filter,  and Subtotal</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 21: PivotTables</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 23: Collaboration</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 24: Printing</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 25: Saving a Workbook</strong> </p>
                <ul class="welcomeLinks">
                    <li>Introduction </li>
                ...
                <p> <strong>Session 26: Macros</strong> </p>
                <ul class="welcomeLinks">
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/international-business-online-course.aspx"
        });
    </script>
    <script>

    ...
    Public Sub insert()
        ...
        If Emailid.Text <> "" Then
            If Phoneno.Text <> "" Then
                ...
                varclass.SendLeadsForIELTS(Phoneno.Text, "Student", Emailid.Text, "IELTS Download Syllabus", "IELTS Download Syllabus", "https://thinknexttraining.com/ielts-coaching-institute-chandigarh.aspx")

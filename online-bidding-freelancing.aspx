<%@ Page Title="Online Bidding Freelancing Training Course in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="online-bidding-freelancing.aspx.vb" Inherits="online_bidding_freelancing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="Online Bidding Freelancing Training Course in Chandigarh- ThinkNEXT is best Android Training Company providing Online Bidding Freelancing Training in Chandigarch Mohali Mohali Panchkula India. ThinkNEXT " />
    <meta name="keywords" content="Online Bidding Freelancing Training Course in Chandigarh, Online Bidding Freelancing Training Course in Chandigarh, Android Training Companies in Mohali, Android Training Companies in panchkula INDIA, Android App Development Training in Chandigarh, Android App Development Training in Mohali, Android App Development Training in panchkula INDIA." />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image">  
         <img class="d-md-none"  src="images/online-bidding-course-mob-min.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali Mohali Panchkula" />
            
     <img class="d-none d-md-block" src="images/online-bidding-course-min.jpg" alt="3DS MAX Training in Chandigarh Mohali Panchkula" />
        ...
        <div class="container">
            <div class="row m-0">
                <div class="col-md-7">
                  ...
                  <h1>Online Bidding Training in Chandigarh</h1>
                  <p>Looking for the best institute of Online bidder Chandigarh? If yes, then you are in the right place. Thinknext Training is a well-known digital marketing and web design training institute for online bidding training Chandigarh. We provide the best practical training in Bidding.</p>
                <p>So if you are in the search for the best institute for the training of Online Bidding in Chandigarh, then your search is finished. At Thinknext Training  is one of the leading institutes Chandigarh for the training of the Bidding. We provide you all the details about online bidding training Chandigarh below.</p>
            ...
            <div class="row m-0">
              <div class="col-lg-8 text-justify">                
                    <div class="d-inline-block pt-2 "><br />
                                     <h2 class="text-danger mt-5"><b>Why Choose Thinknext Training for Online Bidder Training in Chandigarh?</b></h2><br>
                        <ul class="welcomeLinks">
             
<li>At Thinknext Training all the students will get the training according to the latest trend and demand in the industry. This makes this institute better than other institutes.</li>
<li>Training is provided by the professional experts who will provide 100 % advance training based on practical learning.</li>
<li>At Thinknext Training  is 100 % job oriented.</li>
<li>Online certifications are provided to the students during the training.</li>
<li>There are small batches in every training so that every student could get attention.</li>
<li>If you will miss any topic then you can get extra classes.</li>
<li>Trainers are industry experts and many years of experience in that field.</li>
</ul>
    ...
    <section class="bg-ececec py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>  Online Bidding Freelancing - Course Contents</strong></h3>
            </div>
            
            <div class="row">
                 <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">

                    <h4 class="textred fw-bold">MODULE NO.1 Introduction to IT Industry Concepts / Technologies</h4>

                    <ul class="welcomeLinks">
                      <li>  Intro to IT Concepts</li>
                      <li> Basic Knowledge of various IT Departments -- Software Development,<br /> Testing, Web Development, Web Designing, SEO, Mobile Apps- Android<br /> /Iphone /Blackberry / Windows mobile apps.</li>
                      <li>Latest IT Technologies</li>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
                <h4 class="textred fw-bold">MODULE NO.2  Intro to Marketing</h4>
                  <ul class="welcomeLinks">
                        <li>Types of Marketing</li> 
                          <li>Marketing Planning and Role of Internet in marketing.</li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
                    <h4 class="textred fw-bold">MODULE NO.3 Bidding</h4>
                    <ul class="welcomeLinks">
                         
<li>Intro to Bidding</li>
<li> Complete familiarity with the online platforms -- Odesk, Elance,<br /> Guru, Freelancer etc</li>
<li> Understand Key material and concepts</li>
</ul>       
                </div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
                    ...
                    <h4 class="textred fw-bold">MODULE NO.4 Profile on Online Platforms</h4>

                    <ul class="welcomeLinks">
                  
<li>Building Complete & Effective Profiles</li>
<li> Giving Tests on Profiles</li>
<li> Profile Improvement</li>
<li> Learning how to draft Cover Letters for different types of requirements.</li>
</ul>
                     </div>
               <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
  
                      <h4 class="textred mt-5 fw-bold">MODULE NO.5  Complete Insight of Bidding System</h4>

                    <ul class="welcomeLinks">
                  
<li>Hourly Bidding System</li>
<li> Fixed Price Bid</li>
<li> Mutual Contact with Buyer / NDA / MSA Agreements</li>
...
<li> Odesk Team Application</li>
<li> Feedback Transfer</li>
<li> Disputes Solving</li>
...
<li>Online Bidding Freelancing Training from 6 Times National Level Award Winner Company:</li>
...
<li>Online Bidding Freelancing Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>Online Bidding Freelancing Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Best Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Online Bidding Freelancing Training in Chandigarch Mohali Mohali" title="6 Month Online Bidding Freelancing Training in Chandigarch Mohali Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Online Bidding Freelancing Training in Chandigarch Mohali" title="Online Bidding Freelancing Training in Chandigarch Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

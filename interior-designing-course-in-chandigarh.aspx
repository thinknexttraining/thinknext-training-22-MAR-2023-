<%@ Page Title="Interior Designing Course in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="interior-designing-course-in-chandigarh.aspx.vb" Inherits="interior_designing_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   
 <meta name="description" content="Interior Designing Course in Chandigarh - ThinkNEXT provides Interior Designing Course in Chandigarh with 100% practical training by certified professional faculty." />
    <meta name="keywords" content="Interior Designing Course in Chandigarh, Interior Designing Training in Chandigarh" />
   <!-- Facebook sharing image show  -->
     <link rel="image_src" href="http://www.thinknexttraining.com/images/interior-designing-course-in-chandigarh-mob.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/images/interior-designing-course-in-chandigarh-mob.jpg" />
...
"@type": "ImageObject",
"url": "http://www.thinknexttraining.com/images/interior-designing-course-in-chandigarh-mob.jpg",
"width": "716",
"height": "730"
}</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main-image">  
         <img class="d-md-none"  src="images/interior-designing-course-in-chandigarh-mob.jpg" alt="Interior Designing Course in Chandigarh" />            
     <img class="d-none d-md-block" src="images/interior-designing-course-in-chandigarh.jpg" alt="Interior Designing Course in Chandigarh" />
                ...
                <div class="col-md-8 order">
                    <div class="text-justify border p-2 position-sticky top-0">
                        <div class="gdl-header-wrapper">
                            <h1>Interior Designing Course in Chandigarh</h1>
                        </div>
                        <p class="text-danger fw-bold">Do you want to be an Interior Designer?</p>
                        <p class="text-danger fw-bold">Are you looking for the best Interior Designing Course in Chandigarh?</p>
                        ...
                        <p class="text-primary fw-bold">Biggest brand for Professional Interior Designing Training in Chandigarh </p>

                        <p><strong>ThinkNEXT Technologies Private Limited </strong>is an<strong> ISO 9001:2015 certified </strong>Company/Institute that carries expertise in delivering the best <strong>Interior Designing Course </strong><strong>in Chandigarh</strong>. The learning in <strong>Interior Designing Course </strong>at <strong>ThinkNEXT</strong> will be project-based which will help students to understand the construction of interior spaces and the representation of a concept.</p>
                        <p><strong>ThinkNEXT</strong> is a <strong>6 time National Award Winner Company</strong> in the field of <strong>Industrial Training, Web Development and Digital Marketing</strong>. <strong>ThinkNEXT&rsquo;s Interior Designing Course </strong>is equipped with <strong>exceptional faculty members, modern classrooms</strong> that are bound to enhance each student&rsquo;s learning experience.</p>
                        <p>The approach of <strong>Interior Designing Course </strong>in <strong>ThinkNEXT</strong> is more <strong>practical</strong> along with an in-depth study of the technical and studio techniques.</p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" />
                </div>
    ...
    <section class="py-4 bg-black">
        <div class="container">
            <div class="row m-0">
                <div class="col-lg-7">
                    <h2 class="text-warning fw-bold">Interior Designing Training in Chandigarh</h2>
                    <div class="text-white text-justify">
                        <p><strong>Interior Designing </strong>is a leading business in <strong>Chandigarh</strong> for a long time now. After keeping in mind the current and future requirements of the <strong>interior designing industry</strong>, our course curriculum is designed. <strong>Interior designing</strong> majorly involves coming up with floor plans, 3D sketches, and models later on used by builders or property developers for <strong>interior development</strong>.</p>
                        <ul class="welcomeLinks">
                            <li><strong>ThinkNEXT</strong> offers <strong>1 month/3 months/6 months/1 year</strong> well-structured <strong>Professional Interior Designing Training</strong>.</li>
                            <li>Learn different <strong>presentation techniques, design visualization</strong> through this course by improving your skills to <strong>boost your interior designer career.</strong></li>
                            <li>We will also help to give you the insight to solve simple and complex problems in today&rsquo;s constantly evolving <strong>interior design industry</strong>.</li>
                        </ul>
                    </div>
    ...
    <section class="bg-ececec py-5">
        <div class="container">
            <h3 class="bg-0f54bb p-3 text-center text-white "><strong>Interior Designing - Course Contents</strong></h3>
            <br>
            <div class="row">
                <div class="col-sm-6 ">
                    <ul class="welcomeLinks mb-0">
                        <li>Introduction to 2D and 3D</li>
                        <li>Rendering for Photoshop</li>
                        <li>AutoCAD (2D + 3D)</li>
                        <li>3D Max Studio</li>
                        <li>Interior Designing</li>
                        <li>3D Plan Development from 2D</li>
                        <li>Paint effects and Look Development of 3D plans</li>
                ...
                <div class="col-sm-6">
                    <ul class="welcomeLinks">
                        ...
                        <li>V-ray Designing</li>
                        <li>Realistic Texturing and Renderings of 3D plans</li>
                        <li>Animation of 3D plans</li>
                        <li>Revit Architecture for Interior</li>
                        <li>Premiere with sound</li>
                        <li>Project</li>
                    </ul>
                </div>
    ...
    <section style="background: #060e1e;" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-warning fw-bold">Scope of Interior Designing</h3>
                    <div class="text-white text-justify">
                        <p>Ranked as one of the most creative professions in India, <strong>interior designers</strong> are making a living out of their passion. The <strong>scope of interior designing</strong> is complex. It includes the understanding and execution of aesthetics, esthetics and human activity patterns.</p>
                        <h3 class="text-warning fw-bold">Job Opportunities</h3>
                        <ul class="welcomeLinks">
                            <li><strong>Interior Decorator</strong></li>
                        </ul>

                        <p>The job role of an interior decorator includes planning the aesthetics and spatial layouts of the project. An <strong>interior decorator</strong> provides suggestions to clients for <strong>decorating their residential or office spaces, recommending colour schemes, wall designs, furniture and lighting installations</strong>.</p>
                        <ul class="welcomeLinks">
                            <li><strong>Colour Consultant</strong></li>
                        </ul>

                        <p>The role of a colour consultant or specialist requires <strong>creative planning and a thorough understanding of colour psychology</strong> to meet the client's aesthetic requirements.</p>
                        <ul class="welcomeLinks">
                            <li><strong>Production Designer</strong></li>
                        </ul>

                        <p><strong>Production designers</strong> are a crucial part of the film and video production process as they <strong>create sets for films, dramas and videos</strong>. Based on the creative script and direction, <strong>production designers have to plan and complete the film set before the shooting begins.</strong></p>
                        <ul class="welcomeLinks">
                            <li><strong>Exhibition Designer</strong></li>
                        </ul>
                        <p>An <strong>exhibit designer</strong> designs <strong>the floor work, seating arrangement, displays, fitting for events or public spaces such as fashion shows, museums and art galleries</strong>. It is important for them to have an aesthetic vision that is pleasing and creates curiosity among people.</p>
                        <ul class="welcomeLinks">
                            <li><strong>Lighting Designer</strong></li>
                        </ul>
                        <p><strong>Lighting designers transform the ambience of any space, such as an office, exhibition, store, home or a functional venue, </strong>with adequate and effective lighting installations.</p>
                    </div>
                </div>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-thumb.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-award-thumb.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/mohali-sithith-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/mohali-sithith-dm-award-thumbn.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-yugmarg.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-yugmarg-thumb.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-honor-thumb.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-honor-thumb.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award-chd.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-chd-thumb.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-mohali.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-mohali-thumb.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" alt="Interior Designing Course in Chandigarh">
                                </a>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenulership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Interior Designing Course in Chandigarh" title="Best Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Interior Designing Course in Chandigarh Mohali" title="6 Month Interior Designing Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Interior Designing Course in Chandigarh" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Interior Designing Course in Chandigarh" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Interior Designing Course in Chandigarh" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Interior Designing Course in Chandigarh" title="Interior Designing Course in Chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
...
<li>Interior Designing Training from 6 Times National Level Award Winner Company</li>
...
<li>Interior Designing from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
<li>ThinkNEXT offers Part-Time/Full-Time Job offer during Interior Designing Course so that students can earn while they learn.</li>
...
<li>Interior Designing Course from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
...
<li>Get Interior Designing Course in 3 modes: (1. Classroom training/Offline training   2. Instructor-led online Live training          3. Self-Paced Online Courses</li>
...
<li>Interior Designing Course from 10+ Years old company</li>

<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/how-to-learn-java.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>How to Learn Java - ThinkNEXT Technologies</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />How to Learn Java&nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / How to Learn Java
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
                <h1>How to Learn Java &nbsp; </h1>
            </div>
      
             <p>In this course, you will  learn the concepts of fundamental programming which will include  object-oriented programming using Java. <strong>Java  program</strong> can be defined as the collection of objects that communicates with  each other. To <strong>Learn Java</strong>, you have  to start from the basic topics of java which are Object, Class, Methods,  Instance Variables etc.</p>

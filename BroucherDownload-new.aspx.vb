    ...
    Public Sub insert()
        ...
        If Emailid.Text <> "" Then
            If Phoneno.Text <> "" Then
                ...
                varclass.SendLeads4(Phoneno.Text, "Student", Emailid.Text, "None", "Download Brochure", "https://www.thinknexttraining.com/")
                ' SendEmailbroucher()
                ...
                ElseIf Label1.Text = "Digital Marketing Broucher" Then
                    Response.ContentType = "application/pdf"
                    Response.AppendHeader("Content-Disposition", "attachment; filename=digital-marketing-course-chandigarh-brochure.pdf") 'need android pdf 
                    Response.TransmitFile(Server.MapPath("~/Broucher/digital-marketing-course-chandigarh-brochure.pdf")) 'thinknext brouchure has provided temporarily
                    Response.End()

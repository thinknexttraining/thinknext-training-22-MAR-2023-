<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="php-training.aspx.vb" Inherits="php_training" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <title>PHP Training in Chandigarh - ThinkNEXT</title>
...
<br/>
    ...
    <div class="container">
        <div class="col-lg-12">
    <h1 class="gdl-header-title">PHP Training in Chandigarh &nbsp;&nbsp; </h1>
            <br /> <br />

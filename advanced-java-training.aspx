<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/advanced-java-training.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Advanced Java Training - ThinkNEXT</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Advanced Java Training &nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / Advanced Java Training
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
                <h1>Advanced Java Training &nbsp; </h1>
            </div>
      
             <p><strong>Advance  Java</strong> is for that student who has already learned the fundamentals of <strong>Java Language.</strong> Advanced java goes deep  into the fundamental java topics which will help you to understand more  advanced concepts of java. The advanced java topics include the classic data  structure, sorting and searching, generic programming, sequential and  associative data, database programming with JBDC, networking programming, etc. <strong>ThinkNEXT Technologies Private Limited</strong> also gives the training of advanced java. ThinkNEXT is the <strong>Best Institute for Advanced Java Training.</strong></p>
...
<p style="padding-top: 6px; padding-left:8%;"> 
 <asp:Label ID="lblmessgaelogin"  style="text-align:center;" runat="server" ForeColor="Red" Font-Bold="True" Font-Size="9.3">
                              ...
                              <a href="-training-in-chandigarh.aspx">\MySQL Course</a><br>

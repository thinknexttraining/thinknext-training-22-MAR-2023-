<%@ Page Title="Register for Free Demo Class" Language="VB" MasterPageFile="~/topics/MasterPage-Topics.master" AutoEventWireup="false" CodeFile="free-demo-class.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

     
    <meta name="description" content="ThinkNEXT provides Free Demo Class for each students before registration" />

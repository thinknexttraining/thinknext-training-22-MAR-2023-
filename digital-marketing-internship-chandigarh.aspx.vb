...
Partial Class digital_marketing_internship_chandigarh
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtMobile.Text <> "" Then
                    ...
                    ' SMS2nd = "Dear " & txtName.Text & ", Thanks for your enquiry for Digital Marketing Internship in Chandigarh at ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon. To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
                    ' varclass.SendSMS(txtMobile.Text, SMS2nd, "Route9")
                    varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, "Digital Marketing Internship in Chandigarh", "Arrange a Call Back", "https://www.thinknexttraining.com/digital-marketing-internship-chandigarh.aspx")
    ...
    Public Sub SendEmailbroucher()
        ...
        StrContent = StrContent.Replace("[Course]", "Digital Marketing Internship in Chandigarh")
        ...
        msg.Subject = "Digital Marketing Internship in Chandigarh"
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            'SMS2nd = "Dear " & txtNameR.Text & ", Thanks for registration for Online Digital Marketing Internship in Chandigarh Test for Digital Marketing Internship in Chandigarh. Exam Date: " & lblnewssss.Text & " Timings: 11:00 AM to 4:00 PM Duration: 30 Minutes Venue: ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call 0172-4656197, 7837401000, 7837402000."
            ...
            varclass.SendLeads(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "Digital Marketing Internship in Chandigarh", "Demo Class", "https://www.thinknexttraining.com/digital-marketing-internship-chandigarh.aspx")
            txtdemoName.Text = ""
            txtdemoMblno.Text = ""
            txtdemoEmail.Text = ""
            txtdemoMsg.Text = ""

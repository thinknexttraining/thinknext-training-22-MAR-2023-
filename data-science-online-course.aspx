<%@ Page Title="Data Science Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="data-science-online-course.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="Data Science Online Course - ThinkNEXT is one of the best Training company providing 6 months and six weeks Data Science Training Online" />
    <meta name="keywords" content="Data Science Online Course, Data Science Online Training, best online data science courses, data analytics courses online, best data science certification online, data science certificate online, online master's in data science, coursera data science " />
    <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/share-images/data-science-training-in-chandigarh.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/share-images/data-science-training-in-chandigarh.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Data Science Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become Data Science Expert and Boost your Career. Enroll Now </strong></p>
                <br />
                        ...
                        <table class="table2" id="tb1">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="input" placeholder="Data Science Online Training" ReadOnly="true"></asp:TextBox>
                                <tr>
                                </tr>
                            <tr>
                                <td>
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-6 text-justify">
                ...
                <strong class="textred">Module1: Introduction</strong>
                ...
                <br />
                <strong class="textred">Module2:Core Python</strong>
                <ul class="welcomeLinks">
                    <li>Overview of Python- Starting with Python </li>
                    <li>Introduction to installation of Python </li>
                    <li>Introduction to Python Editors &amp; IDE's(Canopy, pycharm, Jupyter, Rodeo, Ipython etc…) </li>
                    <li>Python Syntax </li>
                ...
                <br />
                <strong class="textred">Module 3: Python Libraries for Data Science</strong>
                <ul class="welcomeLinks">
                    <li>Numpy </li>
                    <li>Scify </li>
                    <li>pandas </li>
                ...
                <br />
                <strong class="textred">Module 4: Python Modules for Access, Import/Export Data</strong>
                <ul class="welcomeLinks">
                    <li>Importing Data from various sources (Csv, txt, excel, access etc.) </li>
                    <li>Database Input (Connecting to database) </li>
                ...
                <br />
                <strong class="textred">Module 5: Data Manipulation, Cleansing and Munging</strong>
                <ul class="welcomeLinks">
                    <li>Cleansing Data with Python </li>
                    <li>Data Manipulation steps (Sorting, filtering, duplicates, merging, appending, subsetting, derived variables, sampling, Data type conversions, renaming, formatting etc.) </li>
                    <li>Data manipulation tools (Operators, Functions, Packages, control structures, Loops, arrays etc.) </li>
                    ...
                    <li>Important Python modules for data manipulation (Pandas, Numpy, re, math, string, datetime etc.) </li>
                </ul>
                <br />
                <strong class="textred">Module 6: Data Analysis and Visualization</strong>
                <ul class="welcomeLinks">
            ...
            <div class="col-lg-6 text-justify">
                ...
                <strong class="textred">Module 7: Statistics</strong>
                <ul class="welcomeLinks">
                ...
                <br />
                <strong class="textred">Module 8: Predictive Modeling</strong>
                <ul class="welcomeLinks">
                ...
                <br />
                <strong class="textred">Module 9: Data Exploration for Modeling</strong>
                <ul class="welcomeLinks">
                ...
                <br />
                <strong class="textred">Module 10: Data Preparation</strong>
                <ul class="welcomeLinks">
                ...
                <br />
                <strong class="textred">Module 11: Solving Segmentation Problems</strong>
                <ul class="welcomeLinks">
                ...
                <br />
                <strong class="textred">Module 12: Linear Regression</strong>
                <ul class="welcomeLinks">
                ...
                <br />
                <strong class="textred">Module 13: Logistic Regression</strong>
                <ul class="welcomeLinks">
                    <li>Introduction - Applications </li>
                ...
                <br />
                <strong class="textred">Module 14: Time Series Forecasting</strong>
                <ul class="welcomeLinks">
                    <li>Introduction - Applications </li>
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/data-science-online-course.aspx"
        });
    </script>
    <script>

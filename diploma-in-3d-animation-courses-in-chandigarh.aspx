<%@ Page Title="Animation Courses in Chandigarh Mohali | ThinkNEXT Technologies" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="diploma-in-3d-animation-courses-in-chandigarh.aspx.vb" Inherits="diploma_in_3d_animation_courses_in_chandigarh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   
 <meta name="description" content="Diploma in Animation & Multimedia in Chandigarh Mohali - ThinkNEXT is best Animation and Multimedia Training Institute provides 100% job oriented Animation & Multimedia " />
    <meta name="keywords" content="Diploma in Animation & Multimedia in Chandigarh Mohali " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main-image position-relative">
       <img class="d-md-none"  src="images/diploma-in -3d-animation-min.jpg" alt="Diploma in Animation Course in Chandigarch" />            
     <img class="d-none d-md-block" src="images/diploma-in -3d-animation-min.jpg" alt="Diploma in Animation Course in Chandigarch" />
                ...
                <div class="col-md-8">
                    <div class="p-2 border text-justify position-sticky top-0">
                        <div class="gdl-header-wrapper">
                           <h1>Diploma in 3D Animation, VFX & Multimedia Course in Chandigarh</h1>
                        </div>
                        <p class="text-danger fw-bold">Looking for the best institute for 3D Animation training in Chandigarh?</p>
                        ...
                        <p class="text-primary fw-bold">“Best 3D Animation Classes in Chandigarh region and India”</p>
                        <p>This course is meant for those students who wish to enter the Animation industry, and for working people who want to change their field of work or to do better within the Animation industry. Animation is not only about making cartoons or drawing caricatures; it is the art of creating an illusion of movement and bringing to life everything around you. With sharp skills and the right training, you can work in animation studios, gaming companies, television channels, advertising agencies & film production companies, and have a high-paying career. ThinkNEXT Technologies Pvt. Ltd. helps you develop your skills & build a professional work portfolio.</p>
                   </div>
                 </div>
                <div class="col-md-4">
        ...
        <div class="container">
            ...
            <div class="row">
                  <div class="col-12 mt-3 text-justify">
                              <strong class="textred">Module 1 - Graphic Design & Advertisement</strong>
                  </div>
...
<li>  Posters</li>
<li>  Catalogs Typography for web</li>
<li>  Color Schemes Digital Illustrations</li>
<li>  Social Media Design & Television & Broadcasting Design</li>
<li>  User Interface and Mobile Design & Project</li>
</ul> 
                </div>
                ...
                <div class="col-12 mt-3  text-justify">
                                      <strong class="textred">Module 2- Core Web Design and Connectivity</strong>
                  </div>
                <div class="col-lg-6 col-md-6 text-justify">
...
<li>  PSD to HTML5 & Project</li>
                ...
                <div class="col-12 mt-3 text-justify">
                                <strong class="textred">Module 3: 3D Animation-8 Months</strong>
                  </div>
                <div class="col-lg-6 col-md-6 text-justify">
...
<li> 3D Animation and Project</li>
                       ...
                       <div class="col-12 mt-3 text-justify">
                                 <strong class="textred">Module 4: Video Editing & Visual Effects- 4 Months</strong>
                  </div>
                <div class="col-lg-6 col-md-6 text-justify">
...
<li>3D Animation Training from 6 Times National Level Award Winner Company:</li>
...
<li>3D Animation Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>3D Animation Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
...
<li>3D Animation Training from 10+ Years old company</li>

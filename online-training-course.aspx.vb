...
Partial Class digital_marketing_course_training_in_chandigarh
    ...
    Private Sub Renderhtml()
        Dim courses = New List(Of Course)()
        Dim divStart As String = ""
        Dim divelectrical As String = ""
        Dim divmechanical As String = ""
        Dim divcivil As String = ""
                ...
                If Dt.Rows.Count > 0 Then
                    ...
                    For Each dr As DataRow In Dt.Rows
                        courses.Add(New Course() With {
                                .Name = Convert.ToString(dr("CourseName")),
                                .ActualyPrice = Convert.ToDecimal(dr("Prise").ToString()),
                                .CurrentPrice = Convert.ToDecimal(dr("DiscountOffer")),
                                .discountOffer = Convert.ToString(dr("DiscountPersentage")),
                                .BuyNowLink = Convert.ToString(dr("BuyNowLink")),
                                .ImagePath = Convert.ToString(dr("ImagePath")),
                                .Id = Convert.ToInt32(dr("Id")),
                                .CourseCatagoryId = Convert.ToInt32(dr("CourseCatagoryId"))
                            })
                    Next
                End If
            End If
        End If
        For Each item As Course In courses.Where(Function(a) a.CourseCatagoryId = 1).ToList()
            '"<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20'><img class='width-80' src='" + item.ImagePath + "' alt='Online Course Training in India' /><h4 class='text-center'><a href='" + item.BuyNowLink + "'> " + item.Name + "  </a></h4><a href='" + item.BuyNowLink + "'> <button class='pull-center btn btn-success btn-sm'>Buy Now</button></a> </div></div>"
            Dim imageHTML As String = "<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20 bg-warning shadow-lg p-3 mb-5 bg-white rounded'><div class='offer-discount'>" + Convert.ToString(item.discountOffer) + "</div><img class='width-100' src='" + item.ImagePath + "' alt='Online Course Training in India'><div class='pd-10 bg-grey'><h4 class='mt-0 mb-0 text-center'><a href='" + item.BuyNowLink + "' target='_blank'> " + item.Name + " </a></h4></div><div class='bg-white text-left pd-20'> <span><strong>Rs " + Convert.ToString(item.CurrentPrice) + " </strong></span> <del><strong>Rs " + Convert.ToString(item.ActualyPrice) + " </strong></del><strong> <a  class='pull-right btn btn-success btn-sm' href='" + item.BuyNowLink + " ' target='_blank'>Buy Now </a></strong></div></div></div>"
            divStart += imageHTML
        Next
        contentDiv.InnerHtml = divStart.ToString()
        For Each item As Course In courses.Where(Function(a) a.CourseCatagoryId = 2).ToList()
            '"<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20'><img class='width-80' src='" + item.ImagePath + "' alt='Online Course Training in India' /><h4 class='text-center'><a href='" + item.BuyNowLink + "'> " + item.Name + "  </a></h4><a href='" + item.BuyNowLink + "'> <button class='pull-center btn btn-success btn-sm'>Buy Now</button></a> </div></div>"
            Dim imageHTML As String = "<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20 bg-warning shadow-lg p-3 mb-5 bg-white rounded'><div class='offer-discount'>" + Convert.ToString(item.discountOffer) + "</div><img class='width-100' src='" + item.ImagePath + "' alt='Online Course Training in India'><div class='pd-10 bg-grey'><h4 class='mt-0 mb-0 text-center'><a href='" + item.BuyNowLink + "' target='_blank'> " + item.Name + " </a></h4></div><div class='bg-white text-left pd-20'> <span><strong>Rs " + Convert.ToString(item.CurrentPrice) + " </strong></span> <del><strong>Rs " + Convert.ToString(item.ActualyPrice) + " </strong></del><strong> <a  class='pull-right btn btn-success btn-sm' href='" + item.BuyNowLink + " ' target='_blank'>Buy Now </a></strong></div></div></div>"
            divelectrical += imageHTML
        Next
        divElectricalContain.InnerHtml = Convert.ToString(divelectrical)
        For Each item As Course In courses.Where(Function(a) a.CourseCatagoryId = 3).ToList()
            '"<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20'><img class='width-80' src='" + item.ImagePath + "' alt='Online Course Training in India' /><h4 class='text-center'><a href='" + item.BuyNowLink + "'> " + item.Name + "  </a></h4><a href='" + item.BuyNowLink + "'> <button class='pull-center btn btn-success btn-sm'>Buy Now</button></a> </div></div>"
            Dim imageHTML As String = "<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20 bg-warning shadow-lg p-3 mb-5 bg-white rounded'><div class='offer-discount'>" + Convert.ToString(item.discountOffer) + "</div><img class='width-100' src='" + item.ImagePath + "' alt='Online Course Training in India'><div class='pd-10 bg-grey'><h4 class='mt-0 mb-0 text-center'><a href='" + item.BuyNowLink + "' target='_blank'> " + item.Name + " </a></h4></div><div class='bg-white text-left pd-20'> <span><strong>Rs " + Convert.ToString(item.CurrentPrice) + " </strong></span> <del><strong>Rs " + Convert.ToString(item.ActualyPrice) + " </strong></del><strong> <a  class='pull-right btn btn-success btn-sm' href='" + item.BuyNowLink + " ' target='_blank'>Buy Now </a></strong></div></div></div>"
            divmechanical += imageHTML
        Next
        containDivMechanical.InnerHtml = Convert.ToString(divmechanical)
        For Each item As Course In courses.Where(Function(a) a.CourseCatagoryId = 4).ToList()
            '"<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20'><img class='width-80' src='" + item.ImagePath + "' alt='Online Course Training in India' /><h4 class='text-center'><a href='" + item.BuyNowLink + "'> " + item.Name + "  </a></h4><a href='" + item.BuyNowLink + "'> <button class='pull-center btn btn-success btn-sm'>Buy Now</button></a> </div></div>"
            Dim imageHTML As String = "<div class='col-lg-3 col-md-3 col-sm-3'><div class='text-center margin-bottom20 bg-warning shadow-lg p-3 mb-5 bg-white rounded'><div class='offer-discount'>" + Convert.ToString(item.discountOffer) + "</div><img class='width-100' src='" + item.ImagePath + "' alt='Online Course Training in India'><div class='pd-10 bg-grey'><h4 class='mt-0 mb-0 text-center'><a href='" + item.BuyNowLink + "' target='_blank'> " + item.Name + " </a></h4></div><div class='bg-white text-left pd-20'> <span><strong>Rs " + Convert.ToString(item.CurrentPrice) + " </strong></span> <del><strong>Rs " + Convert.ToString(item.ActualyPrice) + " </strong></del><strong> <a  class='pull-right btn btn-success btn-sm' href='" + item.BuyNowLink + " ' target='_blank'>Buy Now </a></strong></div></div></div>"
            divcivil += imageHTML
        Next
        divContainCivil.InnerHtml = Convert.ToString(divcivil)
    End Sub
    Public Class Course
        Public Sub New()
        End Sub
        Public Property Name As String
        Public Property ActualyPrice As Decimal
        Public Property CurrentPrice As Decimal
        Public Property discountOffer As String
        Public Property BuyNowLink As String
        Public Property ImagePath As String
        Public Property Id As Integer
        Public Property CourseCatagoryId As Integer
    End Class
    Public Function FillCources() As DataTable
        Dim sqlSelectQuery As String
        Dim da As SqlDataAdapter
        Dim ds As New DataTable
        Dim con As Class1 = New Class1()
        sqlSelectQuery = "SELECT Id, CourseName,Prise,DiscountOffer,BuyNowLink,ImagePath,DiscountPersentage,CourseCatagoryId FROM OnlineCourses order by BuyNowLink desc"

        Dim dtCourses As New DataTable
        Dim Connection As SqlConnection = New SqlConnection(con.GetConnectionString(String.Empty))
        Connection.Open()
        da = New SqlDataAdapter(sqlSelectQuery, Connection)
        da.Fill(ds)
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtMobile.Text <> "" Then
                    ...
                    varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/online-training-course.aspx")
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            varclass.SendLeads(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "None", "Demo Class", "https://www.thinknexttraining.com/online-training-course.aspx")
            txtdemoName.Text = ""
            txtdemoMblno.Text = ""
            txtdemoEmail.Text = ""
            txtdemoMsg.Text = ""
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        '------------------------------------------------------------------------
        varclass.SendLeads(txtMobileScholar.Text, txtNameScholar.Text, txtEmailIdScholar.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/online-training-course.aspx")
        Label4.Visible = True

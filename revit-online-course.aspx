<%@ Page Title="Revit Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="revit-online-course.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="Revit Online Course  - ThinkNEXT is one of the best Training company providing 6 months and six weeks Revit Training Online" />
    <meta name="keywords" content="revit online course, revit online training, revit courses near me, learn revit online, free online revit training, best revit online courses" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Revit Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become Revit Expert and Boost your Career. Enroll Now </strong></p>
                <br />
                        ...
                        <table class="table2" id="tb1">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="input" placeholder="revit Online Training" ReadOnly="true"></asp:TextBox>
                                <tr>
                                </tr>
                            <tr>
                                <td>
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/revit-online-course.aspx"
        });
    </script>
    <script>

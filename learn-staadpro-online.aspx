<%@ Page Title="Learn STAADPro Online - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="learn-staadpro-online.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="Learn STAADPro Online  - ThinkNEXT is one of the best Training company providing 6 months and six weeks STAADPro Training Online" />
    <meta name="keywords" content="Learn STAADPro Online, learn staad pro online free, staad pro online " />
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Learn STAAD.Pro Online</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become STAAD.Pro Expert and Boost your Career. Enroll Now </strong></p>
                <br />
                        ...
                        <table class="table2" id="tb1">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="input" placeholder="staadpro Online Training" ReadOnly="true"></asp:TextBox>
                                <tr>
                                </tr>
                            <tr>
                                <td>
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-6 text-justify">
                <p><strong>Introduction to STAAD Pro</strong></p>
                ...
                <p class="plr-30">
                    <i class="fa fa-check"></i>Using Structure Wizard <br>
                    <i class="fa fa-check"></i>Drafting the Geometry using Snap node <br>
                    <i class="fa fa-check"></i>Using Copy/Cut with Paste <br>
                    <i class="fa fa-check"></i>Using Spreadsheet (Excel) Copy and Paste <br>
                    <i class="fa fa-check"></i>Using DXF importing file function <br>
                </p>

                <p><strong>Additional tools for modeling</strong></p>
                <ul class="welcomeLinks">
                ...
                <p class="plr-30">
                    <i class="fa fa-check"></i>Prismatic<br>
                </p>
                <ul class="welcomeLinks">
                    <li>Viewing Cross-Section </li>
                </ul>
                <p class="plr-30">
                    <i class="fa fa-check"></i>Built-In Steel Table<br>
                    <i class="fa fa-check"></i>Thickness<br>
                </p>
                <ul class="welcomeLinks">
            ...
            <div class="col-lg-6 text-justify">
                <p><strong>Constants, Supports, and Specifications</strong></p>
                <ul class="welcomeLinks">
                ...
                <p class="plr-30">
                    <i class="fa fa-check"></i>How to Assign Supports <br />
                    <i class="fa fa-check"></i>Editing Supports <br />
                </p>
                <ul class="welcomeLinks">
                ...
                <p class="plr-30">
                    <i class="fa fa-check"></i>Self-weight <br />
                    <i class="fa fa-check"></i>Members <br />
                    <i class="fa fa-check"></i>Area Load <br />
                    <i class="fa fa-check"></i>Floor Load <br />
                    <i class="fa fa-check"></i>Plate Loads <br />
                    <i class="fa fa-check"></i>Node <br />
                </p>
                <ul class="welcomeLinks">
                ...
                <p class="plr-30">
                    <i class="fa fa-check"></i>Node Displacement<br>
                    <i class="fa fa-check"></i>Node Reactions<br>
                    <i class="fa fa-check"></i>Beam Forces<br>
                    <i class="fa fa-check"></i>Beam Stresses<br>
                    <i class="fa fa-check"></i>Beam Graphs<br>
                </p>
                <ul class="welcomeLinks">
                    <li>Animation</li>
                </ul>
                <p class="plr-30">
                    <i class="fa fa-check"></i>Other Ways: Double-clicking a Beam <br />
                </p>
            </div>
            <div class="clear-both"></div>
        </div>
...
<br />
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/learn-staadpro-online.aspx"
        });
    </script>
    <script>

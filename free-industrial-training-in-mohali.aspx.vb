...
Partial Class free_industrial_training_in_mohali
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            varclass.SendLeads(txtContectR.Text, txtNameR.Text, txtEmailR.Text, "None", "Register for Free Industrial Training", "https://www.thinknexttraining.com/free-industrial-training-in-mohali.aspx  ")

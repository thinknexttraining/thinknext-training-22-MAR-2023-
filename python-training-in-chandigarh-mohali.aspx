<%@ Page Title="Python Training Chandigarh Mohali Panchkula INDIA" Language="VB"  MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="python-training-in-chandigarh-mohali.aspx.vb" Inherits="python_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   
 <meta name="description" content=" Python Training in Chandigarh Mohali Panchkula - ThinkNEXT is top Python training company that provides Python training in chandigarh from ThinkNEXT Company expert as trainers and get details on python classes in Chandigarh, " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="main-image">
            <img class="d-md-none" src="images/python-training-in-chandigarh-mob.jpg" alt="Python Training in Chandigarh" title="Python Training in Chandigarh">
         <img class="d-none d-md-block" src="images/python-course-in-chandigarh-mohali.jpg"  alt="Python Training Course in Chandigarh Mohali Panchkula" title="Python Training Course in Chandigarh" />
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                       <div class="gdl-header-wrapper">
                        <h1>Python Training in Chandigarh Mohali Panchkula</h1>
                    </div>
                <p><strong>Best Python training in Chandigarh Mohali  at ThinkNEXT Technologies Private Limited</strong>&nbsp;can help you build a desirable career. We have put  efforts to provide the <strong>Python training in Chandigarh Mohali</strong> and that is the reason why we have been able  to earn a good name for ourselves in the market. We are an experienced <strong>Python training company in Chandigarh  Mohali</strong> with a lot of desire to see our students doing great in the IT  field. We leave no stone unturned to make sure our students get trained in a  way that they can bring name and fame not just to themselves and their  families.<br />
  We have some  of the most experienced and knowledgeable trainers in Chandigarh Mohali, having  great proficiency in theories and immense technical knowledge. And guess what,  they train students by applying a student-centric approach to teaching. As a  result, they have always been successful in ensuring satisfactory learning  outcomes in trainees.<br />
  Our courses  are another reason why people give us the&nbsp;<strong>best python training course institute in Chandigarh Mohali</strong>.&nbsp;Courses  suited to all kinds of learners and have designed keeping in mind the  needs,&nbsp;standards, and expectations of the industry from python-trained people. We leave no stone unturned to keep you at the forefront  of technology and see to it that every tiny bit of information you receive from  us is correct and relevant to the present-day world.</p>
 ...
 <a class="popupvid" href="#!" data-link="https://www.youtube.com/embed/RQUxnNDbnO0" data-img="https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Crystal_button_cancel.svg/1024px-Crystal_button_cancel.svg.png">
                        <img class="main-video" src="https://i.ytimg.com/vi/RQUxnNDbnO0/maxresdefault.jpg"
 alt="Six Months Industrial Training in Chandigarh">
<svg class="ytp-large-play-button" version="1.1" viewBox="0 0 68 48"><path class="ytp-large-play-button-bg" d="M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55 C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19 C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z" fill="#f00" fill-opacity="0.8">
                ...
                <div class="col-lg-6 text-justify">
                     <div class="position-sticky top-0">                    
                      ...
                      <h2 class="text-danger">Python</h2>
                        <p>
                            Python is a  programming language that interpreted, interactive, object- oriented and extended.  Its philosophy of design emphasizes the readability of the code, and its  programming structure allows programmers to express concepts in fewer lines of  code than in languages ​​such as C ++ or Java.<br />
                            Python  supports many programming models, including object-oriented programming,  deterministic 
                            programming, and functional or procedural methods. It contains  dynamic
                            system and automatic memory management and has a large standard  library.
                        </p>     
        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/iconic-business-summit-awards-jaya-prada-min.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/national-icon-award-suniel-shetty-min.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/asias-quality-entreprenuarship-award-karisma-min.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/National-Gratitude-Award-sonali-bendre-min.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/business-leaders-award-surendra-pal-min.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" />
                </div>

                <div class="col-sm-6 col-md-4 col-lg-4 pb-3 py-1">
                    <img src="images/Nations-Pride-Award-faggan-min.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" />
                </div>
        ...
        <div class="container">
            <div class="row m-0 p-2">
                ...
                <div class="col-lg-7 text-justify">
                    ...
                    <div class="position-sticky top-0">
                        <h2 class="text-danger"><b>Why Python?</b></h2>
                        <ul class="welcomeLinks">
                            <li>Python works on different platforms (Windows, Mac, Linux, Raspberry Pi, etc.).</li>
                            <li>Python has a simple structure like to English.</li>
                            <li>Python contains a structure that allows developers to write programs that have fewer lines than some other programming languages.</li>
                            <li>Python works on an interpreter system, which means that the code can be executed as soon as it written. This means that prototypes can be very fast.</li>
                            <li>Python can handle in a procedural manner, object-oriented or functional way.</li>
                        </ul>
                        <p>
                            <strong class="textred">What Can Python Do?</strong><br />
                            Python is a  programming language that is interpreted, interactive, object-oriented and  extended. 
    Its philosophy of design emphasizes the readability of the code, and  its programming structure allows
    programmers to express concepts in fewer lines  of code than in languages ​​such as C ++ or Java.
                        </p>
    ...
    <section class="py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>Python Industrial Training - Course Contents</strong></h3>
            </div>            
            
            <div class="row">
              <div class="col-lg-6 col-md-6 text-justify mt-4">

                    <p class="h4 text-danger"><strong>Module 1: Python Introduction</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. What is python??</li>
                        <li>2. History of python.</li>
                    </ul>
                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 2:  Environment Setup</strong></p>
                    <ul class="welcomeLinks">                      
                        <li>1. Setting up the working environment for python.</li>
                        <li>2. Working in Console and Python Shell.</li>
                        <li>3. Introduction to PYcharm</li>
                    </ul>
                </div>
            ...
            <div class="row">               
                <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"> <strong>Module 3: Syntax</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Learning the rules to write a python code.</li>
                        <li>2. Creating your first Python program.</li>
                    </ul>
                </div>
                
                <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 4: Variable</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Introduction to variables.</li>
                        <li>2. Introduction to Data Types.</li>
                        <li>3. Assigning values to variables.</li>
                        <li>4. Working with different type of variables.</li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 5: Operator</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Introduction to operators.</li>
                        <li>2. Using Arithmetic operators.</li>
                        <li>3. Working with other operators like Unary, assignment, Logical etc.</li>
                    </ul>
                </div>

                <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 6: Decision Making</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Introduction to control statements.</li>
                        <li>2. Working with If, Elif and Nested If.</li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 7: Loop</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Introduction to loops.</li>
                        <li>2. Working with While Loop.</li>
                        <li>3. Using For Loop.</li>
                    </ul>
                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 8: Number</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Different types of numbers.</li>
                        <li>2. Working with numbers.</li>
                        <li>3. Type Conversion.</li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 9: String</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Accessing values in String.</li>
                        <li>2. Updating String.</li>
                        <li>3. String operators.</li>
                    </ul>
                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                         <p class="h4 text-danger"><strong>Module 10: List</strong></p>
                        <ul class="welcomeLinks">
                            <li>1. Introduction to List.</li>
                            <li>2. Performing Different operation on list.</li>
                        </ul>
                    </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 11: Tuples and Dictionary</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Introducing Tuples and Dictionary in Python.</li>
                        <li>2. Working with Tuples and Dictionary.</li>
                        <li>3. Assigning new values to dictionary.</li>
                    </ul>

                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 12: Date and Time</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Tick.</li>
                        <li>2. TimeTuple.</li>
                        <li>3. Accessing Time and Calendar.</li>
                        <li>4. Printing a month chart.</li>
                    </ul>
                </div>
            ...
            <div class="row">
               <div class="col-lg-6 col-md-6 text-justify mt-4">
                    <p class="h4 text-danger"><strong>Module 13: Functions</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Defining Function.</li>
                        <li>2. Working with Functions.</li>
                        <li>3. Use function to reuse your code.</li>
                    </ul>
                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 14: Modules</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Define Module.</li>
                        <li>2. Working with numbers.</li>
                    </ul>
                </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 15: Working With Files</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Reading config files in python.</li>
                        <li>2. Writing log files in python.</li>
                        <li>3. Understanding read functions, read(), readline() and readlines().</li>
                        <li>4. Understanding write functions, write() and writelines().</li>
                        <li>5. Manipulating file pointer using seek.</li>
                        <li>6. Programming using file operations.</li>
                    </ul>
                </div>

            <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 16: Exception Handling</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Defining Exception.</li>
                        <li>2. Using Try and except methods.</li>
                        <li>3. Working with assertion.</li>
                    </ul>
                </div>
          ...
          <div>
                <h4 class="h3 bg-0f54bb p-3 text-center text-white"><strong>Python Advanced Course Content:</strong></h4>
            </div>
            <br>

            <div class="row">
             <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 17: OOPS concepts</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Concept of class, object and instances.</li>
                        <li>2. Constructor, class attributes and destructors.</li>
                        <li>3. Real time use of class in live projects.</li>
                        <li>4. Inheritance.</li>
                    </ul>
                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 18: Regular Expressions</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Powerful pattern matching and searching.</li>
                        <li>2. Power of pattern searching using regex in python.</li>
                        <li>3. Real time parsing of networking or system data using regex.</li>
                        <li>4. Password, email, url validation using regular expression.</li>
                        <li>5. Pattern finding programs using regular expression.</li>
                    </ul>
                </div>
            ...
            <div class="row">
             <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 19: CGI programming</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Writing python program for CGI applications.</li>
                        <li>2. Creating menus and accessing files.</li>
                        <li>3. Server client program.</li>
                    </ul>
                </div>

               <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 20: Database Access</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. SQL Database connection using python.</li>
                        <li>2. Creating and searching tables.</li>
                        <li>3. Reading and storing config information on database.</li>
                        <li>4. Programming using database connections.</li>
                    </ul>
                </div>
            ...
            <div class="row">
               <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 21: Networking</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Understanding Socket.</li>
                        <li>2. Understanding server and client.</li>
                    </ul>
                </div>

            <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 22: Working with Email</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Installing SMTP python module.</li>
                        <li>2. Sending email.</li>
                        <li>3. Reading from file and sending emails to all users addressing them.</li>
                        <li>4. Directly for marketing.</li>
                    </ul>
                </div>
            ...
            <div class="row">
           <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 23: Multi-threading</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Understanding threads.</li>
                        <li>2. Forking threads.</li>
                        <li>3. Synchronizing the threads.</li>
                        <li>4. Programming using multi-threading.</li>
                    </ul>
                </div>

           <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 24: GUI Programming</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Working with Graphical User Interface.</li>
                    </ul>
                </div>
            ...
            <div class="row">
             <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 26: XML Processing</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Introduction to XML.</li>
                        <li>2. Parsing XML and SAX APIs.</li>
                    </ul>
                </div>

                <div class="col-lg-6 col-md-6 text-justify mt-4">
                     <p class="h4 text-danger"><strong>Module 26: Python Projects</strong></p>
                    <ul class="welcomeLinks">
                        <li>1. Creating user Registration software.</li>
                        <li>2. Hotel Management Software.</li>
                    </ul>
                </div>
    ...
    <section class="help-section py-5" style="background: #22242b;">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3 mt-3 text-justify">
                    <ul class="welcomeLinks text-justify text-white">
                        <li><strong>Readability -</strong> Python's syntax is legible and clear. The manner in which it is organized imposes some order on programmers. Beginners and experts can easily understand the code, and everyone can become productive in Python very quickly. It is very important to mention that Python has fewer "dialects" than other popular languages ​​such as Perl.</li>
                        <li><strong>Straightforward to get support -</strong> The Python community always offers good support to the Python users. As we are already aware of the fact that Python code is freely accessible to everyone, millions of developers around the world work hard to find mistakes and craft spots to solve all the mistakes. Several individuals make new improvements to the language and submit it for approval.</li>
                        <li><strong>Quick to learn -</strong> The Python programming language is simple enough to learn because the source code is a fake code. You will not need too much training here. You, in fact, can get pretty quick results without spending too much time. When you start learning the Python language, you can immediately utilize useful encryption. When you gain some practice, most of your productivity will grow. You can even design an object-oriented and high-level programming code. For smaller tasks, this is a great feature.</li>
                       </ul>
                        </div>
                <div  class="col-lg-6 col-md-3 mt-3 text-justify">
                    ...
                    <ul class="welcomeLinks text-justify text-white">
                        ...
                        <li><strong>Reusability -</strong> Python invokes reuse program by implementing packages and modules accurately. A huge set of units has been created and presented as a standard Python library, an essential part of the Python distribution. You can simply share functions between different programs only by splitting them into several modules and reusing them as components for other specific programs.</li>
                        <li><strong>Portability -</strong> Python not only works on multiple systems but also has a similar interface on different platforms. The design of this language is not specifically related to a particular operating system as written in ANSI C. Mobile. It means that you can easily write Python on a Mac operating system, test it on a Linux operating system, and easily load it into Windows.</li>
                        <li><strong>Object–Oriented Programming -</strong> Typically, scripting languages ​​contain support for routing a different object in the programming language. It works as simple addition. However, everything in this language has been specifically designed to be a theme and theme. You can start the programming process by using non-OO structures. Object-oriented programming is not only simple but very useful as well.</li>
...
<li>Python Training from 6 Times National Level Award Winner Company:</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Python Training in Chandigarh Mohali" title="Best Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Python Training in Chandigarh Mohali Mohali" title="6 Month Python Training in Chandigarh Mohali Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Python Training in Chandigarh Mohali" title="Python Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

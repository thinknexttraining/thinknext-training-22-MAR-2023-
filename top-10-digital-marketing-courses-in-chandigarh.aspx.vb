...
Partial Class top_10_digital_marketing_courses_in_chandigarh
    ...
    Sub AddStudentDetail()
        ...
        If txtName.Text <> "" Then
            ...
            cmd.Parameters.AddWithValue("@Comment", "www.thinknexttraining.com/top-10-digital-marketing-courses-in-chandigarh.aspx")

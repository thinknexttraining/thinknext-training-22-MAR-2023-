...
Partial Class top_7_ielts_coaching_institutes_in_chandigarh
    ...
    Sub AddStudentDetail()
        ...
        If txtName.Text <> "" Then
            ...
            cmd.Parameters.AddWithValue("@Comment", "www.thinknexttraining.com/top-7-ielts-coaching-institutes-in-chandigarh.aspx")

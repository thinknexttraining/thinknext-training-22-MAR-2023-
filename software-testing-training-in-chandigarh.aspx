<%@ Page Title="Software Testing Training in Chandigarh Mohali - ThinkNEXT " Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="software-testing-training-in-chandigarh.aspx.vb" Inherits="software_testing_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">   
 <meta name="description" content="Best Software Testing Training Institute in Chandigarh, Mohali and Panchkula, 100% job gauranteed courses, manual testing, automation tools, QTP Tools, Loadrunner training." />
    <meta name="author" content=" Munish Mittal, mittalmunish@thinknext.co.in " />
    <!-- Facebook sharing image show  -->
     <link rel="image_src" href="http://www.thinknexttraining.com/images/Software-Testing-training-in-chandigarh-mob.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/images/Software-Testing-training-in-chandigarh-mob.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="main-image">  
            <img class="d-md-none" src="images/Software-Testing-training-in-chandigarh-mob.jpg" alt="Software Testing Training Course in Chandigarh" title="Software Testing Training Course in Chandigarh">
         <img class="d-none d-md-block" src="images/Software-Testing-training-in-chandigarh.jpg"  alt="Software Testing Training Course in Chandigarh" title="Software Testing Training Course in Chandigarh" />       
                ...
                <div class="col-md-8">
                    <div class="p-2 border text-justify position-sticky top-0">
                        <div class="gdl-header-wrapper">
                            <h1>Best Software Testing Training in Chandigarh Mohali</h1>
                        </div>
                        <p>
                            <strong>ThinkNEXT Technologies</strong> is the one of the best leading IT/software Company that provides <strong>Software Testing training in Chandigarh, Mohali</strong> for students to build their career in IT. Software Quality Testing 
                       Training provides the concepts on software quality assurance and manual testing of applications. Students get to know about various testing types, techniques and testing methodologies. The course- ware is divided into teaching the basic concepts of software testing and then covering practical software 
                       testing with approach of writing testcases, reporting bugs, regression testing and test planning.
                    Students will learn the following concepts under Software Testing – Manual Testing + QA + Bugzilla + 
                    Jira+ QC, SQL + Database Testing, Basic & Advanced HP QTP / UFT 11.5, Basic & Advanced Selenium. 
                    Also will get to work on real time projects which will be helpful to face the real-time challenges
                    successfully in a job. <strong>ThinkNEXT Technologies</strong> offering <strong>100% job oriented 
                        courses after 12th.</strong> Join professional Software Testing course in Chandigarh expose your
                    carrier as a software tester.
                        </p>

                        <p><strong>ThinkNEXT</strong> recognized among the <strong>Top Ten Software Testing Company in  Chandigarh Mohali </strong>which is providing training to the beginners, intermediate and experts. At <strong>ThinkNEXT  Technologies, Software Testing Course in Chandigarh Mohali </strong>is conducted by  working Professionals having 10+ years of experience in IT Industry. Our association with the good organization makes us capable to provide 100%  placements to the students.</p>
                        <p>
                            <strong>Duration:</strong> 6Weeks/8Weeks/12Weeks/24Weeks<br />
                            <br />

                            <strong>*Pre-requisite Qualification(s) should be</strong>: Any Graduate having good analytical skills B.Sc.(IT), BCA, B.Tech, M.Sc.(IT),MCA,MBA(IT),M.Tech.
            ...
            <div class="row m-0 p-2">
                ...
                <div class="col-lg-7 text-justify">
                     ...
                     <div class="position-sticky top-0">
                         <h3 class="text-danger"><strong>Software Testing</strong></h3>
                             <p><strong>Software Testing</strong> is the process of executing a program or application with the intent of finding software error (bug, defect) and makes it quality product.Software testing is an activity to ensure that the software is defect free and to check whether the actual result matches the expected result. Testing plays an important role in <strong>software development</strong> as the evaluation of quality is important before it’s launched into the market.</p>
              <p>In the past, the term "software tester" was not used specifically, but later it was also seen as a separate profession. In Software Testing profession different roles have been established, such as test manager, test lead, test analyst, test designer, tester, automation developer, and test administrator. </p>
                <p>Software Quality Assurance uses the following testing approaches like unit testing, integration testing, functional testing, system testing, regression testing, load testing, stress testing, usability testing, and acceptance testing. Software testing can either perform manually or by using automated tools. Some of the methods include white box testing, black box testing, and grey box testing.</p>
                <p>
    ...
    <section class="py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>Software Testing Training 
              - Course Contents</strong></h3>
            </div>
            <br>
            <div class="row">
                 <div class="col-lg-5 col-md-4 mt-3 text-justify">

                    <strong class="textred">Testing Concepts</strong>
...
<li>  Introduction to test planning</li>
                 ...
                 <div class="col-lg-4 col-md-4 mt-3 text-justify">
                    <strong class="textred">Mobile Testing</strong>
                    <ul class="welcomeLinks">
...
<li>  Mobile Performance testing with tools.</li>
                ...
                <div class="col-lg-3 col-md-4 mt-3 text-justify">
                    <strong class="textred">Introduction to Data Base Testing </strong>
                    <ul class="welcomeLinks">
...
<li>  Back end test methods</li>
                     ...
                     <strong class="textred">Structural back end tests </strong>
                    <ul class="welcomeLinks">
...
<li>  Common bug</li>
                 ...
                 <div class="col-lg-5 col-md-4 mt-3 text-justify">
                    ...
                    <strong class="textred">Functional back end tests</strong>
...
<li>  Common bugs</li>
                 ...
                 <div class="col-lg-4 col-md-4 mt-3 text-justify">
                    ...
                    <strong class="textred">Testing The Nightly downloading and Distribution jobs</strong>
                    <ul class="welcomeLinks">
                       <li>Batch jobs</li>
...
<li>  Common bugs</li>
                ...
                <div class="col-lg-3 col-md-4 mt-3 text-justify">
                    ...
                    <strong class="textred">Testing the Interfaces to Transaction APIS</strong>
                    <ul class="welcomeLinks">
                      ...
                      <strong class="textred">Other Database testing Issues</strong>
                    <ul class="welcomeLinks">
                        <li>  Test tips </li>
                        <li>Test tools</li>
                        <li>Useful querie</li>
                 ...
                 <div class="col-lg-5 col-md-4 mt-3 text-justify">
                    ...
                    <strong class="textred">QTP</strong>
                    <ul class="welcomeLinks">
                        <li>BASIC</li>
...
<li>  Object Recognition and Smart Identification</li>
                      ...
                      <strong class="textred">Advance</strong>
                    <ul class="welcomeLinks">
...
<li>  Analyzing Results</li>
                 ...
                 <div class="col-lg-4 col-md-4 mt-3 text-justify">
                       ...
                       <strong class="textred">Selenium</strong>
                    <ul class="welcomeLinks">
                  <li>Java Essentials for Selenium</li>

<li>Java Programming Basics</li>

<li>Installing Java</li>
<li>Installing Eclipse</li>
<li>First Eclipse Project</li>
<li>First Java program</li>
<li>Concept of class file</li>
<li>Datatypes in Java</li>
<li>String class and functions</li>
<li>Conditional Statements</li>
<li>Loops</li>
<li>Arrays</li>
<li>Single Dimensional Arrays</li>
<li>Two Dimensional arrays</li>
<li>Practical usage of arrays in Selenium</li>
<li>Operators</li>
...
<li>Static and Non-Static Functions</li>
<li>Creating Objects in Java</li>
<li>Meaning of static</li>
<li>Why is main method static?</li>
<li>Object and Object References</li>
<li>Call by reference and Value</li>
<li>Overloading and Overriding Functions</li>
<li>Access Modifiers – Public/Private/Default/Protected</li>
<li>Constructors</li>
<li>Interface</li>
<li>Usage of Objects in Selenium</li>
                ...
                <div class="col-lg-3 col-md-4 mt-3 text-justify">
                    <ul class="welcomeLinks">
                        <li>Inheritance</li>
<li>Usage of Inheritance in Selenium</li>
<li>Creating Packages</li>
<li>Accessing Classes across Packages</li>
                    <li>What is Selenium?</li>
<li>Who developed Selenium?</li>
<li>Selenium Components</li>
<li>Selenium IDE</li>
<li>Installing Selenium IDE</li>
<li>Creating your First Selenium IDE script</li>
<li>How to use Locators in Selenium IDE</li>
<li>How to enhance a script using Selenium IDE</li>
<li>Creating and Running Tests</li>
<li>Creating and Running Test Suite</li>
<li>WebDriver Introduction</li>
<li>Introduction to WebDriver & Comparison with Selenium RC</li>
<li>Installing Selenium WebDriver</li>
<li>Architecture of selenium Webdriver</li>
<li>Creating your First Script in Webdriver</li>
<li>Launching AUT and Inspecting properties of Elements</li>
<li>Launching AUT in FireFox</li>
<li>Launching AUT in InternetExplorer</li>
<li>Launching AUT in Chrome</li>
<li>Launching AUT in Safari</li>
<li>Inspecting properties of Elements on different Browsers</li>
<li>Installing FireBug and FirePath</li>
<li>Creating FireFox Profile</li>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-thumb.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-award-thumb.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/mohali-sithith-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/mohali-sithith-dm-award-thumbn.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-yugmarg.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-yugmarg-thumb.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-honor-thumb.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-honor-thumb.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award-chd.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-chd-thumb.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-mohali.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-mohali-thumb.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" alt="Software Testing Training in Chandigarh">
                                </a>
                            </div>
                        </div>
    ...
    <section class="py-4 ">
        <div class="container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-justify">
                <ul class="welcomeLinks">                   
<li>Software Testing Training from 6 Times National Level Award Winner Company:</li>
...
<li>Software Testing Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>Software Testing Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
...
<li>Free online courses for class-room/offline students undergoing Software Testing Training</li>
<li>Get Software Testing Training in 3 modes: (1. Classroom training/Offline training   2. Instructor-led online Live training          3. Self-Paced Online Courses</li>
...
<li>Software Testing Training from 10+ Years old company</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Software Testing Training Course in Chandigarh Mohali" title=" Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Software Testing Training Course in Chandigarh Mohali Mohali" title="6 Month Software Testing Training Course in Chandigarh Mohali Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Software Testing Training Course in Chandigarh Mohali" title="Software Testing Training Course in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

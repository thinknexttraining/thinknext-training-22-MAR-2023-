...
Partial Class php_training_in_chandigarh
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtMobile.Text <> "" Then
                    sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,StudentMobileNo,Course,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values('" + enquiryno + "','" + txtName.Text + "','" + txtEmailId.Text + "','" + txtMobile.Text + "','" + "Software Industrial Training" + "','" + "Software Industrial Training" + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',@Admissiondate)")
                    ...
                    'SMS2nd = "Dear " & txtName.Text & ", Thanks for your enquiry for Software Industrial Training at ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon. To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
                    ' varclass.SendSMS(txtMobile.Text, SMS2nd, "Route9")
                    varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/software-companies-providing-industrial-training-chandigarh-mohali.aspx")
    ...
    Public Sub SendEmailbroucher()
        ...
        StrContent = StrContent.Replace("[Course]", "Software Industrial Training")
        ...
        msg.Subject = "Industrial Training"
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            varclass.SendLeads(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "None", "Demo Class", "https://www.thinknexttraining.com/software-companies-providing-industrial-training-chandigarh-mohali.aspx")
            txtdemoName.Text = ""
            txtdemoMblno.Text = ""
            txtdemoEmail.Text = ""
            txtdemoMsg.Text = ""

<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/java-industrial-training-in-panchkula.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Java Industrial Training in Panchkula - ThinkNEXT Technologies </title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Java Industrial Training in Panchkula </h3>
    <div class="ryt">

 You Are Here / Java Industrial Training in Panchkula
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
                <h1>Java Industrial Training in Panchkula &nbsp;</h1>
            </div>

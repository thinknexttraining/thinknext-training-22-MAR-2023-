<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/java-for-beginners.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Java for Beginners - ThinkNEXT</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Java for Beginners &nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / Java for Beginners
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
             ...
             <p>For beginners, it is very  important to know <strong>what is java</strong>? <strong>Java is a programming language</strong> and  computing platform 6 that is released by Microsystems. There is a number of  applications and website which only works upon the system in which java is  pre-installed. Java is everywhere like in laptops, cell phones, games,  scientific super computers etc. So, it is a good step towards your future if  you are thinking to <strong>learn java</strong>. <strong>ThinkNEXT</strong> is one of the famed  institutes in its area for its <strong>java  training</strong>.  This institute provides  the well-experienced trainers of java. </p>

<%@ Page Title="" Language="VB" MasterPageFile="~/topics/MasterPage-Topics.master" AutoEventWireup="false" CodeFile="android-course.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>Android Course - ThinkNEXT Technologies</title>
   <meta name="description" content="Android Training course - ThinkNEXT is best android training Company providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image">
        ...
        <img src="../android-images/Android-Training-Course-in-Chandigarh-Mohali-Panchkula.jpg" alt="Android Course in Chandigarh" />
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
                <h1>Android Course</h1>       
         
               </div>
              
           <img src="../android-images/learn-android-programming.jpg" width="100%" title="" alt="Android Course in Chandigarh" />
             <br /><br />
                <p><strong>Android  course</strong> is very important for those students who want to make  their future in the field of Android. Android is related to the development of  the Mobile Apps. ThinkNEXT Technologies Pvt. Ltd is the top class company in  the area of Chandigarh, Mohali or Panchkula which offers the <strong>Android course</strong>. The course duration is 6  weeks, 3 months or 6 months. The trainers of the company are highly qualified  and well experienced. They educate their students with the help of examples.  They educate their students in the understandable language. ThinkNEXT Company  provides all the essential skills that are necessary for students.</p>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        <div class="without_border dwl" >
          <div class="brochiframe"  id="brochiframe">
            ...
            <img class="closebrochureiframe" alt="Android Course in Chandigarh" src="../images/close.png"  onclick="clsifrm()"  /> 
               
          </div>

        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Android Course in Chandigarh" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Android Course in Chandigarh" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Android Course in Chandigarh"/></div>

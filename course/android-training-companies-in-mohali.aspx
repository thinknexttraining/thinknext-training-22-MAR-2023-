<%@ Page Title="" Language="VB" MasterPageFile="~/course/MasterPage-course.master" AutoEventWireup="false" CodeFile="android-training-companies-in-mohali.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>Android Training Companies in Mohali - ThinkNEXT</title>
  <meta name="description" content="Android Training course - ThinkNEXT is best android training institute providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image">
        ...
        <img src="../android-images/Android-Training-Course-in-Chandigarh-Mohali-Panchkula.jpg" alt="Android Training Companies in Mohali Chandigarh" />
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
                <h1>Android Training Companies in Mohali Chandigarh</h1>       
         
               </div>
              
             <img src="../android-images/Android-App-Development-Course.jpg" width="100%" alt="Android Training Companies in Mohali Chandigarh" />
            <br /><br />
                   <p>ThinkNEXT Technologies Pvt. Ltd. is one of the experienced company in Mohali. It is the best company which provides the Android training in Mohali. ThinkNEXT is the leading company for many years. On the other side, ThinkNEXT is the solid foundation on the platform of Android in Mohali.</p>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        <div class="without_border dwl" >
          <div class="brochiframe"  id="brochiframe">
            ...
            <img class="closebrochureiframe" alt="Android Training Companies in Mohali Chandigarh" src="../images/close.png"  onclick="clsifrm()"  /> 
               
          </div>

        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Android Training Companies in Mohali Chandigarh" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Android Training Companies in Mohali Chandigarh" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Android Training Companies in Mohali Chandigarh"/></div>

<%@ Page Title="" Language="VB" MasterPageFile="~/course/MasterPage-course.master" AutoEventWireup="false" CodeFile="mobile-application-development-training-course-in-chandigarh.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>Mobile Application Development Training Course in Chandigarh </title>
    <meta name="description" content="Mobile Application Development Training Course in Chandigarh - ThinkNEXT is best android training institute providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
                <h1>Mobile Application Development Training Course in Chandigarh</h1>
            </div>
      <p>
          In this course students will learn to develop mobile applications across multiple platforms including ios, android and window. After completing this mobile application development course in Chandigarh, you’ll understand how to develop mobile application using as Objective-C (Interface Builder for Apple), Java and Eclipse (for Android) combined with SDK(Software Development Kit) 
      </p>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        ...
        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Mobile App Development Course Training in Chandigarh Mohali" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Mobile App Development Course Training in Chandigarh Mohali" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Mobile App Development Course Training in Chandigarh Mohali"/></div>

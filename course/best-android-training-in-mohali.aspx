<%@ Page Title="" Language="VB" MasterPageFile="~/topics/MasterPage-Topics.master" AutoEventWireup="false" CodeFile="best-android-training-in-mohali.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
        <title>Best Android Training in Mohali - ThinkNEXT</title>
    <meta name="description" content="Best Android Training in Mohali - ThinkNEXT is best android training institute providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image">
        ...
        <img src="../android-images/Android-Training-Course-in-Chandigarh-Mohali-Panchkula.jpg" alt="Best Android Training in Mohali Chadigarh" />
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
                <h1>Best Android Training in Mohali</h1>
             <img src="../android-images/Android-app-development-course-in-panchkula.jpg" width="100%" title="Learn Android Programming" alt="Best Android Training in Mohali Chadigarh" />
            </div>
                       <p>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        <div class="without_border dwl" >
          <div class="brochiframe"  id="brochiframe">
            ...
            <img class="closebrochureiframe" alt="Best Android Training in Mohali Chadigarh" src="../images/close.png"  onclick="clsifrm()"  /> 
               
          </div>

        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Best Android Training in Mohali Chadigarh" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Best Android Training in Mohali Chadigarh" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Best Android Training in Mohali Chadigarh"/></div>

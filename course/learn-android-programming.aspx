<%@ Page Title="" Language="VB" MasterPageFile="~/course/MasterPage-course.master" AutoEventWireup="false" CodeFile="learn-android-programming.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>Learn Android Programming - ThinkNEXT</title>
      <meta name="description" content="Learn Android Programming - ThinkNEXT is best android training institute providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image">
        ...
        <img src="../android-images/Android-Training-Course-in-Chandigarh-Mohali-Panchkula.jpg" alt="Android Training Course in Chandigarh Mohali Panchkula" />
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
             ...
             <img src="../android-images/learn-android-programming.jpg" width="100%" title="Learn Android Programming" alt="Learn Android Programming" />
            </div>
        <p><strong>Android  training</strong> comes out as excitement for the new generation in IT  sector. The demand of Mobile Application is extremely very high in these days. <strong>ThinkNEXT Technologies Private Limited</strong> offers the best <strong>Android training in  Chandigarh, Mohali, and Panchkula.</strong> It also very famed because of the best <strong>Android training institute</strong> in the area.  India and all over the customers deal with the mobile applications. We train  the students which are interested in Android or mobile application. <strong>ThinkNEXT Technologies</strong> train their  students professionally by contributing best training program.</p>
             </div>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        <div class="without_border dwl" >
          <div class="brochiframe"  id="brochiframe">
            ...
            <img class="closebrochureiframe" alt="Learn Adroid Programming" src="../images/close.png"  onclick="clsifrm()"  /> 
               
          </div>

        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Learn Adroid Programming" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Learn Adroid Programming" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Learn Adroid Programming"/></div>

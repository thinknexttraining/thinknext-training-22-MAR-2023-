<%@ Page Title="" Language="VB" MasterPageFile="~/topics/MasterPage-Topics.master" AutoEventWireup="false" CodeFile="android-development-course.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>Android Learning - ThinkNEXT Technologies</title>
   <meta name="description" content="Android Learning - ThinkNEXT is best android training institute providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image">
        ...
        <img src="../android-images/Android-Training-Course-in-Chandigarh-Mohali-Panchkula.jpg" alt="Android Learning" />
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
              ...
              <img src="../android-images/learn-android-programming.jpg" width="100%" title="Android Learning" alt="Android Learning" />
            <br /><br />
                <p>Everyone knows about the word of the computing. <strong>Android</strong> is the most famous platform for the cell phones. <strong>Android</strong> is the platforms that make the million cell phones near about 200 countries or all around the world. Android can carry apps, books, movies, games or digital contents.  The students will learn how to work in an eclipse based environment during their training. So learning Android in these days is not a bad option in the Android era. <strong>ThinkNEXT Technologies Private Limited</strong> is the most repudiated company because of its dedication towards the future of their students. It gives the full opportunities to the students so that they can learn Android easily.</p>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        <div class="without_border dwl" >
          <div class="brochiframe"  id="brochiframe">
            ...
            <img class="closebrochureiframe" alt="Android Learning" src="../images/close.png"  onclick="clsifrm()"  /> 
               
          </div>

        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Android Learning" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Android Learning" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Android Learning"/></div>

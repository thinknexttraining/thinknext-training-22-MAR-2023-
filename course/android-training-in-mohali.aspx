<%@ Page Title="" Language="VB" MasterPageFile="~/topics/MasterPage-Topics.master" AutoEventWireup="false" CodeFile="android-training-in-mohali.aspx.vb" Inherits="topics_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <title>Android Training in Mohali - ThinkNEXT Technologies</title>
    <meta name="description" content="Android Training in Mohali - ThinkNEXT is best android training Company providing Android Training in Chandigarh Mohali Panchkula India. ThinkNEXT is top android company in chandigarh for mobile apps development " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image">
        ...
        <img src="../android-images/Android-Training-Course-in-Chandigarh-Mohali-Panchkula.jpg" alt="Android Training in Mohali" />
    ...
    <div class="page-div">
        ...
        <div class="gdl-header-wrapper">
          ...
          <img src="../android-images/Android-Training-Course-in-Chandigarh.jpg" width="100%" title="Android Training in Mohali" alt="Android Training in Mohali" />
              </div>
                <br /><br />
            
             <p>Android become the best  platform for those who are related to IT professional or for those who want to  switch their jobs. It is the best opportunity for the job seekers too. Well,  this will be possible only when you will start the <strong>Android training course in Chandigarh.</strong> ThinkNEXT presents the best  professional and skilled <strong>based Android  training course in Chandigarh.</strong></p>
 ...
 <div class="col-lg-4 col-md-4"">
    ...
    <div class="right_box margin-top">
        <div class="without_border dwl" >
          <div class="brochiframe"  id="brochiframe">
            ...
            <img class="closebrochureiframe" alt="Android Training in Mohali" src="../images/close.png"  onclick="clsifrm()"  /> 
               
          </div>

        <a title="ThinkNEXT Brochure"  href="../BroucherDownload.aspx?data=Android Broucher" onclick="broucherdownload();"  target="broucher"><img src="../images/download_brochure.png" alt="Android Training in Mohali" border="0"  /> </a>
    ...
    <img src="images/loader.gif" alt="Android Training in Mohali" />
</div>
...
<div class="contt"> 
              ...
              <div class="person-img"><img src="../images/silhouette.png" alt="Android Training in Mohali"/></div>

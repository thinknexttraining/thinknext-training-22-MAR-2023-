<%@ Page Title="AVR Training in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="Avr-training-in-chandigarh.aspx.vb" Inherits="Avr_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="AVR Training in Chandigarh - PIC Embedded Systems Training in Chandigarh Mohali - ThinkNEXT is one of the best IT company providing free 6 months and six weeks Embedded Systems training in Chandigarh Mohali panchkula INIDA. Embedded System Training institute/company in Mohali Chandigarh. " />
    <meta name="keywords" content="AVR Training Companies in Chandigarh, PIC Embedded Systems Training in Chandigarh Mohali, Best Embedded Training institute in Chandigarh, Best Embedded Training institute in Mohali, Best Embedded Training institute in panchkula INDIA, Embedded System Training institute in Chandigarh, Embedded System Training institute in Mohali, Embedded System Training institute in panchkula INIDA, Embedded Systems Basics Institute, Embedded Systems Basics Training Company" />
      <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/images/avr-training-chandigarh.jpg" />
     <meta property="og:image" content="http://www.thinknexttraining.com/images/avr-training-chandigarh.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image">  
         <img class="d-md-none"  src="images/avr-training-chandigarh.jpg" alt="AVR Training in Chandigarh " />

     <img class="d-none d-md-block" src="images/avr-training-chandigarh.jpg" alt="AVR Training in Chandigarh " />
    ...
    <section class="py-4">
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                       <div class="gdl-header-wrapper">
                        <h1>AVR Training in Chandigarh</h1>
                           <p class="text-danger"><strong>AVR Microcontrollers are available in three categories:</strong></p>
                           <ul class="welcomeLinks">
                               <li><strong>TinyAVR </strong>– Less memory, small size, suitable only for simpler applications. Pins 6-32,flash memory 0.5-8 kb</li>
                               <li><strong>MegaAVR </strong> – These are the most popular ones having good amount of memory (upto 256 KB), higher number of inbuilt peripherals and suitable for moderate to complex applications. Pins 28-100</li>
                               <li><strong>XmegaAVR </strong>– Used commercially for complex applications, which require large program memory and high speed. Pins 44-100. Flash memory 16-384 kb</li>
                           </ul>
                           <h2 class="text-danger"><strong>Introduction to Embedded Systems</strong></h2>
                    <ul class="welcomeLinks">
                        <li> History & need of Embedded System</li>
                        <li> Basic components of Embedded System</li>
                        <li> Hardware Classification of Embedded System</li>
                        <li> Programming Language Classification of Embedded System</li>
                    </ul>    
                    </div>
        ...
        <div class="container">
             <h3 class="text-danger"><strong>Embedded Systems Training Certification, Placement and other Activities</strong></h3>
                    <div class="p-2 text-justify position-sticky top-0">
                      <ul class="welcomeLinks">
                        ...
                        <li> Embedded Systems & Robotics Experience Certificate by ThinkNEXT</li>
    ...
    <section class="py-4">
        <div class="container">
             <h3 class="text-danger"><strong>Introduction to AVR Compiler/Simulator</strong></h3>
            <div class="row m-0">
                <div class="col-md-6">
                    <div class="p-2 text-justify position-sticky top-0">
                      <ul class="welcomeLinks">
                ...
                <div class="col-md-6">
                     <ul class="welcomeLinks">
                        ...
                        <li> SPI Protocol</li>
                        <li> I2C Protocol</li>
                        <li> How to configure Watchdog Timers of AVR Microcontroller (ATmega16)</li>
                        <li> How to use inbuilt ADC of AVR microcontroller (ATmega16)</li>
            ...
            <div class="row m-0">
                <div class="col-lg-8 text-justify">
                    <div class="d-inline-block pt-2 ">
                        <br />
                        <h2 class="text-danger"><strong>Classification of Microprocessor & Microcontroller</strong></h2>
                        <br>
                        <ul class="welcomeLinks">

...
Partial Class winter_internship_jackpot_offer
        ...
        If PersonName.Text <> "" Then
            If PersonEmail.Text <> "" Then
                If MobileNo.Text <> "" Then
                    ...
                    cmd.Dispose()
                    con.Close()
                    varclass.SendLeads(MobileNo.Text, PersonName.Text, PersonEmail.Text, PersonCourse.Text, "Winter Internship Jackpot Offer", "https://thinknexttraining.com/lp/winter-internship-jackpot-offer.aspx")
                    PersonName.Text = ""
                    PersonEmail.Text = ""
                    MobileNo.Text = ""
                    PersonCourse.Text = ""

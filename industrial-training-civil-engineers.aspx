<%@ Page Title="Six months Industrial Training for Civil Engineering in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="industrial-training-civil-engineers.aspx.vb" Inherits="industrial_training_civil_engineering_students" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="Civil Engineering Industrial training-in-chandigarh Mohali - ThinkNEXT is best Android Training Company providing Civil Engineering Industrial training-in-chandigarh Mohali Panchkula India. ThinkNEXT " />
    <meta name="keywords" content="Civil Engineering Industrial training-in-chandigarh Mohali, Civil Engineering Industrial training-in-chandigarh, Civil Engineering Industrial training-in-chandigarh, Civil Engineering Industrial training-in-chandigarh, Civil Engineering Industrial training-in-chandigarh, Civil Engineering Industrial training-in-chandigarh, Android App Development Training in panchkula INDIA." />
      <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/share-images/industrial-civil-engineering-training.jpg" />
     <meta property="og:image" content="http://www.thinknexttraining.com/share-images/industrial-civil-engineering-training.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image">  
         <img class="d-md-none"  src="images/industrial-civil-engineering-training.jpg" alt="Civil Engineering Industrial training-in-chandigarh Mohali " />
            
     <img class="d-none d-md-block" src="images/industrial-civil-engineering-training.jpg" alt="Civil Engineering Industrial training-in-chandigarh Mohali" />
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                       <div class="gdl-header-wrapper">
                        <h1>Best Six Months/6 Weeks (45 Days/Summer Training) Industrial Training for Civil Engineering Students in Chandigarh Mohali Panchkula</h1>
                         <p><strong>Civil Engineering </strong>offers with the design, creation and renovation of the physical and clearly constructed environment, inclusive of works such as houses, Institutional homes, bridges, canals, roads, dams, airports, sewerage structures, pipelines, and railways and so forth.</p>
                         <p>Earlier, it was believed that civil engineering is an area where you should work only on the construction site, but at present, you must need software skills as well as on-site knowledge to be ready for the industry. Universities are therefore mandatory for students to obtain Software programs Training as well as on-site training.</p>
                         <p>So to give students a hassle-free opportunity, <strong><a href="https://www.thinknexttraining.com/">ThinkNEXT</a></strong> offer on-site industrial training software for <strong>BE, B.Tech (Civil Engineering), Diploma of Applied Arts</strong>, working professionals and other job seekers in the field of Civil Engineering and Architecture under 6 months, 3 months or 6 Weeks work-oriented training programs</p>
    ...
    <section>
        <div class="container text-justify">
            <p><strong> Are you seeking for best six Months (Software + Industry) Industrial Training or six Weeks (45 days) summer internship training for Civil Engineering Students in Chandigarh Mohali?</strong></p>
                         <p><strong>ThinkNEXT Technologies Private Limited</strong> offers the best summer Internship training opportunity for six months or 6 weeks (45 days) summer training in <strong>civil engineering in Chandigarh Mohali</strong> area to make students ready for industry. To be ready for industry, civil / architectural students must have knowledge of the different software packages used in their industry for design, structural analysis, and project planning and cost estimation.</p>
                         <p>Apart from this, students must undergo industrial training at any construction site to learn how companies actually work. <strong><a href="https://www.thinknexttraining.com/">ThinkNEXT</a></strong> offers both industry and Summer training programs for civil engineering students. In training programs for civil and architectural students, <strong>ThinkNEXT</strong> offers work-oriented programs/courses as follows:</p>
                       <div class="row">
                           <div class="col-6">
                           <ul class="course-img">
                           ...
                           <div class="col-6">
                             <ul class="course-img">
                               <li><a href="3dsmax-training-courses-institute-chandigarh-mohali.aspx">
                                   <img src="images/3dsmax.jpg" alt="3DS MAX" />&ensp; 3Ds MAX</a></li>
                               <li><a href="google-sketchup-training-in-chandigarh.aspx">
                                   <img src="images/Google-sketchup-training-chandigarh.png" alt="Google sketchup training in chandigarh" />&ensp; SketchUp (Formerly Google Sketchup)</a> </li>
                               <li><a href="#">
                                   <img src="images/microsoft-project-training-chandigarh.png" alt="microsoft-project-training-chandigarh" />&ensp; Microsoft Project</a> </li>
                           </ul>
                     </div>
        </div>
    </section>
            ...
            <div class="row m-0">
              <div class="col-lg-8 text-justify">                
                    <div class="d-inline-block pt-2 "><br />
                      <h3 class="fw-bold text-danger">Companies offering internship for Civil Engineering students in Chandigarh Mohali:</h3>
                      <p><strong>ThinkNEXT</strong> has made various tie-ups/collaborations with many companies to make students industry-ready in Chandigarh Mohali such as:</p>
                        <ul class="welcomeLinks">
                            <li>JLPL (Janta Land Promoters Private Limited)</li>
                            <li>TDI Group</li>
                            <li>Bajwa Developers Limited</li>
                            <li>Singla Builders and Promoters (SBP Group)</li>
                            <li>Primary Estates.</li>
                            <li>Bestech Group</li>
                            <li>Aura Builders</li>
                            <li>Shivjot Builders</li>
                            <li>Omaxe Group</li>
                            <li>Gillco Group</li>
                        </ul>
                      <p><strong>ThinkNEXT</strong> also offers Civil or Architectural students stipend based or Free internship or training in various civil companies. So various students can earn while they learn in many civil companies.</p>
                        ...
                        <div class="row m-0">
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-thumb.jpg" alt="Industrial Training in Chandigarh">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-award-thumb.jpg" alt="Industrial Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                               ...
                               <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                                ...
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-yugmarg.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-yugmarg-thumb.jpg" alt="Free online internship">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                                ...
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-honor-thumb.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-honor-thumb.jpg" alt="Free online internship">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                               ...
                               <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award-chd.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-chd-thumb.jpg" alt="Free online internship">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                             ...
                             <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-mohali.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-mohali-thumb.jpg" alt="Free online internship">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" alt="Free online internship">
                                </a>
                            </div>
                        </div>
...
<li>Civil Engineering Industrial Training from 6 Times National Level Award Winner Company:</li>
...
<li>Civil Engineering Industrial Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>Civil Engineering Industrial Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Best Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month Civil Engineering Industrial training-in-chandigarh Mohali" title="6 Month Civil Engineering Industrial training-in-chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="Civil Engineering Industrial training-in-chandigarh" title="Civil Engineering Industrial training-in-chandigarh" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

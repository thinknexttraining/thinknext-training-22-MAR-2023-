<%@ Page Title="iPhone training in Chandigarh" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="iphone-training-in-chandigarh.aspx.vb" Inherits="iphone_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<meta name="description" content="ThinkNEXT is one of the best IT company providing free 6 months and six weeks iPHONE training in Chandigarh, Mohali. Visit us for iPHONE, PHP, JAVA, Web Designing, .net, Networking and Android." />
<meta name="keywords" content="PHP, JAVA, Web Designing, iPHONE, dot net, Android, networking" />
<link rel="image_src" href="https://www.thinknexttraining.com/images/iphone-training-in-chandigarh-min.jpg"/>
<meta property="og:image" content="https://www.thinknexttraining.com/images/iphone-training-in-chandigarh-min.jpg" />
...
<link rel="canonical" href="https://www.thinknexttraining.com/iphone-training-in-chandigarh.aspx" /> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-image position-relative">
        ...
        <img class="d-md-none" src="images/iphone-training-in-chandigarh-min.jpg" alt="iPhone Training in Chandigarh">
        <img class="d-none d-md-block" src="images/iphone-training-in-chandigarh-min.jpg" alt="iPhone Training in Chandigarh">
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                        <div class="gdl-header-wrapper">
                            ...
                            <h1>Best iPhone Developer Training in Chandigarh Mohali Panchkula</h1>
                            <ul class="welcomeLinks">
                              <li> Free Spoken English, Personality Development and Interview Preparation classes on daily basis.</li>
                                ...
                                <li>iPhone Experience Certificate by ThinkNEXT</li>
                                ...
                                <li>One-to-one Project and Project will be made Live and to make it Live, ThinkNEXT will provide free Apple itunes Connect (Apple App Store) for iPhone Apps worth Rs. $100.</li>
                            </ul>
          ...
          <div class="container">
            <div class="row m-0">
              <div class="col-lg-8 text-justify">                
                    <h3 class="text-warning">iPhone Training Certification, Placement and other Activities</h3>
                  <div>
                      ...
                      <h3 class="text-warning">SAP Crystal Reports</h3>
                      <h3 class="text-warning">Project Work</h3>
                  </div>
                  <div class="d-none">
    ...
    <section class="py-4">
        <div class="container">
            <div class="text-center bg-0f54bb py-2">
                <h3 class="text-white mb-0 content"><strong>iPhone Industrial Training - Course contents</strong> </h3>
            </div>
            <br>
            <div class="row">
                <div class="col-lg-6 col-md-6 mt-3 text-justify">

                    <strong class="textred">Overviwe</strong>

                    <ul class="welcomeLinks">
                        <li>iPhone OS Overview</li>
                        <li>iPhone OS Technologies</li>
                        <li>Objective-C Introduction</li>
                        <li>How to install Mac OS</li>
                        <li>First Program in Objective -C , Data Types</li>
                        <li>Operators, Constant Values</li>
                        <li>Condition Statements in Obj-C</li>
                        <li>Switch Statement</li>
                        <li>Loops (For and While)</li>
                        <li>Classes in Objective -C (Introduction)</li>
                        <li>Declaring an Obj-C Class Imp, Adding Instance Variables</li>
                        <li>Class Methods and Instance Methods</li>
                        <li>Data Encapsulation: Synthesize accessor Methods</li>
                        <li>Dot Notations</li>
                        <li>Access Modifiers</li>
                        <li>Inheritance</li>
                        <li>Indirection and Objects</li>
                        <li>Dynamic Binding</li>
                        <li>Functions and String Function</li>
                        <li>Categories</li>
                        <li>Protocols</li>
                        <li>Revision</li>
                        <li>Test- ObjectiveC</li>
                    </ul>

                </div>

                <div class="col-lg-6 col-md-6 mt-3 text-justify">
                    <strong class="textred">xcode</strong>
                    <ul class="welcomeLinks">
                        <li>Overview of XCode and Development Environmen</li>
                        <li>Overview of iPhone SDK (components: Xcode, Simulator, Interface Builder, Instruments), Architecture, Applications</li>
                        <li>Interface Builder: Windows, Views, ViewController Overviews, First Hello Application</li>
                        <li>Alertview, Outlet, Actions with Viewcontroller</li>
                        <li>Add ViewController Class Manually</li>
                        <li>Window Based and View Based Manually</li>
                        <li>UIView, UITextView, Textview in ViewController Class, Font Color in Text View</li>
                        <li>Common Controls : Label, TextField and Button with IB as well as coding</li>
                        <li>Alert & Action sheet and Event Handling</li>
                        <li>ImageView</li>
                        <li>Page Control</li>
                        <li>Switch Views, MultiViews</li>
                        <li>Switch View in Animations</li>
                        <li>Segmented Control</li>
                        <li>Progress Bar and Activity Indicator</li>
                        <li>Pickers</li>
                        <li>Date Pickers</li>
                        <li>Keyboard Inputs</li>
                        <li>Screen Rotations</li>
                        <li>Tab Bars</li>
                        <li>Search Control, Web View (All Pending Controls)</li>
                        <li> Combined Example of all above Controls</li>
                        <li>Revision</li>
                    </ul>
                ...
                <div class="col-lg-6 col-md-6 mt-3 text-justify">
                      <strong class="textred">XcodeCont.. Core Data and Localization</strong>
                    
                    <ul class="welcomeLinks">
                        <li>Where am I? Finding your location with Core Locations</li>
                        <li>Device Features – Accelerometer</li>
                        <li>Core Data : Connectivity , add , Insert, Update the Data</li>
                        <li>XML – Read and Write, XML Parsing, Lib XML</li>
                        <li>Web Services</li>
                        <li>iAd</li>
                        <li>iCalendar</li>
                        <li>Multitasking: Local Notifications</li>
                        <li>Audio and Video Streaming</li>
                        <li>Record Audio and Video</li>
                        <li>Overview of Android and Blackberry</li>
                        <li>Test- Xcode (Till Covered)</li>
                    </ul>
                </div>

                <div class="col-lg-6 col-md-6 mt-3 text-justify">
                      <strong class="textred">XcodeCont.. File Handling</strong>
                    
                    <ul class="welcomeLinks">
                        <li>File Handling</li>
                        <li>Persistence</li>
                        <li>NSUserDefault, NSTimer, Animation with Timer and Images</li>
                        <li>UITouch and MultiTouch :Tap, Touches and Gestures</li>
                        <li>Drawing with Quartz2D and Open GLv</li>
                        <li>Sending E-Mails and SMS</li>
                        <li> Access PhotoLibrary Store the Images in the databases: Image Pickerv</li>
                        <li>Access Camera</li>
                        <li>Access Address Book – Add, Remove and save</li>
                        <li>WebView</li>
                        <li>Revision</li>
                        <li>Test- Xcode (Till Covered)</li>
                    </ul>
                    </div>
                   <strong class=" col-12 textred">XCodeCont.. SQLite, PList</strong>
                    <div class="col-lg-6 col-md-6 mt-3 text-justify">
                   

                    <ul class="welcomeLinks">
                        <li>Table View (Simple...)</li>
                        <li>Table View (Complex...)</li>
                        <li>PList (Simple and Complex Both)</li>
                        <li>Table View With PList</li>
                        <li>Navigation Control Template</li>
                        <li>Navigation With Table View</li>
                        <li>Example of Navigation Controller with Table View</li>
                        <li>All Other Controls by Code</li>
                        <li>Revision</li>
                        <li>SqliteOverview(DBMS, Difference with other Databases...)</li>
                        <li>DDL , DML Statements</li>
                        <li>Operators, Select Statements</li>
                    </ul>
                </div>
                 ...
                 <div class="col-lg-6 col-md-6 mt-3 text-justify">
                    ...
                    <ul class="welcomeLinks">
                        ...
                        <li>Triggers</li>
                        <li>Functions</li>
                        <li>Application Preferences – Loading Setting Values, Saving</li>
                        <li>Database Storage Using Sqlite3: Database Created, Table Creation, Inserting, Updating...</li>
                        <li>Revision</li>
                        <li>Test- SQLite, Xcode (Till Covered)</li>
                    </ul>
                </div>
    ...
    <section class="py-4 ">
        <div class="container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-justify">
                <ul class="welcomeLinks">
                    <li>iphone training from 6 Times National Level Award Winner Company</li>
                    ...
                    <li>iphone training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
                    ...
                    <li>iphone training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
                    ...
                    <li>iphone training from 11+ Years old company</li>

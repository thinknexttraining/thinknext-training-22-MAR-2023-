<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="RegisterForScholar.aspx.vb" Inherits="RegisterForScholar" title="Register For Scholar" %>
     ...
     <table style="width: 100%">
        <tr>
            ...
            <td style="width: 695px; text-align: center">
                    <asp:Label ID="lblMsg0" runat="server" ForeColor="Red" 
                        Text="Get Students Detail whom applied for Industrial Training" 
                        style="color: #0000CD"></asp:Label>
                </td>
            <td>
                &nbsp;</td>
        </tr>
            ...
            <tr>
               ...
               <asp:GridView ID="GridView1" runat="server" Width="781px" 
                   style="font-size: small; text-align: center" CellPadding="4" Height="16px" 
                     ...
                     <Columns>
                         <asp:BoundField />
                         <asp:BoundField DataField="comment" HeaderText="ModeofEnquiry" />
                         <asp:BoundField DataField="AdmissionDate" HeaderText="AdmissionDate" />
                         <asp:BoundField DataField="Course" HeaderText="Course" />
                         <asp:BoundField DataField="Duration" HeaderText="Duration" />
                         <asp:BoundField DataField="StudentName" HeaderText="StudentName" />
                         <asp:BoundField DataField="StudentMobileNo" HeaderText="StudentMobileNo" />

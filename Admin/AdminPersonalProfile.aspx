<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AdminPersonalProfile.aspx.cs" Inherits="Admin_AdminPersonalProfile" Title="Personal Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <script type="text/javascript" language="JavaScript">
    ...
    <div id="xcxcxcxc" style="height: 445px; width: 837px; margin-right: 0px;">
    ...
    <tr>
        <td style="height: auto;" align="center" valign="top">
                <asp:Panel ID="Panel3" runat="server" Height="290px" Width="831px">
                    <table style="width: 810px; height: 265px;" cellpadding="0" cellspacing="0">
                        <tr style="background-color: #F7F6F3;">
                            ...
                            <td align="center" colspan="5" class="style1">
                                <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
                                 style="text-decoration:none; "   ForeColor="Blue" onclick="LinkButton1_Click">Update Profile</asp:LinkButton>
                                </td>
                        </tr>
                        <tr>
                        ...
                        <tr style="background-color: #F7F6F3;">
                            ...
                            <td align="left" style="height: 8px; width: 8705px;" colspan="2">
                                &nbsp;</td>
                            <td align="left" style="height: 8px; width: 9254px;">
                                <asp:Label ID="lblDepartment" runat="server" Font-Size="Small" 
                                    SkinID="MytextID" Text="Department"></asp:Label>
                            </td>
                            <td align="left" colspan="2" style="height: 8px; ">
                                <asp:TextBox ID="txtDepartment" runat="server" BorderStyle="None" 
                        ...
                        <tr>
                            ...
                            <td align="left" style="height: 8px; width: 8705px; font-size: small;" 
                                colspan="2">
                                &nbsp;</td>
                            <td align="left" style="height: 8px; width: 9254px; font-size: small;">
                                D.O.B</td>
                            <td align="left" colspan="2" style="height: 8px; ">
                                <asp:TextBox ID="txtDob1" runat="server" BorderStyle="None" Height="14px" 
                        ...
                        <tr style="background-color: #F7F6F3;">
                            ...
                            <td align="left" style="height: 8px; width: 118px;">
                                <asp:TextBox ID="txtMobileNo" runat="server" BorderColor="Black" 
                                    ...
                                    Width="110px" Enabled="False" ReadOnly="True"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td align="left" style="width: 21062px; height: 8px;">
                                &nbsp;</td>
                            <td align="left" style="height: 8px; width: 74324px;">
                                <asp:Label ID="lblDateOfJoining" runat="server" Font-Size="Small" 
                                    SkinID="MytextID" Text="Date Of Joining"></asp:Label>
                            </td>
                            <td align="left" colspan="2" style="height: 8px; ">
                                <asp:TextBox ID="xtDateOfJoining" runat="server" BorderStyle="None" 
                                    Height="14px" ReadOnly="True" SkinID="MytextID" 
                                    style="font-size: x-small; margin-top: 0px; color: #000099; font-weight: 700; background-color: #FFFFFF;" 
                                    Width="207px"></asp:TextBox>
                                <cc1:CalendarExtender ID="xtDateOfJoining_CalendarExtender" runat="server" 
                                    Enabled="True" Format="dd/MM/yyyy" TargetControlID="xtDateOfJoining" 
                        ...
                        <tr>
                            ...
                            <td align="left" style="height: 8px; width: 74324px;">
                                <asp:Label ID="lblPANNo" runat="server" Font-Size="Small" SkinID="MytextID" 
                                    Text="PAN No."></asp:Label>
                            </td>
                            <td align="left" colspan="2" style="height: 8px; ">
                                <asp:TextBox ID="txtPANNo" runat="server" AutoCompleteType="Disabled" 
                                    BorderStyle="None" Height="14px" ReadOnly="True" SkinID="MytextID" 
                                    style="font-size: x-small; color: #000099; font-weight: 700;background-color: #FFFFFF;" Width="207px"></asp:TextBox>
                            </td>
                            <td align="left" style="height: 8px; " colspan="2">
                                &nbsp;</td>
                            <td align="left" style="height: 8px; ">
                                <asp:Label ID="lblDOB" runat="server" Font-Size="Small" SkinID="MytextID" 
                                    Text="Bank Name"></asp:Label>
                            </td>
                            <td align="left" colspan="2" style="height: 8px; ">
                                <asp:TextBox ID="txtBank" runat="server" BorderStyle="None" Height="14px" 
                                    ReadOnly="True" style="font-size: x-small; color: #000099; font-weight: 700; background-color: #FFFFFF;" 
                                    Width="184px"></asp:TextBox>
                            </td>
                            <td align="left" style="height: 8px; ">
                                &nbsp;</td>
                        ...
                        <tr style="background-color: #F7F6F3;">
                            ...
                            <td align="left" style="height: 7px; ">
                                <asp:Label ID="lblAccountNo" runat="server" Font-Size="Small" SkinID="MytextID" 
                                    Text="Bank Account No."></asp:Label>
                            </td>
                            <td align="left" colspan="2" style="height: 7px;">
                                <asp:TextBox ID="txtAccountNo" runat="server" BorderStyle="None" Height="14px" 
                                    ReadOnly="True" SkinID="MytextID" 
                                    style="font-size: x-small; color: #000099; font-weight: 700; background-color: #F7F6F3;" 
                                    Width="207px"></asp:TextBox>
                            </td>
                            <td align="left" style=" height: 7px;" colspan="2">
                                &nbsp;</td>
                            <td align="left" style=" height: 7px;">
                                <asp:Label ID="lblLocked" runat="server" Font-Size="Small" SkinID="MytextID" 
                                    Text="Locked"></asp:Label>
                            </td>
                            <td align="left" colspan="2" style="height: 7px;">
                                <asp:TextBox ID="txtLocked" runat="server" BorderStyle="None" Font-Size="Small" 
                                    Height="14px" ReadOnly="True" SkinID="MytextID" 
                                    style="font-size: x-small; color: #000099; font-weight: 700; background-color: #F7F6F3;" 
                                    Width="184px"></asp:TextBox>
                            </td>
...
<div id="clrs" style="height: 2px; clear: both"></div>
  ...
  <div id="selectemails" runat="server"  
        ...
        <div id="inner" 
            ...
            <div id="uploader" 
                ...
                <br /><br />
                <asp:Button ID="btnUpload" runat="server" Text="Upload" Width="90px" Height="24px" OnClick="btnUpload_Click" />
                <br /><br />

...
Partial Class Admin_DisplayOnlineRegistration
    Inherits System.Web.UI.Page
    Function GetDiscountConnection1() As String
        Dim constr As String
        constr = " Data Source=103.21.58.193;Initial Catalog=dbthinknex;Persist Security Info=True;User ID=thinknex;Password=techsmart?;"
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        'varDate1 = CDate(txtDateFrom.Text)
        'varDate2 = CDate(txtDateTo.Text)
        ...
        cmd.CommandText = "Select ModeOfEnquiry,convert(varchar(10), AdmissionDate,101)as AdmissionDate,Course, Duration,StudentName,StudentMobileNo,EmailID,CollegeName,WhatsAppNo  from Admissions where AdmissionDate Between '" & txtDateFrom.Text & "' and '" & txtDateTo.Text & "'and  Comment not in('Register for scholarship') and FranchiseCode='" + txtfranchise.Text + "'"


        'cmd.CommandText = "Select ModeOfEnquiry, AdmissionDate,Training, TrainingBatch,StudentName,StudentMobileNo,EmailID,CollegeName  from Admissions where AdmissionDate Between " & "@DateFrom" & " And " & "@DateTo" & " and Training in('.NET','Java','Android','iPhone','/MySQL','Web Designing','Hardware &amp; Networking' ,'CCNA','MCITP','Embedded Systems','AutoCAD','Online Bidding','Oracle/SQL Server','Software Testing','C/C++','SEO') and Comment not in('Register for scholarship') and FranchiseCode='" + txtfranchise.Text + "'"
        'cmd.Parameters.AddWithValue("@DateFrom", Format(varDate1, "MM/dd/yyyy"))
        'cmd.Parameters.AddWithValue("@DateTo", Format(varDate2, "MM/dd/yyyy"))
        ...
        If ds.Tables("Admissions").Rows.Count > 0 Then
            lblRec.Text = "Record Found : " & ds.Tables("Admissions").Rows.Count

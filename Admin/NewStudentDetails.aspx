<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="NewStudentDetails.aspx.cs" Inherits="Admin_NewStudentDetails"  EnableEventValidation ="false" %>
...
<td class="auto-style14">
   ...
   <td class="auto-style9"><asp:Button ID="btnsubmit" runat="server" Text="Display" CssClass="Allbuttons" 
       ...
       <asp:Button ID="Btnexpdisp" runat="server" Text="Export display" Width="91px" OnClick="Btnexpdisp_Click" />
    </td>
...
<tr><td class="auto-style13">
 ...
 <div id="details" style="width: 100%; height: 534px; text-align: center; vertical-align: top; margin-top: 10px"> 
                       ...
                       <asp:TemplateField>
                           <ItemTemplate>
                              ...
                              <td class="tdstyle"><strong>Admission Date :</strong></td> <td class="tdstyle"><%# Eval("AdmissionDate") %></td>
                                   ...
                                   <td class="tdstyle"><strong>Enquiry No :</strong></td> <td class="tdstyle"><a href="NewFollowupDetails.aspx?enquiry=<%# Eval("EnquiryNo") %>" target="admin101" onclick="openss()" ><%# Eval("EnquiryNo") %></a></td>
    ...
    <div id="Div1" 
          ...
          style="width: 100%; height: 534px; text-align: center; vertical-align: top;    margin-top: -60%;"> 
...
<tr>
  ...
  <asp:CalendarExtender ID="cal" TargetControlID ="txtnextfollowupdate" runat ="server" ></asp:CalendarExtender></td>
               ...
               <asp:GridView ID="Gridexport" AutoGenerateColumns="false" runat="server">
                   <Columns>
                       <asp:TemplateField  HeaderText="AdmissionDate" >
                          <ItemTemplate>
                              <asp:Label ID="Label2" runat="server" Text='<%# Eval("AdmissionDate") %>' ></asp:Label>
                          </ItemTemplate> 
                       </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="CollegeName">
                           <ItemTemplate>
                               <asp:Label ID="Label4" runat="server" Text='<%#Eval("CollegeName") %>'></asp:Label>
                           </ItemTemplate>
                       </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="StudentMobileNo">
                           <ItemTemplate>
                               <asp:Label ID="Label7" runat="server" Text='<%#Eval("StudentMobileNo") %>'></asp:Label>
                           </ItemTemplate>
                       </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="ModeOfEnquiry">
                           <ItemTemplate>
                               <asp:Label ID="Label11" runat="server" Text='<%#Eval("ModeOfEnquiry") %>'></asp:Label>
                           </ItemTemplate>
                       </asp:TemplateField>
                   </Columns>
               </asp:GridView>

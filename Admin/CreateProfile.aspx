<%@ Page Title="Create Profile" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="~/Admin/CreateProfile.aspx.vb" Inherits="Admin_CreateProfile"%>
   ...
   <h3> 
      ...
      <div id="profile" style="width: 100%; height: 396px">
        ...
        <p style="height: 35px"> 
            ...
            <asp:Button ID="btnSaveUpdate" runat="server" CssClass="Allbuttons" 
                Text="Update Profile"  Width="120px" Visible="false"/>
          </p>

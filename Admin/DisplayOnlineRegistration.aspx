<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false" CodeFile="DisplayOnlineRegistration.aspx.vb" Inherits="Admin_DisplayOnlineRegistration" title="Online Registration" %>
            ...
            <tr>
                ...
                <td style="width: 191px">
                    <asp:TextBox ID="txtDateTo" runat="server" Width="181px" style="height: 16px"></asp:TextBox>
                     ...
                     <cc1:CalendarExtender ID="txtDateTo_CalendarExtender0" runat="server" 

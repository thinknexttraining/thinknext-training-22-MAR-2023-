<%@ Page Title="Catia Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="catia-online-course.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="Catia Online Course  - ThinkNEXT is one of the best Training company providing 6 months and six weeks Catia Training Online" />
    <meta name="keywords" content="Catia Online Course, free online catia course with certificate, catia online training, online catia course, catia course near me, learn catia online " />
    <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/share-images/catia-course-chandigarh.jpg" />
    <meta property="og:image" content="http://www.thinknexttraining.com/share-images/catia-course-chandigarh.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>Catia Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become Catia Expert and Boost your Career. Enroll Now </strong></p>
                <br />
                        ...
                        <table class="table2" id="tb1">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="input" placeholder="Catia Online Training" ReadOnly="true"></asp:TextBox>
                                <tr>
                                </tr>
                            <tr>
                                <td>
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-6 text-justify">
                <p><strong>1: INTRODUCTION TO CATIA</strong></p>
                ...
                <p><strong>2: DRAWING SKETCHES IN THE SKETCHER WORKBENCH-I</strong></p>
                <ul class="welcomeLinks">
                ...
                <p><strong>3: DRAWING SKETCHES IN THE SKETCHER WORKBENCH-II</strong></p>
                <ul class="welcomeLinks">
                    ...
                    <li>Deleting Sketched Elements<strong></strong> </li>
                </ul>

            </div>

            <div class="col-lg-6 text-justify">
                <p><strong>4: CONSTRAINING SKETCHES AND CREATING BASE FEATURES</strong></p>
                <ul class="welcomeLinks">
                ...
                <p><strong>5: REFERENCE ELEMENTS AND SKETCH-BASED FEATURES</strong></p>
                <ul class="welcomeLinks">
                ...
                <p><strong>6: CREATING DRESS-UP AND HOLE FEATURES</strong></p>
                <ul class="welcomeLinks">
                ...
                <p><strong>7: EDITING FEATURES</strong></p>
                <ul class="welcomeLinks">
                ...
                <p><strong>8: TRANSFORMATION FEATURES AND ADVANCED MODELing TOOLS-I</strong></p>
                <ul class="welcomeLinks">
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/catia-online-course.aspx"
        });
    </script>
    <script>

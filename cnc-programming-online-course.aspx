<%@ Page Title="CNC Programming Online Course - ThinkNEXT" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="cnc-programming-online-course.aspx.vb" Inherits="networking_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="description" content="CNC Programming Online Course  - ThinkNEXT is one of the best Training company providing 6 months and six weeks CNC Programming Training Online" />
    <meta name="keywords" content="CNC Programming Online Course, CNC Programming Online training  " />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="pd-30" style="background-image: url('images/technology-blue-background.jpg'); background-size: cover;">
        <div class="container">
            <div class="col-lg-7 col-md-7 col-sm-6 text-justify ptb-20">
                ...
                <h2 class="fa-5x text-white main-head text-left"><strong>CNC Programming Online Course</strong></h2>
                <div style="border: 3px solid orange;"></div>
                <br />
                <p class="text-white"><strong>Become CNC Programming Expert and Boost your Career. Enroll Now </strong></p>
                <br />
                        ...
                        <table class="table2" id="tb1">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="input" placeholder="CNC Programming Online Training" ReadOnly="true"></asp:TextBox>
                                <tr>
                                </tr>
                            <tr>
                                <td>
    ...
    <section class="pd-30">
        <div class="container">
            ...
            <div class="col-lg-7 text-justify">
                ...
                <br />
                <p><strong>CNC  Machine Setter. </strong></p>
                <ul class="welcomeLinks">
                ...
                <p><strong>CNC Milling/Turning </strong></p>
                <ul class="welcomeLinks">
            ...
            <div class="col-lg-5 text-justify">
                <p><strong>CNC Programmer. </strong></p>
                <ul class="welcomeLinks">
                ...
                <br />
                <p><strong>Turning Operation </strong></p>
                <ul class="welcomeLinks">
                ...
                <br />
                <p><strong>Milling Operation </strong></p>
                <ul class="welcomeLinks">
                    <li>Face Milling </li>
                    <li>Plain Milling </li>
    ...
    <script>
        $("body").floatingSocialShare({
            ...
            url: "http://www.thinknexttraining.com/cnc-programming-online-course.aspx"
        });
    </script>
    <script>

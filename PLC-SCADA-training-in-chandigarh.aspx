<%@ Page Title="PLC SCADA Training Chandigarh Mohali" Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="PLC-SCADA-training-in-chandigarh.aspx.vb" Inherits="plc_scada_training_in_chandigarh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   
    <meta name="description" content="PLC SCADA Training Course Institue in Chandigarh Mohali - ThinkNEXT is best Android Training Company providing PLC SCADA Training in Chandigarh Mohali Panchkula India. ThinkNEXT " />
    <meta name="keywords" content="PLC SCADA Training Course Institue in Chandigarh" />
      <!-- Facebook sharing image show  -->
    <link rel="image_src" href="http://www.thinknexttraining.com/images/plc-scada-training-in-chandigarh-mob.jpg" />
     <meta property="og:image" content="http://www.thinknexttraining.com/images/plc-scada-training-in-chandigarh-mob.jpg" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="main-image">
         <img class="d-md-none"  src="images/plc-scada-training-in-chandigarh-mob.jpg" alt="PLC SCADA Training in Chandigarh" />            
     <img class="d-none d-md-block" src="images/plc-scada-training-in-chandigarh.jpg" alt="PLC SCADA Training in Chandigarh" />
                ...
                <div class="col-md-7">
                    <div class="p-2 border text-justify position-sticky top-0">
                        <div class="gdl-header-wrapper">
                            <h1>Best PLC/SCADA Training in Chandigarh Mohali Panchkula </h1>
                        </div>
                        <p>ThinkNEXT provides comprehensive course covers the essentials of SCADA and PLC systems, which are often used in close association with each other. A selection of case studies are used to illustrate the key concepts with examples of real world working SCADA and PLC systems in the water, electrical and processing industries.  </p>
                        <p>This course will be an excellent opportunity to network with your peers, as well as to gain significant new information and techniques for your next SCADA / PLC project. Although the emphasis of the course will be on practical industry topics highlighting recent developments, using case studies, the latest application of SCADA, PLC technologies and fundamentals will be covered.</p>
                    </div>
          ...
          <div class="container">
            <div class="row m-0">
              <div class="col-lg-6 ">                
                  ...
                  <div class="col-lg-6 text-justify d-md-none">
    ...
    <section class="bg-ececec py-4">
        <div class="container">
            <div>
                <h3 class="bg-0f54bb p-3 text-center text-white"><strong>PLC/SCADA Industrial Training - Course Contents</strong></h3>
            </div>
            
            <div class="row">
                 <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 1:PLC Introduction</h4>
                  

                    <ul class="welcomeLinks">
<li>WHAT IS A PLC?</li>
<li> THE PURPOSE OF PLC</li>
<li> HISTORY OF PLC</li>
<li> RECENT DEVELOPMENTS.</li>
<li> TYPES OF PLC</li>
<li> PLC MANUFACTURE COMPANY</li>
<li> DIFFERENCE BETWEEN PLC & RELAY</li>
</ul>
                ...
                <h4 class="mt-3 text-danger fw-bold">Module 2:PLC Structure</h4>

                    <ul class="welcomeLinks">
                    

<li>BLOCK DIAGRAM OF PLC.</li>
<li> CPU</li>
<li> MEMORY</li>
<li> RAM</li>
<li> ROM</li>
<li> POWER SUPPLY</li>
<li> PROGRAMMING DEVICES</li>
<li> FIRMWARE</li>
</ul>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 3:Input/Output System</h4>
                  

                    <ul class="welcomeLinks">

<li>INPUT MODULE AND TYPE</li>
<li> OUTPUT MODULE AND TYPE</li>
<li> INPUT TYPES THAT CAN BE CONNECTED</li>
<li> OUTPUT TYPES THAT CAN BE CONNECTED</li>
<li> FUNCTIONS OF MODULES.</li>
<li> CIRCUIT ISOLATION IN PLC.</li>
<li> PLC WIRING.</li>
</ul>
                ...
                <h4 class="mt-3 text-danger fw-bold">Module 4:Basic Concept of Operation</h4>

                    <ul class="welcomeLinks">
                    

<li>HOW PLC OPERATES.</li>
<li> SCAN CYCLE.</li>
<li> SCAN TIME.</li>
<li> SCAN DIAGRAM.</li>
<li> INPUT SCAN</li>
...
<li> OUTPUT SCAN</li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 5:Programming Languages</h4>
...
<li> SEQUENTIAL FUNCTION CHART</li>
                ...
                <h4 class="mt-3 text-danger fw-bold">Module 6:Selection of PLC</h4>

                    <ul class="welcomeLinks">
                    
<li>INPUT & OUTPUT REQUIREMENTS</li>
<li> TYPE OF INPUT & OUTPUT REQUIREMENTS</li>
<li> MEMORY CAPICITY</li>
<li> INSTRUCTION SET SUPPORTED</li>
<li> PLC INPUT AND OUTPUT CIRCUITS</li>
<li> PLC’S INPUT & OUTPUT WIRING</li>
<li> PLC’S FORMS OF INPUT & OUTPUT TYPES</li>
</ul>
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 7:Basic Concepts of Programming</h4>
                  

                    <ul class="welcomeLinks">
<li>PLC HARDWARE DESCRIPTION</li>
<li> PLC HARDWARE & SOFTWARE RELATION</li>
<li> PLC BASIC PROGRAMMING CONCEPT</li>
<li> PLC – RELAY RELATIONSHIP WITH PROGRAM</li>
<li> PLC INSTRUCTIONS</li>
<li> NO & NC CONTACT</li>
<li> O/P CONTACT</li>
<li> LATCH – UNLATCH (SET – RESET)</li>
</ul>
                ...
                <h4 class="mt-3 text-danger fw-bold">Module 8:Advance Concepts of Programming</h4>
...
<li> ARITHMETICAL & LOGICAL INSTRUCTIONS</li>
</ul>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 9:SCADA</h4>
                  

                    <ul class="welcomeLinks">


<li>INTRODUCTION TO SCADA</li>
<li> INTRODUCTION ABOUT SCADA SOFTWARE</li>
<li> INTRODUCTION ABOUT SCADA SOFTWARE</li>
<li> INTRODUCTION TO TAGS</li>
<li> ATTACHING CONTROL TO GRAPHIC OBJECTS</li>
<li> ALARMS</li>
<li> RECIPE MANAGEMENT</li>
<li> REAL TIME AND HISTORICAL TRENDING</li>
<li> EVENTS</li>
<li> DERIVED TAGS</li>
...
<li> PAGE JUMP</li>
<li> AUTOMATIC SLIDER</li>
<li> AUTOMATIC PAGE JUMP</li>
<li> SECURITY (LOGIN & LOGOUT)</li>
<li> COMMUNICATION WITH PLC</li>
<li> DIRECT DRIVER COMMUNICATION</li>
<li> DDE SERVER COMMUNICATION</li>
<li> OPC SERVER COMMUNICATION</li>
<li> COMMUNICATION WITH MICROSOFT EXCEL</li>
<li> DIFFERENCE BETWEEN SCADA & HMI</li>
</ul>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 10:HMI</h4>
                  

                    <ul class="welcomeLinks">

<li>INTRODUCTION ABOUT HMI</li>
<li>  USE & BENEFITS OF HMI</li>
<li>  TYPES OF HMI</li>
<li>  INTRODUCTION ABOUT HMI SOFTWARE</li>
...
<li>  CREATING ALARMS</li>
<li>  SECURITY (LOGIN & LOGOUT)</li>
<li>  BOOT PAGE (WELCOME PAGE)</li>
<li>  DOWNLOADING/UPLOADING PROGRAM</li>
<li>  COMMUNICATION WITH PLC</li>
<li>  DIFFERENCE BETWEEN SCADA AND HMI</li>
<li>  FAULT FINDING</li>
</ul>
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 11:DRIVES</h4>
                  

                    <ul class="welcomeLinks">

<li>INTRODUCTION TO DRIVES</li>
<li>  INTRODUCTION TO AC DRIVE & APPLICATIONS</li>
<li>  AC MOTOR & OPERATIONS</li>
<li>  DC MOTOR & OPERATIONS</li>
<li>  MOTOR STARTERS – DOL, STAR-DELTA</li>
<li>  BENEFITS OF AC DRIVES OVER CONVENTIONAL STARTERS (DOL & STAR/DELTA)</li>
<li>  CRITERIA FOR DRIVE SELECTION</li>
<li>  PARAMETER PROGRAMMING</li>
</ul>
...
<li>  ENERGY SAVING CONCEPT</li>
<li> LIVE DEMONSTRATION OF EFFECT OF EACH PROGRAMMED PARAMETER ON DRIVE</li>
<li>  DESIGNING OF DRIVE CONTROL PANEL</li>
<li>  COMMUNICATION OF DRIVE WITH PLC,HMI & SCADA</li>
<li>  FAULT FINDING/TROUBLESHOOTING</li>
<li>  SOFT STARTER THEIR ADVANTAGES OVER CONVENTIONAL STARTERS</li>
<li>  PROGRAMMING OF DRIVE WITH PC</li>
</ul>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 12:WIRING & PANEL DESIGNING</h4>
...
<li>  PLC WIRING</li>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 13:AUTO CAD 2D</h4>
                  

                    <ul class="welcomeLinks">

<li>INTRODUCTION TO AUTO CAD, CO-ORDINATE SYSTEMS</li>
<li>  PRACTICE OF CO-ORDINATES</li>
<li>  LINE COMMAND, ERASE</li>
<li>  SPLINE, REVISION CLOUD, X-LINE</li>
<li>  RECTANGLE, CIRCLE, POLYGON, FILLET, CHAMFER</li>
<li>  ELLIPSE, ARC, POLYLINE, EDIT</li>
<li>  MOVE, COPY, OFFSET, ROTATE</li>
</ul>
...
<li>  MOVE, COPY, OFFSET, ROTATE</li>
<li>  ARRAY, SCALE, STRETCH</li>
<li>  HATCH, LINETYPES</li>
<li>  DIMENSION</li>
<li>  TEXT, EDITING TEXT</li>
<li>  BREAK, MEASURE, DIVED, LENGTHEN, AREA,GROUP, JOIN</li>
</ul>
                </div>

                <div class="col-lg-6 col-md-6 col-sm-6 mt-3 text-justify">
 <h4 class="mt-3 text-danger fw-bold">Module 14:AUTOCAD 3D</h4>
                  

                    <ul class="welcomeLinks">
<li>INTRODUCTION TO 3D, ISOMETRIC VIEWS</li>
<li>  THICKNESS, ELEVATION</li>
<li>  3D VIEWS, CHANGING VIEWPORTS, VISUAL STYLES, ORBIT, SOLID PRIMITIVES</li>
</ul>
...
<li>  ALIGN , ROATATE3D</li>
<li>  MIRROR3D, 3DARRAY</li>
</ul>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-thumb.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-award-thumb.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/AajSamaj.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/AajSamaj-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="1" data-bs-toggle="modal" data-title="" data-image="images/mohali-sithith-dm-award.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/mohali-sithith-dm-award-thumbn.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/DivyaHimachal20-03-2020.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DivyaHimachal20-03-2020-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="8" data-bs-toggle="modal" data-title="" data-image="images/tricity-it-thinknext-dm-yugmarg.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/tricity-it-thinknext-dm-yugmarg-thumb.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="3" data-bs-toggle="modal" data-title="" data-image="images/DainikSavera20-03-2010Chandigarh.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikSavera20-03-2010Chandigarh-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="2" data-bs-toggle="modal" data-title="" data-image="images/DainikBhaskar.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/DainikBhaskar19-03-2020-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="4" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-honor-thumb.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-honor-thumb.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="5" data-bs-toggle="modal" data-title="" data-image="images/HimachalDastak.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HimachalDastak-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/Himprabha.png" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Himprabha-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="6" data-bs-toggle="modal" data-title="" data-image="images/it-sangathan-dm-award-chd.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/it-sangathan-dm-award-chd-thumb.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="7" data-bs-toggle="modal" data-title="" data-image="images/HT.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/HT-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/thinknext-got-award-mohali.jpeg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/thinknext-got-award-mohali-thumb.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-12 p-2 thumb">
                                <a class="thumbnail" href="#" data-image-id="9" data-bs-toggle="modal" data-title="" data-image="images/Punjab-Express-19-03-2020-Page-4.jpg" data-bs-target="#image-gallery">
                                    <img class="img-thumbnail" src="images/Punjab-Express-19-03-2020-Page-4-1.jpg" alt="PLC SCADA Training in Chandigarh">
                                </a>
                            </div>
                        </div>
...
<li>PLC SCADA Training from 6 Times National Level Award Winner Company:</li>
...
<li>PLC SCADA Training from Government Registered Company with Corporate Identity No. U72200PB2011PTCO35677. ThinkNEXT is registered as a Pvt. Ltd. Company under the companies Act 1956 and approved by Ministry of Corporate Affairs (MCA), Govt. of India </li>
...
<li>PLC SCADA Training from ISO 9001:2015 Certified, Google Partner, Facebook Blueprint Certified, Microsoft Accredited and Hubspot Certified Company.</li>
            ...
            <div class="row m-0">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Iconic Business Summit & Awards 2021" class="thumb">
                                <img src="images/iconic-business-summit-awards-jaya-prada-gallery.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged Asia's Quality and Entreprenuership Award from Bollywood Film Actress Karisma Kapoor " class="thumb">
                                <img src="images/asia-quality-entreprenuership-award.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National icon Award from Bollywood Film Star Sunil Shetty " class="thumb">
                                <img src="images/award-image11.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="Best PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT bagged National Gratitude Award from Bollywood Actress Sonali Bendre" class="thumb">
                                <img src="images/summer-training-in-chandigarh-mohali-2.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="A meet with Bollywood Film Actress Upasna Singh Regarding Digital Marketing of her Upcoming Movie" class="thumb">
                                <img src="/php-images/php-industrial-training.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Business Leaders Award from Film Actor Surendra Pal" class="thumb">
                                <img src="images/best-industrial-training-company-chandigarh1.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="Nation's Business Pride Award 2021" class="thumb">
                                <img src="images/Nations-Business-Pride-Award-faggan-gallery.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title=" A meet with Chaudhary Udaybhan Singh (Minister of State in Govt. of UP)" class="thumb">
                                <img src="images/Award-Chaudhary-Udaybhan-Singh-gallery.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-1.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Taking Award for best Industrial Training Company" class="thumb">
                                <img src="images/awards-2.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award during Leadership Summit 2019" class="thumb">
                                <img src="images/Leadership-Summit-2019-Award.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award at Chitkara University for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-month-industrial-training-mohali-chandigarh.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/6-weeks-industrial-training-mohali-chandigarh.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT receives Award from Ms. Apneet Riyait, Dupity Commissioner, Mansa" class="thumb">
                                <img src="images/6-weeks-industrial-training-company-chandigarh.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT gets Award for Excellence in Industrial Training" class="thumb">
                                <img src="images/six-months-industrial-training-company-chandigarh.jpeg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/ThinkNEXT-Frontdesk.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <%-- <div class="col-sm-4 col-md-3 col-xs-12 profile">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                    <img src="images/Android-lab.webp" alt="6 Month PLC SCADA Training in Chandigarh Mohali Mohali" title="6 Month PLC SCADA Training in Chandigarh Mohali Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/galleryjob-fair7.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT taking Award" class="thumb">
                                <img src="images/Top-Company-Industrial-Training-Chandigarh.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/page-5_img-4-b.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/THINKNEXT-b.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industial-training-in-chandigarh-group.webp" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/industrial-training-in-chandigarh-award-image-min.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/tally-course-in-chandigarh-mohali-min.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-4 col-md-3 col-xs-12 profile">
                    <div class="panel panel-default">
                        <div class="panel-thumbnail">
                            <a href="#" title="ThinkNEXT Technologies" class="thumb">
                                <img src="images/softwere-testing-training-in-chadigarh.jpg" alt="PLC SCADA Training in Chandigarh Mohali" title="PLC SCADA Training in Chandigarh Mohali" class="img-responsive img-rounded" data-bs-toggle="modal" data-bs-target=".modal-profile-lg" />
                            </a>
                        </div>

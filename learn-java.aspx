<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="~/learn-java.aspx.vb" Inherits="javatraining" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   
        <title>Learn Java - ThinkNEXT Technologies</title>
...
z-index: 999;
    ...
    <script>    (function (d, s, id) {
     ...
     <div class="head1">
    <h3 style="color:#000;" > <img src="images/App-icon/java-logo.png" alt="Dot Net" style="width:50px" />Learn Java  &nbsp;&nbsp; </h3>
    <div class="ryt">

 You Are Here / Learn Java
    ...
    <br />
        ...
        <div class="gdl-header-wrapper">
             ...
             <p>We at <strong>ThinkNEXT Technologies  Private Limited</strong> Chandigarh always provide excellent&nbsp;<strong>Java Training</strong>&nbsp;to our trainee and make them an  expert in both basic version and advance version of Java. We provide you  various types of programs that are related to Java, so we provide you the best  course from one of them that suits with the current competency area. Due to our  top-standard JAVA and other IT sector coaching, we are rapidly becoming  the&nbsp;<strong>Best Java Training Institute in Chandigarh Mohali</strong>.  Our expert and skilled professionals who have lots of experience in this field  are always sharing their knowledge and experience with our trainees. In  our&nbsp;<strong>Java Training</strong>&nbsp;we also include various  concepts like proper hands on practical experience with PD (Personality  Development) and interview Preparation skills to improve your way of working.  Our&nbsp;<strong>Java Training</strong>&nbsp;program is designed in such a  way that you can easily give your best performance in Java interview and also  achieve you desired motive that you want to achieve in your life.<br /><br />
  When we compare various languages, Java proves to be most effective  language due to its architecture neutral, security, efficiency, platform  portability, etc. Due to this more than 6.5 million software developers has  learned this platform. Java is used in every major industry segment and has a  presence in a wide range of devices, computers, and networks.<br /><br />
  Object-oriented  programming, for one, was an accepted but seldom practiced paradigm, with much  of what passed as so-called object-oriented programs being little more than  rebranded C code that used&nbsp;&gt;&gt;&nbsp;instead  of&nbsp;print&nbsp;and&nbsp;class&nbsp;instead  of&nbsp;struct.  The programs we wrote those days routinely dumped core due to pointer  arithmetic errors or ran out of memory due to leaks. Source code could barely  be ported between different versions of Unix. Running the same binary on  different processors and operating systems was crazy talk.<br /><br />
  Java  changed all that. While platform-dependent, manually allocated, procedural C  code will continue to be with us for the next 20 years at least, Java proved  this was a choice, not a requirement. For the first time, we began writing real  production code in a cross-platform, garbage-collected, object-oriented  language; and we liked it…millions of us. Languages that have come after Java,  most notably C#, have had to clear the new higher bar for developer  productivity that Java established.<br />
  Java did  not (and still does not) have&nbsp;structs,&nbsp;unions,&nbsp;typedefs, and&nbsp;header&nbsp;files.  An object-oriented language not shackled by a requirement to run legacy code  didn&rsquo;t need them.<br />
  The oracle implementation is  divided into two parts: </p>

  <i class="fa fa-hand-o-right"></i>&nbsp JRE (JAVA Runtime Environment):  contains all the parts of Java SE platform that are required to run java  programs.<br />
 <i class="fa fa-hand-o-right"></i>&nbsp JDK (Java Development Toolkit):  contains all the development tools like compiler, debugger, etc.<br /><br />

<p>Java SE contains all  the basic concepts of Java (Core Java) like swings, threads, applets. One can  develop gaming applications, desktop applications using these. Java EE contains  the advanced frameworks like JSP, Servlet, Hibernate, Struts, Springs, etc. </p>
            ...
            <div class="col-lg-12">
            <h2 style="color: #FF0000; font-weight: bold;">Why Java Training from ThinkNEXT</h2>
...
<iframe  class="thknxtytube" style="width:100%;height:400px;" src="https://www.youtube.com/embed/FvkfHjQttTg?&autoplay=1&rel=0" frameborder="0" allowfullscreen></iframe>
    </div>

...
Partial Class HR_training_in_chandigarh_with_management_internship
    ...
    Public Sub insert()
        ...
        If txtName.Text <> "" Then
            If txtEmailId.Text <> "" Then
                If txtEmailId.Text <> "" Then
                    sql = ("insert into Admissions (EnquiryNo,StudentName,EmailID,StudentMobileNo,Course,ModeOfEnquiry,StatusCode,Session,FranchiseCode,BrandName,Admissiondate) values('" + enquiryno + "','" + txtName.Text + "','" + txtEmailId.Text + "','" + txtMobile.Text + "','" + "Online Tally Course" + "','" + "Online Tally Course" + "','" + "Enquiry" + "','" + ses + "','" + "TNK101" + "','" + "THINKNEXT TRAINING" + "',GetDate())")
                    ...
                    'SMS2nd = "Dear " & txtName.Text & ", Thanks for your enquiry for Tally Online Training at ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon. To know more about ThinkNEXT and get regular updates on your facebook account regarding placements and other activities, please like us at www.facebook.com/thinknexttechnologies"
                    ...
                    varclass.SendLeads(txtMobile.Text, txtName.Text, txtEmailId.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/tally-online-course.aspx")
                    txtName.Text = ""
                    txtEmailId.Text = ""
                    txtMobile.Text = ""
                    lblmsg.Visible = True
    ...
    Public Sub SendEmailbroucher()
        ...
        StrContent = StrContent.Replace("[Course]", "Online Tally Course")
        ...
        msg.Subject = "Online Tally Course"
    ...
    Protected Sub Btndemo_Click(sender As Object, e As EventArgs) Handles Btndemo.Click
        ...
        If txtdemoEmail.Text <> email Then
            ...
            varclass.SendLeads(txtdemoMblno.Text, txtdemoName.Text, txtdemoEmail.Text, "None", "Demo Class", "https://www.thinknexttraining.com/tally-online-course.aspx")
            txtdemoName.Text = ""
            txtdemoMblno.Text = ""
            txtdemoEmail.Text = ""
            txtdemoMsg.Text = ""

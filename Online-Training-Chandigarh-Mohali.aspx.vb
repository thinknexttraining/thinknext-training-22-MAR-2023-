...
Partial Class Online_Training_Chandigarh_Mohali
    ...
    Sub SendEmailReg()
        ...
        Dim reader As New StreamReader(Server.MapPath("~/newemail4.html"))
        ...
        msg.Subject = "Online Industrial Training"
    ...
    Sub AddStudentScholarshipDetail()
        ...
        cmd.Parameters.AddWithValue("@ModeOfEnquiry", "Online Traning")
        cmd.Parameters.AddWithValue("@EmailID", txtEmailR.Text)
        cmd.Parameters.AddWithValue("@Duration", "Online Traning")
        cmd.Parameters.AddWithValue("@Course", txtjob.Text)
        'cmd.Parameters.AddWithValue("@CollegeName", txtjob.Text)
        cmd.Parameters.AddWithValue("@Comment", "Online Traning")
    ...
    Protected Sub btnsubmit_Click(sender As Object, e As EventArgs) Handles btnsubmit.Click
        ...
        If txtEmailR.Text <> email Then
            ...
            SMS2nd = "Dear " & txtNameR.Text & ", Thanks for your registration for Online Industrial Training Test for Industrial Training. Venue: ThinkNEXT Technologies Pvt. Ltd., SCF 113, Sector-65, Phase-XI, Mohali (Chandigarh) Call: 7837401000, 7837402000, 7837403000, 7837404000, 0172-4656197 Toll Free : 1800-102-4102 or visit us at www.thinknexttraining.com, One of our representative will get in touch with you soon."
            ...
            varclass.SendLeads(txtContectR.Text, txtNameR.Text, txtEmailR.Text, "None", "Arrange a Call Back", "https://www.thinknexttraining.com/Online-Training-Chandigarh-Mohali.aspx")
